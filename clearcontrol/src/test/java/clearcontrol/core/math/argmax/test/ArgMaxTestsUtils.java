...
public class ArgMaxTestsUtils
{
   ...
   * 
   * @param pRootClass
   *          root class to locate resources relatively
   * @param pRessource
   *          Resource name
   * @param pColumn
   *          column
   ...
   *           ...
   */
  public static TDoubleArrayList loadData(Class<?> pRootClass,
                                          String pRessource,
                                                       ...
                                                       URISyntaxException
  {
    ...
    try (
        BufferedReader lBufferedReader =
                                       Files.newBufferedReader(Paths.get(Resources.getResource(pRootClass,
                                                                                               pRessource)
                                                                                  .toURI())))
    {
      String lLine;
   ...
   *          argmax finder to test
   * @param pNumberOfDatasets
   *          number of datasets
   * @return max error
   * @throws IOException
   *           ...
   ...
   *           ...
   */
  public static double test(ArgMaxFinder1DInterface pArgMaxFinder1D,
                                                   ...
                                                   URISyntaxException
  {
    ...
    {
      final TDoubleArrayList lY = loadData(ArgMaxTestsUtils.class,
      ...
      final TDoubleArrayList lX = loadData(ArgMaxTestsUtils.class,
                                           "./benchmark/Benchmark.txt",
                                           0);
      lX.remove(0, 1);
      if (lY.size() < lX.size())
