...
public class SmartArgMaxFinderTests
{
  ...
  public void basicTest()
  {
    ...
    {
      final double[] lX = new double[]{0, 1, 2, 3, 4};
      final double[] lY = new double[]{1, 2, 3, 4, 5};
    ...
    {
      final double[] lX = new double[]{0, 1, 2, 3, 4, 5, 6};
      final double[] lY = new double[]{1.542E-4, 1.547E-4, 1.555E-4, 1.557E-4, 1.556E-4, 1.545E-4, 1.547E-4};
    ...
    {
      final double[] lX = new double[]{0, 1, 2, 3, 4, 5, 6};
      final double[] lY = new double[]{1.504E-4, 1.506E-4, 1.517E-4, 1.513E-4, 1.519E-4, 1.515E-4, 1.498E-4};
  ...
  public void performanceTest()
  {
    ...
    {
      final double[] lX = new double[]{0, 1, 2, 3, 4};
      final double[] lY = new double[]{0.11, 0.21, 0.3, 0.19, 0.09};
      ...
      final double lElapsed = OrderOfMagnitude.nano2milli((1.0 * lStop - lStart) / lNumberOfIterations);
  ...
  public void benchmark() throws IOException, URISyntaxException
  {
    ...
    final SmartArgMaxFinder lSmartArgMaxFinder = new SmartArgMaxFinder();
    final double lMaxError = ArgMaxTestsUtils.test(lSmartArgMaxFinder, 15);
   ...
   */
  @Test
  public void benchmarkWithFitEstimation() throws IOException, URISyntaxException
  {
    final SmartArgMaxFinder lSmartArgMaxFinder = new SmartArgMaxFinder();
    final double lMaxError = ArgMaxTestsUtils.test(lSmartArgMaxFinder, 8);
   ...
   */
  @Test
  public void regressionTestBug() throws IOException, URISyntaxException
  {
    final double[] lX = new double[]{-4.000E+02, -3.600E+02, -3.200E+02, -2.800E+02, -2.400E+02, -2.000E+02, -1.600E+02, -1.200E+02, -8.000E+01, -4.000E+01, 0.000E+00, 4.000E+01, 8.000E+01, 1.200E+02, 1.600E+02, 2.000E+02, 2.400E+02, 2.800E+02, 3.200E+02, 3.600E+02, 4.000E+02};

    final double[] lY = new double[]{3.173E-04, 3.148E-04, 3.138E-04, 3.164E-04, 3.188E-04, 3.194E-04, 3.199E-04, 3.219E-04, 3.233E-04, 3.255E-04, 3.269E-04, 3.299E-04, 3.297E-04, 3.289E-04, 3.298E-04, 3.317E-04, 3.316E-04, 3.304E-04, 3.316E-04, 3.322E-04, 3.321E-04};
