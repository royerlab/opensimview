...
public class ClearVolumeRendererFactoryTests
{
  ...
  public void testBestRenderer8Bit()
  {
    ...
    try
    {
      final ClearVolumeRendererInterface lNewBestRenderer = ClearVolumeRendererFactory.newBestRenderer8Bit("Test", 128, 128, false);
  ...
  public void testBestRenderer16Bit()
  {
    ...
    try
    {
      final ClearVolumeRendererInterface lNewBestRenderer = ClearVolumeRendererFactory.newBestRenderer16Bit("Test", 128, 128, false);
      System.out.println(lNewBestRenderer.getClass());
      assertNotNull(lNewBestRenderer);
    } catch (final Throwable e)
    {
