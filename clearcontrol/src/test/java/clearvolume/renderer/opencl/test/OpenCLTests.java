...
public class OpenCLTests
{
  ...
  public void test_creation()
  {
    ...
    try
    {
      ...
      final ClearCLImage img = dev.createGenericImage3D(N, N, N, ImageChannelDataType.SignedInt16);
  ...
  public void test_compile()
  {
    ...
    try
    {
      ...
      final ClearCLKernel lCLKernel = lOpenCLDevice.compileKernel(OpenCLTests.class, "kernels/test.cl", "test_char");
    } catch (final Throwable e)
    {
      e.printStackTrace();
      fail();
  ...
  public void test_run()
  {
    ...
    try
    {
      ...
      final ClearCLKernel lCLKernel = lOpenCLDevice.compileKernel(OpenCLTests.class, "kernels/test.cl", "test_float");
