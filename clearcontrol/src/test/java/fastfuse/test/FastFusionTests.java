...
public class FastFusionTests
{
  ...
  public void test() throws Exception
  {
    ...
    try (ClearCL lClearCL = new ClearCL(lBestBackend); ClearCLDevice lFastestGPUDevice = lClearCL.getFastestGPUDeviceForImages(); ClearCLContext lContext = lFastestGPUDevice.createContext())
    {
      ...
      OffHeapMemory lStackDataA = OffHeapMemory.allocateShorts(width * height * depth);
      OffHeapMemory lStackDataB = OffHeapMemory.allocateShorts(width * height * depth);
      ...
      lStackFusion.passImage("a", lStackDataA, ImageChannelDataType.UnsignedInt16, width, height, depth);
      ...
      lStackFusion.passImage("b", lStackDataB, ImageChannelDataType.UnsignedInt16, width, height, depth);
