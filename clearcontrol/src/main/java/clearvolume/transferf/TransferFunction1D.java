...
public class TransferFunction1D implements TransferFunction
{
   ...
   *
   * @param pComponent red , blue, green or apha component
   */
   ...
   *
   * @param pRGBA single RGBA 4-tuple of double values
   */
  public void addPoint(final double... pRGBA)
  {
    if (pRGBA.length != 4) complain();
   ...
   *
   * @param pRGBA single RGBA 4-tuple of float values
   */
  ...
  {
    return String.format("TransferFunction1D [mTransferFunctionList=%s]", mTransferFunctionList);
  }
