...
public class TransferFunctions
{
  ...
  /**
   * Returns a simple transfer function that is a gradient from dark transparent
   * to a given color. The color is given as a float vector in [0,1]^4.
   *
  ...
  /**
   * Returns a simple transfer function that is a gradient from dark transparent
   * to a given color. The transparency of the given color is used.
   *
   * @param pColor color
  ...
  public static TransferFunction1D getGradientForColor(Color pColor)
  {
    ...
    lTransfertFunction.addPoint(lNormaFactor * pColor.getRed(), lNormaFactor * pColor.getGreen(), lNormaFactor * pColor.getBlue(), lNormaFactor * pColor.getAlpha());
    return lTransfertFunction;
  }
