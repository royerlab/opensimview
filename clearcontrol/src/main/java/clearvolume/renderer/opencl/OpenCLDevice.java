...
public class OpenCLDevice implements ClearVolumeCloseable
{
  ...
  public boolean initCL()
  {
    ...
    try
    {
      ...
      System.out.println(lAllDevices.size() + " available OpenCL devices:\n");
  ...
  public ClearCLKernel compileKernel(final Class<?> pRootClass, final String pRessourceName, final String pKernelName)
  {
  ...
  {
    if (mCLDevice == null || mCLContext == null || mCLQueue == null) return;
  ...
  public void run(final int pKernelIndex, final int mNx, final int mNy)
  {
    if (mCLDevice == null || mCLContext == null || mCLQueue == null) return;
  ...
  public void run(final int pKernelIndex, final int mNx, final int mNy, final int mNz)
  {
    if (mCLDevice == null || mCLContext == null || mCLQueue == null) return;
  ...
  public void run(final int pKernelIndex, final int mNx, final int mNy, final int mNz, final int mNxLoc, final int mNyLoc, final int mNzLoc)
  ...
  public void run(final ClearCLKernel pCLKernel, final int mNx, final int mNy)
  {
  ...
  public void run(final ClearCLKernel pCLKernel, final int mNx, final int mNy, final int mNz)
  {
  ...
  public void run(final ClearCLKernel pCLKernel, final int mNx, final int mNy, final int mNz, final int mNxLoc, final int mNyLoc, final int mNzLoc)
  ...
  public ClearCLImage createGenericImage2D(final long Nx, final long Ny, ImageChannelOrder pChannelOrder, ImageChannelDataType pChannelDataType)
  {
    if (mCLDevice == null || mCLContext == null || mCLQueue == null) return null;

    return mCLContext.createImage(pChannelOrder, pChannelDataType, Nx, Ny);

  }

  public ClearCLImage createGenericImage3D(final long Nx, final long Ny, final long Nz, ImageChannelDataType pChannelDataType)
  {
    if (mCLDevice == null || mCLContext == null || mCLQueue == null) return null;

    return mCLContext.createSingleChannelImage(pChannelDataType, Nx, Ny, Nz);
  ...
  public void writeFloatBuffer(final ClearCLBuffer pCLBuffer, final FloatBuffer pBuffer)
  {
    if (mCLDevice == null || mCLContext == null || mCLQueue == null) return;
  ...
  public void copyCLBufferToPointer(final ClearCLBuffer pCLBuffer, OffHeapMemory pPointer)
  {
    if (mCLDevice == null || mCLContext == null || mCLQueue == null) return;
  ...
  public void writeImage(final ClearCLImage img, final ContiguousMemoryInterface pContiguousMemoryInterface)
  {
    if (mCLDevice == null || mCLContext == null || mCLQueue == null) return;
  ...
  public void writeImage(final ClearCLImage img, final FragmentedMemoryInterface pFragmentedMemoryInterface)
  {
    if (mCLDevice == null || mCLContext == null || mCLQueue == null) return;
  ...
  public void close()
  {
    try
    {
      ...
      if (mCLKernelList != null) for (ClearCLKernel lCLKernel : mCLKernelList)
      {
        lCLKernel.close();
        lCLKernel = null;
      }
