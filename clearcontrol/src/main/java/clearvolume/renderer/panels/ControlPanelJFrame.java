...
public class ControlPanelJFrame extends JFrame
{
   ...
   *
   * @param pRenderLayerToBeControlled    render layer to be controlled
   * @param pClearVolumeRendererInterface render interface
   */
  public ControlPanelJFrame(final int pRenderLayerToBeControlled, final ClearVolumeRendererInterface pClearVolumeRendererInterface)
  {
    super();
    setSize(448, 149);
    setResizable(false);
    setDefaultCloseOperation(WindowConstants.HIDE_ON_CLOSE);
    mControlJPanel = new ControlJPanel(pRenderLayerToBeControlled, pClearVolumeRendererInterface);
