 ...
 * @author royer
 */
public class BasicVideoRecorder extends VideoRecorderBase implements VideoRecorderInterface
{
  ...
  {
    if (!super.screenshot(pGLAutoDrawable, pAsynchronous)) return false;
