...
public interface VideoRecorderInterface
{
   ...
   *
   * @param pTargetFrameRate target frame rate
   */
   ...
   *
   * @param pActive state: true records, false does not record
   */
   ...
   *
   * @param pDrawable     JOGL GLAutoDrawable to be used to get pixel data from.
