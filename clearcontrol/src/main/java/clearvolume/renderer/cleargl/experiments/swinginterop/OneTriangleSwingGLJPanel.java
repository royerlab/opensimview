...
public class OneTriangleSwingGLJPanel
{
  ...
  public static void main(String[] args)
  {
    ...
    jframe.setLayout(new MigLayout("", "[190px,grow,fill]", "[grow,fill][29px][29px][29px]"));
    ...
    final JSlider slide1 = new JSlider(SwingConstants.HORIZONTAL, 0, 255, 128);
    ...
    final JSlider slide2 = new JSlider(SwingConstants.HORIZONTAL, 0, 255, 128);
    ...
    final JSlider slide3 = new JSlider(SwingConstants.HORIZONTAL, 0, 255, 128);
