...
public abstract class ClearVolumeRendererBase implements ClearVolumeRendererInterface, ClearVolumeCloseable
{
  ...
  public ClearVolumeRendererBase(final int pNumberOfRenderLayers)
  {
    ...
    mVolumeClipBox = new float[]{-1.f, 1.f, -1.f, 1.f, -1.f, 1.f};
    ...
    if (pNumberOfRenderLayers == 1) mTransferFunctions[0] = TransferFunctions.getDefault();
   ...
   *
   * @param pEyeRayListener eye ray listener
   */
  @Override
   ...
   *
   * @param pRotationControllerInterface rotation controller
   */
  @Override
  ...
  public void addTranslationX(final double pDX)
  {
    ...
    {
      if (getDisplayLock().isHeldByCurrentThread()) getDisplayLock().unlock();
    }
  }
  ...
  {
    if (pVolumeCaptureListener != null) mVolumeCaptureListenerList.add(pVolumeCaptureListener);
  }
  ...
  public void toggleAlphaBlending(int pRenderLayerIndex)
  {
    ...
    try
    {
      boolean isAlphaBlending = mAlphaBlending[pRenderLayerIndex] > 0.f;

      mAlphaBlending[pRenderLayerIndex] = isAlphaBlending ? 0.f : cDefault_Alpha_Blend;
   ...
   *
   * @param pRenderLayerIndex renderlayer index
   * @return maximal number of steps
   */
  public int getMaxSteps(final int pRenderLayerIndex)
  {
    return (int) (sqrt(getVolumeSizeX(pRenderLayerIndex) * getVolumeSizeX(pRenderLayerIndex) + getVolumeSizeY(pRenderLayerIndex) * getVolumeSizeY(pRenderLayerIndex) + getVolumeSizeZ(pRenderLayerIndex) * getVolumeSizeZ(pRenderLayerIndex)) * getQuality(pRenderLayerIndex));
  }
  ...
  public boolean isNewVolumeDataAvailable()
  {
    for (final FragmentedMemoryInterface lFragmentedMemoryInterface : mVolumeDataByteBuffers)
      if (lFragmentedMemoryInterface != null) return true;
    return false;
  }
  ...
  public void notifyVolumeCaptureListeners(ByteBuffer pCaptureBuffer, NativeTypeEnum pNativeType, long pVolumeWidth, long pVolumeHeight, long pVolumeDepth, double pVoxelWidth, double pVoxelHeight, double pVoxelDepth)
  {
    for (final VolumeCaptureListener lVolumeCaptureListener : mVolumeCaptureListenerList)
    {
      lVolumeCaptureListener.capturedVolume(pCaptureBuffer, pNativeType, pVolumeWidth, pVolumeHeight, pVolumeDepth, pVoxelWidth, pVoxelHeight, pVoxelDepth);
    }
  }
  ...
  {
    if (mAdaptiveLODController != null) mAdaptiveLODController.setActive(pAdaptiveLOD);
  }

  /**
   * Sets brightness.
   *
   * @param pBrightness brightness level
   */
  @Override
  ...
  public void setBrightness(final int pRenderLayerIndex, final double pBrightness)
  {
    ...
    try
    {
      mBrightness[pRenderLayerIndex] = (float) clamp(pBrightness, 0, getNativeType() == NativeTypeEnum.UnsignedByte ? 16 : 256);
  ...
  public void setClipBox(float... pVolumeClipBox)
  {
    ...
    try
    {
      mVolumeClipBox = Arrays.copyOf(pVolumeClipBox, pVolumeClipBox.length);
   ...
   *
   * @param pRenderLayerIndex current render layer index
   */
  @Override
   ...
   *
   * @param pRenderLayerIndex render layer index
   * @param pDithering        new dithering level for render layer
   */
  @Override
   ...
   */
  @Override
  public void setGamma(final int pRenderLayerIndex, final double pGamma)
   ...
   *
   * @param pVisible true to set layer visible, false to set it invisible
   */
  @Override
   ...
   */
  @Override
  public void setLayerVisible(final int pRenderLayerIndex, final boolean pVisible)
  {
    getDisplayLock().lock();
    try
    {
   ...
   * Returns current render layer.
   *
   * @param pNumberOfRenderLayers number of render layers
   */
  @Override
   ...
   *
   * @param pRenderLayerIndex render layer index
   * @param pQuality          new quality level for render layer
   */
  @Override
  ...
  public void setQuaternion(Quaternion pQuaternion)
  {
    ...
    try
    {
      if (mLastAppliedQuaternion == null || pQuaternion.getX() != mLastAppliedQuaternion.getX() || pQuaternion.getY() != mLastAppliedQuaternion.getY() || pQuaternion.getZ() != mLastAppliedQuaternion.getZ() || pQuaternion.getW() != mLastAppliedQuaternion.getW())
      {
   ...
   */
  @Override
  public void setRenderAlgorithm(final int pRenderLayerIndex, final RenderAlgorithm pRenderAlgorithm)
  {
    getDisplayLock().lock();
    try
    {
   ...
   */
  @Override
  public void setTransferFunction(final int pRenderLayerIndex, final TransferFunction pTransfertFunction)
  {
    getDisplayLock().lock();
    try
    {
   ...
   * index.
   *
   * @param pTransferRangeMin transfer range min
   * @param pTransferRangeMax transfer range max
   */
  @Override
  public void setTransferFunctionRange(final double pTransferRangeMin, final double pTransferRangeMax)
  {
    setTransferFunctionRange(getCurrentRenderLayerIndex(), pTransferRangeMin, pTransferRangeMax);
  }
   ...
   */
  @Override
  public void setTransferFunctionRange(final int pRenderLayerIndex, final double pTransferRangeMin, final double pTransferRangeMax)
  {
    getDisplayLock().lock();
    try
    {
      mTransferFunctionRangeMin[pRenderLayerIndex] = (float) clamp(pTransferRangeMin, 0, 1);
      mTransferFunctionRangeMax[pRenderLayerIndex] = (float) clamp(pTransferRangeMax, 0, 1);
      notifyChangeOfVolumeRenderingParameters();
    } finally
    {
      if (getDisplayLock().isHeldByCurrentThread()) getDisplayLock().unlock();
   ...
   *
   * @param pTransferRangeMax maximum
   */
  @Override
  public void setTransferFunctionRangeMax(final double pTransferRangeMax)
  {
    setTransferFunctionRangeMax(getCurrentRenderLayerIndex(), pTransferRangeMax);
  }
   ...
   */
  @Override
  public void setTransferFunctionRangeMax(final int pRenderLayerIndex, final double pTransferRangeMax)
  {
    getDisplayLock().lock();
    try
    {
   ...
   *
   * @param pTransferRangeMin minimum
   */
  @Override
  public void setTransferFunctionRangeMin(final double pTransferRangeMin)
  {
    setTransferFunctionRangeMin(getCurrentRenderLayerIndex(), pTransferRangeMin);
  }
   ...
   */
  @Override
  public void setTransferFunctionRangeMin(final int pRenderLayerIndex, final double pTransferRangeMin)
  {
    getDisplayLock().lock();
    try
    {
   ...
   *
   * @param pWaitForCopy               set to true for waiting for data to be copied.
   * @param pRenderLayerIndex          render pByteBuffer index
   * @param pFragmentedMemoryInterface fragmented buffer
   * @param pVolumeSizeX               volume size in voxels along X
   * @param pVolumeSizeY               volume size in voxels along Y
   * @param pVolumeSizeZ               volume size in voxels along Z
   * @param pVoxelSizeX                voxel dimension along X
   * @param pVoxelSizeY                voxel dimension along Y
   * @param pVoxelSizeZ                voxel dimension along Z
   * @return true if transfer was completed (no time out)
   */
  @Override
  public boolean setVolumeDataBuffer(boolean pWaitForCopy, long pTimeOut, TimeUnit pTimeUnit, final int pRenderLayerIndex, final FragmentedMemoryInterface pFragmentedMemoryInterface, final long pVolumeSizeX, final long pVolumeSizeY, final long pVolumeSizeZ, final double pVoxelSizeX, final double pVoxelSizeY, final double pVoxelSizeZ)
  {
    synchronized (getSetVolumeDataBufferLock(pRenderLayerIndex))
    {

      if (mVolumeSizeX[pRenderLayerIndex] != pVolumeSizeX || mVolumeSizeY[pRenderLayerIndex] != pVolumeSizeY || mVolumeSizeZ[pRenderLayerIndex] != pVolumeSizeZ)
      {
    ...
    if (pWaitForCopy)
    {
      ...
      final boolean lWaitResult = waitToFinishDataBufferCopy(pRenderLayerIndex, pTimeOut, pTimeUnit);
      return lWaitResult;
    } else return false;
   ...
   * @param pVolumeSizeX      size in voxels along X
   * @param pVolumeSizeY      size in voxels along Y
   * @param pVolumeSizeZ      size in voxels along Z
   * @return true if transfer was completed (no time out)
   */
  @Override
  public boolean setVolumeDataBuffer(final int pRenderLayerIndex, final ByteBuffer pByteBuffer, final long pVolumeSizeX, final long pVolumeSizeY, final long pVolumeSizeZ)
  {
    return setVolumeDataBuffer(pRenderLayerIndex, pByteBuffer, pVolumeSizeX, pVolumeSizeY, pVolumeSizeZ, 1, 1, 1);
  }
   ...
   */
  @Override
  public boolean setVolumeDataBuffer(int pRenderLayerIndex, ByteBuffer pByteBuffer, long pVolumeSizeX, long pVolumeSizeY, long pVolumeSizeZ, double pVoxelSizeX, double pVoxelSizeY, double pVoxelSizeZ)
  {
    return setVolumeDataBuffer(cDefaultSetVolumeDataBufferTimeout, TimeUnit.SECONDS, pRenderLayerIndex, pByteBuffer, pVolumeSizeX, pVolumeSizeY, pVolumeSizeZ, pVoxelSizeX, pVoxelSizeY, pVoxelSizeZ);
  }
   ...
   *
   * @param pRenderLayerIndex          render layer index
   * @param pContiguousMemoryInterface contguous buffer
   * @param pVolumeSizeX               volume size in voxels along X
   * @param pVolumeSizeY               volume size in voxels along Y
   * @param pVolumeSizeZ               volume size in voxels along Z
   * @return true if transfer was completed (no time out)
   */
  @Override
  public boolean setVolumeDataBuffer(final int pRenderLayerIndex, final ContiguousMemoryInterface pContiguousMemoryInterface, final long pVolumeSizeX, final long pVolumeSizeY, final long pVolumeSizeZ)
  {
    return setVolumeDataBuffer(pRenderLayerIndex, FragmentedMemory.wrap(pContiguousMemoryInterface), pVolumeSizeX, pVolumeSizeY, pVolumeSizeZ, 1, 1, 1);
  }
   ...
   *
   * @param pRenderLayerIndex          render layer index
   * @param pContiguousMemoryInterface contiguous buffer
   * @param pVolumeSizeX               volume size in voxels along X
   * @param pVolumeSizeY               volume size in voxels along Y
   * @param pVolumeSizeZ               volume size in voxels along Z
   * @param pVoxelSizeX                voxel dimension along X
   ...
   */
  @Override
  public boolean setVolumeDataBuffer(final int pRenderLayerIndex, final ContiguousMemoryInterface pContiguousMemoryInterface, final long pVolumeSizeX, final long pVolumeSizeY, final long pVolumeSizeZ, final double pVoxelSizeX, final double pVoxelSizeY, final double pVoxelSizeZ)
  {
    return setVolumeDataBuffer(pRenderLayerIndex, FragmentedMemory.wrap(pContiguousMemoryInterface), pVolumeSizeX, pVolumeSizeY, pVolumeSizeZ, pVoxelSizeX, pVoxelSizeY, pVoxelSizeZ);
  }
   ...
   */
  @Override
  public boolean setVolumeDataBuffer(final int pRenderLayerIndex, final FragmentedMemoryInterface pFragmentedMemoryInterface, final long pVolumeSizeX, final long pVolumeSizeY, final long pVolumeSizeZ)
  {
    return setVolumeDataBuffer(pRenderLayerIndex, pFragmentedMemoryInterface, pVolumeSizeX, pVolumeSizeY, pVolumeSizeZ, 1, 1, 1);
  }
   ...
   */
  @Override
  public boolean setVolumeDataBuffer(final int pRenderLayerIndex, final FragmentedMemoryInterface pFragmentedMemoryInterface, final long pVolumeSizeX, final long pVolumeSizeY, final long pVolumeSizeZ, final double pVoxelSizeX, final double pVoxelSizeY, final double pVoxelSizeZ)
  {
    return setVolumeDataBuffer(cDefaultSetVolumeDataBufferTimeout, TimeUnit.SECONDS, pRenderLayerIndex, pFragmentedMemoryInterface, pVolumeSizeX, pVolumeSizeY, pVolumeSizeZ, pVoxelSizeX, pVoxelSizeY, pVoxelSizeZ);
  }
   ...
   * Sets volume data buffer.
   *
   * @param pTimeOut          time out duration
   * @param pTimeUnit         time unit for time out duration
   * @param pRenderLayerIndex render layer index
   * @param pByteBuffer       byte buffer
   * @param pVolumeSizeX      volume size in voxels along X
   * @param pVolumeSizeY      volume size in voxels along Y
   ...
   */
  @Override
  public boolean setVolumeDataBuffer(long pTimeOut, TimeUnit pTimeUnit, final int pRenderLayerIndex, final ByteBuffer pByteBuffer, final long pVolumeSizeX, final long pVolumeSizeY, final long pVolumeSizeZ)
  {
    return setVolumeDataBuffer(pTimeOut, pTimeUnit, pRenderLayerIndex, pByteBuffer, pVolumeSizeX, pVolumeSizeY, pVolumeSizeZ, 1, 1, 1);
  }
   ...
   *
   * @param pRenderLayerIndex render pByteBuffer index
   * @param pByteBuffer       NIO byte buffer
   * @param pVolumeSizeX      volume size in voxels along X
   * @param pVolumeSizeY      volume size in voxels along Y
   * @param pVolumeSizeZ      volume size in voxels along Z
   * @param pVoxelSizeX       voxel dimension along X
   ...
   */
  @Override
  public boolean setVolumeDataBuffer(long pTimeOut, TimeUnit pTimeUnit, final int pRenderLayerIndex, final ByteBuffer pByteBuffer, final long pVolumeSizeX, final long pVolumeSizeY, final long pVolumeSizeZ, final double pVoxelSizeX, final double pVoxelSizeY, final double pVoxelSizeZ)
  {
    ...
    return setVolumeDataBuffer(pTimeOut, pTimeUnit, pRenderLayerIndex, lFragmentedMemoryInterface, pVolumeSizeX, pVolumeSizeY, pVolumeSizeZ, pVoxelSizeX, pVoxelSizeY, pVoxelSizeZ);
   ...
   */
  @Override
  public boolean setVolumeDataBuffer(long pTimeOut, TimeUnit pTimeUnit, final int pRenderLayerIndex, final ContiguousMemoryInterface pContiguousMemoryInterface, final long pVolumeSizeX, final long pVolumeSizeY, final long pVolumeSizeZ)
  {
    return setVolumeDataBuffer(pTimeOut, pTimeUnit, pRenderLayerIndex, FragmentedMemory.wrap(pContiguousMemoryInterface), pVolumeSizeX, pVolumeSizeY, pVolumeSizeZ, 1, 1, 1);
  }
   ...
   * @param pTimeUnit                  time unit for time out duration
   * @param pRenderLayerIndex          render layer index
   * @param pContiguousMemoryInterface byte buffer
   * @param pVolumeSizeX               volume size in voxels along X
   * @param pVolumeSizeY               volume size in voxels along Y
   * @param pVolumeSizeZ               volume size in voxels along Z
   * @return true if transfer was completed (no time out)
   */
  @Override
  public boolean setVolumeDataBuffer(long pTimeOut, TimeUnit pTimeUnit, final int pRenderLayerIndex, final FragmentedMemoryInterface pFragmentedMemoryInterface, final long pVolumeSizeX, final long pVolumeSizeY, final long pVolumeSizeZ)
  {
    return setVolumeDataBuffer(pTimeOut, pTimeUnit, pRenderLayerIndex, pFragmentedMemoryInterface, pVolumeSizeX, pVolumeSizeY, pVolumeSizeZ, 1, 1, 1);
  }
   ...
   */
  @Override
  public boolean setVolumeDataBuffer(long pTimeOut, TimeUnit pTimeUnit, final int pRenderLayerIndex, final FragmentedMemoryInterface pFragmentedMemoryInterface, final long pVolumeSizeX, final long pVolumeSizeY, final long pVolumeSizeZ, final double pVoxelSizeX, final double pVoxelSizeY, final double pVoxelSizeZ)
  {
    return setVolumeDataBuffer(true, pTimeOut, pTimeUnit, pRenderLayerIndex, pFragmentedMemoryInterface, pVolumeSizeX, pVolumeSizeY, pVolumeSizeZ, pVoxelSizeX, pVoxelSizeY, pVoxelSizeZ);
  }
   ...
   * Sets the voxel size.
   *
   * @param pVoxelSizeX voxel size along X
   * @param pVoxelSizeY voxel size along Y
   * @param pVoxelSizeZ voxel size along Z
   */
  @Override
  public void setVoxelSize(final double pVoxelSizeX, final double pVoxelSizeY, final double pVoxelSizeZ)
  {
    getDisplayLock().lock();
    try
    {
   ...
   */
  @Override
  public void setVoxelSize(final int pRenderLayerIndex, final double pVoxelSizeX, final double pVoxelSizeY, final double pVoxelSizeZ)
  {
    getDisplayLock().lock();
    try
    {
  ...
  {
    if (mControlFrame != null) SwingUtilities.invokeLater(new Runnable()
    {
      @Override
      public void run()
      {
  ...
  {
    if (mParametersListFrame != null) SwingUtilities.invokeLater(new Runnable()
    {
      @Override
      public void run()
      {
   ...
   */
  @Override
  public boolean waitToFinishAllDataBufferCopy(final long pTimeOut, final TimeUnit pTimeUnit)
  {
    boolean lNoTimeOut = true;
    for (int i = 0; i < getNumberOfRenderLayers(); i++)
      lNoTimeOut &= waitToFinishDataBufferCopy(getCurrentRenderLayerIndex(), pTimeOut, pTimeUnit);
   ...
   */
  @Override
  public boolean waitToFinishDataBufferCopy(final int pRenderLayerIndex, final long pTimeOut, final TimeUnit pTimeUnit)

  {
    try
    {
      // final long lStartNs = System.nanoTime();
      if (mDataBufferCopyIsFinishedArray[pRenderLayerIndex] == null) return true;
      final boolean lAwaitResult = mDataBufferCopyIsFinishedArray[pRenderLayerIndex].await(pTimeOut, pTimeUnit);
      // final long lStopNs = System.nanoTime();
      // System.out.println("ELPASED:" + (lStopNs - lStartNs) / 1.0e6);
      return lAwaitResult;
    } catch (final InterruptedException e)
    {
      return waitToFinishDataBufferCopy(pRenderLayerIndex, pTimeOut, pTimeUnit);
    }
  }
