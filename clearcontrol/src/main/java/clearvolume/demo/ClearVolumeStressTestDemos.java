...
public class ClearVolumeStressTestDemos
{
  ...
  public void demoStressTest() throws InterruptedException, IOException
  {
    for (int i = 0; i < 50; i++)
    {
      ...
      final ClearVolumeRendererInterface lClearVolumeRenderer = ClearVolumeRendererFactory.newBestRenderer("ClearVolumeTest", i % 2 == 0 ? 768 : 512, i % 2 == 0 ? 768 : 512, NativeTypeEnum.UnsignedByte, false);
  ...
  @Test
  public void demoStressTestNewtCanvasAWT() throws InterruptedException, IOException, InvocationTargetException
  {
    for (int nfi = 0; nfi < 50; nfi++)
    {
      ...
      final ClearVolumeRendererInterface lClearVolumeRenderer = new OpenCLVolumeRenderer("ClearVolumeTest", (i % 2 == 0) ? 768 : 64, (i % 2 == 0) ? 768 : 64, NativeTypeEnum.UnsignedByte, (i % 2 == 0) ? 768 : 64, (i % 2 == 0) ? 768 : 64, 1, true);
  ...
  @Test
  public void demoWithBigBig16BitGeneratedDataset() throws InterruptedException, IOException
  {
    ...
    ContiguousBuffer lContiguousBuffer = ContiguousBuffer.allocate(lResolutionX * lResolutionY * lResolutionZ * 2L);
    ...
    lClearVolumeRenderer.setVolumeDataBuffer(0, lContiguousBuffer.getContiguousMemory(), lResolutionX, lResolutionY, lResolutionZ);
    lClearVolumeRenderer.requestDisplay();
