...
public class ClearVolumeDefaultFont
{
  ...
  public static Font getFontPlain(float pSize)
  {
    ...
    try
    {
      sFont = Font.createFont(Font.TRUETYPE_FONT, ClearVolumeDefaultFont.class.getResourceAsStream(cFontPath)).deriveFont(Font.PLAIN, pSize);
    } catch (final FontFormatException | IOException e)
    {
      ...
      System.err.println("Could not use \"" + cFontPath + "\" (" + e.toString() + "), falling back to Sans.");
