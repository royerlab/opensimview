...
public class AppleMac
{
    ...
    try
    {
      final Thread lThread = new Thread("Apple Set Application Icon")
      {
        ...
        public void run()
        {
          try
          {
            Method lMethod = cClass.getDeclaredMethod("setDockIconImage", Image.class);
  ...
  public static final boolean setApplicationName(final String pString)
  {
    ...
    try
    {
      System.setProperty("com.apple.mrj.application.apple.menu.about.name", pString);
      return true;
    } catch (final Throwable e)
    {
      System.err.println(e.getMessage());
  ...
  public final static boolean requestFullscreen(final Window pWindow)
  {
    ...
    try
    {
      ...
      Method lMethod = cClass.getDeclaredMethod("requestToggleFullScreen", Window.class);
