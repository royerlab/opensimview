 ...
 * @author royer
 */
public class ZarrStackSource extends FileStackBase implements
                                ...
                                AutoCloseable
{
   ...
   *
   */
  public ZarrStackSource(final RecyclerInterface<StackInterface, StackRequest> pStackRecycler)
  {
    super(true);
