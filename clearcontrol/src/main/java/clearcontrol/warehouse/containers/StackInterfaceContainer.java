package clearcontrol.warehouse.containers;
 ...
 */
public abstract class StackInterfaceContainer extends DataContainerBase implements DataContainerInterface, Map<String, StackInterface>, LoggingFeature
{
  ...
  @Override
  public void putAll(Map<? extends String, ? extends StackInterface> m)
  {
    mData.putAll(m);
  }
