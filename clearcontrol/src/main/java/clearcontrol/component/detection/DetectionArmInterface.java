 ...
 * @author royer
 */
public interface DetectionArmInterface extends NameableInterface, OpenCloseDeviceInterface, QueueDeviceInterface<DetectionArmQueue>, HasChangeListenerInterface<VirtualDevice>
{
  /**
   * Resets functions
   */
