...
public class LightSheetDemo
{
   ...
   */
  @Test
  public void demoOnSimulator() throws InterruptedException, ExecutionException
  {

    final SignalGeneratorInterface lSignalGeneratorDevice = new SignalGeneratorSimulatorDevice();

    final LightSheetSignalGeneratorDevice lLightSheetSignalGeneratorDevice = LightSheetSignalGeneratorDevice.wrap(lSignalGeneratorDevice, false);
   ...
   */
  @Test
  public void demoOnNIRIO() throws InterruptedException, ExecutionException
  {
  ...
  private void runDemoWith(final LightSheetSignalGeneratorDevice pSignalGeneratorDevice) throws InterruptedException, ExecutionException
  {
