...
public class ScriptingPreprocessor
{
  ...
  public static String process(final Class pClassInPackageWhereScriptsCanBeFound, final String pPathForFindingScripts, final String pScriptString)
  {
    return process(pClassInPackageWhereScriptsCanBeFound, pPathForFindingScripts, pScriptString, new HashSet<String>());
  }

  public static String process(final Class pClassForFindingScripts, final String pPathForFindingScripts, final String pScriptString, final HashSet<String> pAllreadyIncludedFiles)
  {
      ...
      if (lLine.startsWith("//include"))
      {
        ...
        try
        {
          if (lIncludedFile.exists() && !pAllreadyIncludedFiles.contains(lFileName))
          {
            ...
            final String lPreProcessedIncludedFileString = process(pClassForFindingScripts, pPathForFindingScripts, lIncludedFileString, pAllreadyIncludedFiles);
