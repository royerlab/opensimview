...
public class ScriptingPanelDemo
{
  ...
  @Test
  public void testPython() throws InvocationTargetException, InterruptedException
  {
    ...
    final ScriptingPanel lScriptingPanel = new ScriptingPanel("testPython", lScriptingEngine);
  ...
  @Test
  public void testGroovy() throws InvocationTargetException, InterruptedException
  {
    final JFrame lJFrame = new JFrame();
    ...
    final ScriptingPanel lScriptingPanel = new ScriptingPanel("testGroovy", lScriptingEngine);
    lScriptingPanel.loadLastLoadedScriptFile();
    lJFrame.add(lScriptingPanel);
