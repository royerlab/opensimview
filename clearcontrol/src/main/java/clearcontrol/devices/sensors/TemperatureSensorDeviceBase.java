...
public abstract class TemperatureSensorDeviceBase extends PeriodicLoopTaskDevice implements OpenCloseDeviceInterface, TemperatureSensorDeviceInterface
{
  ...
  public TemperatureSensorDeviceBase(final String pDeviceName)
  {
    ...
    mTemperatureVariable = new Variable<Double>(pDeviceName + "TemperatureInCelcius", Double.NaN);
  }
