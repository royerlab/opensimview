 ...
 * @author royer
 */
public interface LaserDeviceInterface extends NameableInterface, OpenCloseDeviceInterface, StartStopDeviceInterface
{
   ...
   * laser itself.
   *
   * @param pState power on/off state
   */
   ...
   *
   * @param pTargetPowerinMilliWatt target power in milliwatt
   */
   ...
   *
   * @param pTargetPowerInPercent target power in percent
   */
