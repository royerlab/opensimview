...
public class SMC100ResetAdapter extends SerialDeviceAdapterAdapter<Boolean> implements SerialTextDeviceAdapter<Boolean>
{
  ...
  {
    if (pOldValue == false && pNewValue == true) return SMC100Protocol.cResetCommand.getBytes();
    else return null;
  }
