...
public class SMC100EnableAdapter extends SerialDeviceAdapterAdapter<Boolean> implements SerialTextDeviceAdapter<Boolean>
{
  ...
  {
    if (!pOldValue == false && pNewValue == true) return SMC100Protocol.cEnableCommand.getBytes();
    else return null;
  }
