...
public interface ScoreInterface
{
   ...
   * @param pMeasure given measure
   */
  public abstract void insertMeasureAt(final int pIndex, final MeasureInterface pMeasure);

  /**
   * Adds measure to score.
   *
   * @param pMeasure measure to add
   */
   ...
   *
   * @param pMeasure       measure to add
   * @param pNumberOfTimes number of times
   */
  public abstract void addMeasureMultipleTimes(final MeasureInterface pMeasure, final int pNumberOfTimes);

  /**
   * Adds all measures in given score to this score.
   *
   * @param pScore score from which measures are added
   */
   ...
   *
   * @param pScore score to copy into this score.
   */
   ...
   *
   * @param pMeasureIndex measure index.
   * @return measure
   */
