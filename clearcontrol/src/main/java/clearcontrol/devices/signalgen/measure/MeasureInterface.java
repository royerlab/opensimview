...
public interface MeasureInterface extends NameableInterface
{
   ...
   *
   * @param pDuration duration of the measure
   ...
   *
   * @param pSync true if sync, false if not.
   */
   ...
   *
   * @param pSyncOnRisingEdge true if sync on raising edge, false if sync on falling edge
   */
   ...
   *
   * @param pSyncChannel sync channel
   */
