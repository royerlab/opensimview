 ...
 * @author royer
 */
public interface StackCameraDeviceInterface<Q extends StackCameraQueue<Q>> extends CameraDeviceInterface, QueueDeviceInterface<Q>, NameableInterface
{
