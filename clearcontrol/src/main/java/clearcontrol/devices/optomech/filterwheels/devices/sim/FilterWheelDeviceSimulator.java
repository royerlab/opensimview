...
public class FilterWheelDeviceSimulator extends FilterWheelDeviceBase implements FilterWheelDeviceInterface, LoggingFeature, SimulationDeviceInterface
{

  public FilterWheelDeviceSimulator(String pDeviceName, int... pValidPositions)
  {
