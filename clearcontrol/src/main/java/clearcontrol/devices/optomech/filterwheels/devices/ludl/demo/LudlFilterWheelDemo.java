...
public class LudlFilterWheelDemo
{
  ...
  {
    final LudlFilterWheelDevice lLudlFilterWheelDevice =
                                                     new LudlFilterWheelDevice("COM31");

    assertTrue(lLudlFilterWheelDevice.open());

    final Variable<Integer> lPositionVariable =
        lLudlFilterWheelDevice.getPositionVariable();
    final Variable<Integer> lSpeedVariable =
        lLudlFilterWheelDevice.getSpeedVariable();
