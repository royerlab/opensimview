...
public class FilterWheelDevicePanelDemo extends Application
{
  ...
  {
    FilterWheelDeviceSimulator lFilterWheelDeviceSimulator = new FilterWheelDeviceSimulator("demofilterwheel", 0, 1, 2, 3);
    ...
    Scene scene = new Scene(lFilterWheelDevicePanel, javafx.scene.paint.Color.WHITE);
