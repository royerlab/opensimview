...
public class JOpenFileChooserButton extends JButton
{
  ...
  public JOpenFileChooserButton(final String pLabel, final boolean pOnlyFolders)
  {
    this(cDefaultFolder, pLabel, pOnlyFolders);
  }

  public JOpenFileChooserButton(final File pCurrentFolder, final String pLabel, final boolean pOnlyFolders)
  {
    super(pLabel);
