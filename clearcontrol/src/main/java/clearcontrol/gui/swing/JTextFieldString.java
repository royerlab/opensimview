...
public class JTextFieldString extends JPanel
{
  ...
  public JTextFieldString(final String pValueName, final String pInicialValue)
  {
    super();
    ...
    mValueTextField.getDocument().addDocumentListener(new DocumentListener()
    {
      ...
      public void parseDoubleAndNotify()
      {
        ...
        {
          JOptionPane.showMessageDialog(null, "String cannot be parsed as double!", "Error Message", JOptionPane.ERROR_MESSAGE);
          return;
        }
      }
    });
