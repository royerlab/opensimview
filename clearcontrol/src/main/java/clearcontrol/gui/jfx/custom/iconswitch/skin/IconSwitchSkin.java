...
public class IconSwitchSkin extends SkinBase<IconSwitch> implements Skin<IconSwitch>
{
  ...
  private void resize()
  {
    ...
    if (width > 0 && height > 0)
    {
      ...
      symbol.relocate(height * 0.15 + (height * 0.59375 - height * 0.59375 * getSkinnable().getSymbolType().WIDTH_FACTOR) * 0.5, height * 0.18 + (height * 0.59375 - height * 0.59375 * getSkinnable().getSymbolType().HEIGHT_FACTOR) * 0.5);
