 ...
 * 2018
 */
public class FocusFinderZInstruction extends LightSheetMicroscopeInstructionBase implements InstructionInterface, LoggingFeature, PropertyIOableInstructionInterface
{
  ...
  public boolean enqueue(long pTimePoint)
  {
    ...
    double lIZ = lAcquisitionState.getInterpolationTables().get(LightSheetDOF.IZ, cpi, lLightSheetIndex);
  ...
  private double determineBestDeltaZAtZ(double lCPPositionZ, int lLightSheetIndex, int lCameraIdx)
  {
    ...
    if (debug)
    {
      ...
      Plot plot = new Plot("title", "quality", "z", lXAxis, lQualityPerSliceMeasurementsArray);
      plot.show();
    }
  ...
  */
  ...
  {
    return new Variable[]{getDeltaZVariable(), getExposureTimeInSecondsVariable(), getImageHeightVariable(), getImageWidthVariable(), getNumberOfImagesToTakeVariable(), getResetAllTheTime()};
  }
}
