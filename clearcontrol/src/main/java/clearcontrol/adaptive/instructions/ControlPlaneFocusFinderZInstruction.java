 ...
 * 2018
 */
public class ControlPlaneFocusFinderZInstruction extends LightSheetMicroscopeInstructionBase implements InstructionInterface, LoggingFeature
{
  ...
  public boolean enqueue(long pTimePoint)
  {
    ...
    {
      FocusFinderZInstruction lFocusFinder = new FocusFinderZInstruction(lLightSheetIndex, mDetectionArmIndex, mControlPlaneIndex, getLightSheetMicroscope());
