 ...
 * @author royer
 */
public interface AdaptationModuleInterface<S extends AcquisitionStateInterface<?, ?>> extends Function<Void, Boolean>, AsynchronousExecutorFeature, NameableInterface
{

  /**
   * Sets the parent adaptor
   *
   * @param pAdaptator parent adaptor
   */
   ...
   *
   * @param pPriority module priority
   */
