...
public class LightSheetPositioner
{
   ...
   */
  public void setAt(LightSheetMicroscope pLightSheetMicroscope, int pLightSheetIndex, double pPixelX, double pPixelY)
  {
    LightSheetInterface lLightSheetDevice = pLightSheetMicroscope.getDeviceLists().getDevice(LightSheetInterface.class, pLightSheetIndex);
   ...
   * @param pMaxY             max y
   */
  public void illuminateBox(LightSheetInterface pLightSheetDevice, double pMinX, double pMinY, double pMaxX, double pMaxY)
  {
  ...
  private SimpleMatrix getControlVector(double pPixelX, double pPixelY)
  {
    ...
    SimpleMatrix lControlVector = SimpleMatrix.wrap(getInverseTransformMatrix()).mult(lVector);
