...
public class Bezier extends PolynomialFunction
{
  ...
  {
    super(x4 - x1 + 3 * x2 - 3 * x3, 3 * (x1 + x3 - (2 * x2)), 3 * (x2 - x1), x1);
   ...
   * @return bezier value
   */
  public static double bezier(double x1, double x2, double x3, double x4, double x)
  {
    return x1 + 3 * x * (x2 - x1) + 3 * pow(x, 2) * (x1 + x3 - (2 * x2)) + pow(x, 3) * (x4 - x1 + 3 * x2 - 3 * x3);
