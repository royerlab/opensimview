package clearcontrol.imaging.interleaved;
 ...
 * 2018
 */
public class InterleavedFusionInstruction extends FusionInstruction implements InstructionInterface, LoggingFeature
{
  /**
  ...
  public boolean enqueue(long pTimePoint)
  {
    ...
    final InterleavedImageDataContainer lContainer = lDataWarehouse.getOldestContainer(InterleavedImageDataContainer.class);
