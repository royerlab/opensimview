...
public abstract class ImagerBase implements ImagerInterface, LoggingFeature
{
  ...
  private synchronized boolean image()
  {
    ...
    */
    ...
    try
    {
      lPlayQueueAndWait = mLightSheetMicroscope.playQueueAndWaitForStacks(lQueue, 100 + lQueue.getQueueLength(), TimeUnit.SECONDS);
  ...
  public void applyInterpolatedAcquisitionState(InterpolatedAcquisitionState pInterpolatedAcquisitionState, Double pAcquisitionZ)
  {
    invalidate();
