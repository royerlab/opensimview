 ...
 * @author royer
 */
public interface LightSheetAcquisitionStateInterface<S extends LightSheetAcquisitionStateInterface<S>> extends AcquisitionStateInterface<LightSheetMicroscopeInterface, LightSheetMicroscopeQueue>, Cloneable
{
   ...
   * @return queue
   */
  LightSheetMicroscopeQueue getQueue(int pCameraIndexMin, int pCameraIndexMax, int pLightSheetIndexMin, int pLightSheetIndexMax, int pLaserLineIndexMin, int pLaserLineIndexMax, int pExtendedDepthOfFieldSlices);
