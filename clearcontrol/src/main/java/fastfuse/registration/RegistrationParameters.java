...
public class RegistrationParameters
{
  ...
  {
    return new double[]{+mTranslationSearchRadius, +mTranslationSearchRadius, +mTranslationSearchRadius, +mRotationSearchRadius, +mRotationSearchRadius, +mRotationSearchRadius};
  }
