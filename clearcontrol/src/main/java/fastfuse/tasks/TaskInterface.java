...
public interface TaskInterface
{
   ...
   *
   * @param pAvailableImagesSlotKeys set of available slot keys
   ...
   *
   * @param pFastFusionEngine fast fusion engines
   * @param pWaitToFinish     true -> waits for computation to finish
