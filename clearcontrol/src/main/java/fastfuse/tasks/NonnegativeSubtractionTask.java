...
public class NonnegativeSubtractionTask extends TaskBase implements TaskInterface
{
  ...
  public NonnegativeSubtractionTask(String pSrc1ImageKey, Number pSrc2Number, String pDstImageKey)
  {
    this(pSrc1ImageKey, pSrc2Number, pDstImageKey, null);
  }

  public NonnegativeSubtractionTask(String pSrc1ImageKey, Number pSrc2Number, String pDstImageKey, ImageChannelDataType pDstDataType)
  {
    super(pSrc1ImageKey);
    setupProgram(NonnegativeSubtractionTask.class, "./kernels/arithmetic.cl");
  ...
  public NonnegativeSubtractionTask(String pSrc1ImageKey, String pSrc2ImageKey, String pDstImageKey)
  {
    this(pSrc1ImageKey, pSrc2ImageKey, pDstImageKey, null);
  }

  public NonnegativeSubtractionTask(String pSrc1ImageKey, String pSrc2ImageKey, String pDstImageKey, ImageChannelDataType pDstDataType)
  {
  ...
  public boolean enqueue(FastFusionEngineInterface pFastFusionEngine, boolean pWaitToFinish)
  {
    ...
    if (lDstDataType == null) lDstDataType = lSrc1Image.getChannelDataType();

    MutablePair<Boolean, ClearCLImage> lFlagAndDstImage = pFastFusionEngine.ensureImageAllocated(mDstImageKey, lDstDataType, lSrc1Image.getDimensions());
    ...
    try
    {
      if (mSrc2ImageKey == null)
      {
        ...
        ClearCLKernel lKernel = getKernel(lSrc1Image.getContext(), "subtract_constant", TaskHelper.getOpenCLDefines(lSrc1Image, lDstImage));
      ...
      } else
      {
        ...
        ClearCLImage lSrc2Image = pFastFusionEngine.getImage(mSrc2ImageKey);
        assert lSrc2Image.getChannelDataType() == lSrc1Image.getChannelDataType();

        ClearCLKernel lKernel = getKernel(lSrc1Image.getContext(), "subtract_image", TaskHelper.getOpenCLDefines(lSrc1Image, lDstImage));
        lKernel.setGlobalSizes(lDstImage.getDimensions());
