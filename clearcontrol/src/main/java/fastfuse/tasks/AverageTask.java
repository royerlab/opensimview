 ...
 * @author royer
 */
public class AverageTask extends FusionTaskBase implements TaskInterface
{
  /**
   ...
   */
  public AverageTask(String pImageASlotKey, String pImageBSlotKey, String pDestImageKey)
  {
   ...
   */
  public AverageTask(String pImageASlotKey, String pImageBSlotKey, String pImageCSlotKey, String pImageDSlotKey, String pDestImageSlotKey)
  {
  ...
  public boolean fuse(ClearCLImage lImageA, ClearCLImage lImageB, ClearCLImage lImageC, ClearCLImage lImageD, MutablePair<Boolean, ClearCLImage> pImageAndFlag, boolean pWaitToFinish)
  {
    ...
    try
    {
      if (mInputImagesSlotKeys.length == 2) lKernel = getKernel(lImageFused.getContext(), "fuseavg2");
      else if (mInputImagesSlotKeys.length == 4) lKernel = getKernel(lImageFused.getContext(), "fuseavg4");
    } catch (Exception e)
    {
      e.printStackTrace();
      return false;
