...
public class IdentityTask extends TaskBase implements TaskInterface
{
  ...
  public static List<TaskInterface> withSuffix(String pSuffix, String... pImageKeys)
  {
   ...
   *
   * @param pSrcImageSlotKey source slot key
   * @param pDstImageSlotKey destination slot key
   */
  public IdentityTask(String pSrcImageSlotKey, String pDstImageSlotKey)
  {
  ...
  {
    pFastFusionEngine.assignImageToAnotherSlotKey(mSrcImageSlotKey, mDstImageSlotKey);
    return true;
  }
