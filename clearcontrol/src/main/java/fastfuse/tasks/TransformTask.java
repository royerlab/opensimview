...
public class TransformTask extends TaskBase implements TaskInterface
{
   ...
   */
  public TransformTask(String pInputImageSlotKey, String pDestImageSlotKey)
  {
  ...
  public boolean enqueue(FastFusionEngineInterface pFastFusionEngine, boolean pWaitToFinish)
  {
    ...
    MutablePair<Boolean, ClearCLImage> lImageAndFlag = pFastFusionEngine.ensureImageAllocated(mDestImageSlotKey, lInputImage.getChannelDataType(), lInputImage.getDimensions());
    ...
    mTransformMatrixBuffer = MatrixUtils.matrixToBuffer(lImageFused.getContext(), mTransformMatrixBuffer, lInverseTransformMatrix);
