...
public class ContentTabPaneSkin extends BehaviorSkinBase<TabPane, TabPaneBehavior>
{
  ...
  private static class StyleableProperties
  {
    ...
    private final static CssMetaData<TabPane, TabAnimation> OPEN_TAB_ANIMATION = new CssMetaData<TabPane, ContentTabPaneSkin.TabAnimation>("-fx-open-tab-animation", new EnumConverter<TabAnimation>(TabAnimation.class), TabAnimation.GROW)
    {
    ...
    private final static CssMetaData<TabPane, TabAnimation> CLOSE_TAB_ANIMATION = new CssMetaData<TabPane, ContentTabPaneSkin.TabAnimation>("-fx-close-tab-animation", new EnumConverter<TabAnimation>(TabAnimation.class), TabAnimation.GROW)
    {
  ...
  class TabControlButtons extends StackPane
  {
    ...
    protected void layoutChildren()
    {
      ...
      inner.resize(w, h);
      positionInArea(inner, x, y, w, h,
              /*baseline ignored*/0, HPos.CENTER, VPos.BOTTOM);
    }
