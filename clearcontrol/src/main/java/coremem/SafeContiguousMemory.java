...
public class SafeContiguousMemory implements ContiguousMemoryInterface
{
   ...
   * checks.
   *
   * @param pContiguousMemory contiguous memory to wrap.
   ...
   *
   * @param pContiguousMemory contiguous memory to wrap.
   * @param pDoWrap           flag that determines if the wrapping occurs or not
  ...
  {
    checkOffset(pOffset);
    mDelegatedContiguousMemoryInterface.setByteAligned(pOffset, pValue);
  }
  ...
  {
    checkOffset(pOffset);
    mDelegatedContiguousMemoryInterface.setCharAligned(pOffset, pValue);
  }
  ...
  {
    checkOffset(pOffset);
    mDelegatedContiguousMemoryInterface.setShortAligned(pOffset, pValue);
  }
  ...
  {
    checkOffset(pOffset);
    mDelegatedContiguousMemoryInterface.setIntAligned(pOffset, pValue);
  }
  ...
  {
    checkOffset(pOffset);
    mDelegatedContiguousMemoryInterface.setLongAligned(pOffset, pValue);
  }
  ...
  {
    checkOffset(pOffset);
    mDelegatedContiguousMemoryInterface.setFloatAligned(pOffset, pValue);
  }
  ...
  {
    checkOffset(pOffset);
    mDelegatedContiguousMemoryInterface.setDoubleAligned(pOffset, pValue);
  }
  ...
  {
    return mDelegatedContiguousMemoryInterface.writeBytesToFileChannel(pFileChannel, pFilePositionInBytes);
  }
  ...
  public long writeBytesToFileChannel(long pBufferPositionInBytes, FileChannel pFileChannel, long pFilePositionInBytes, long pLengthInBytes) throws IOException
  {
    ...
    return mDelegatedContiguousMemoryInterface.writeBytesToFileChannel(pBufferPositionInBytes, pFileChannel, pFilePositionInBytes, pLengthInBytes);
  }
  ...
  public long readBytesFromFileChannel(FileChannel pFileChannel, long pFilePositionInBytes, long pLengthInBytes) throws IOException
  {
    ...
    return mDelegatedContiguousMemoryInterface.readBytesFromFileChannel(pFileChannel, pFilePositionInBytes, pLengthInBytes);
  }
  ...
  public long readBytesFromFileChannel(long pBufferPositionInBytes, FileChannel pFileChannel, long pFilePositionInBytes, long pLengthInBytes) throws IOException
  {
    checkOffset(pBufferPositionInBytes);
    checkOffset(pBufferPositionInBytes + pLengthInBytes - 1);
    return mDelegatedContiguousMemoryInterface.readBytesFromFileChannel(pBufferPositionInBytes, pFileChannel, pFilePositionInBytes, pLengthInBytes);
  }
  ...
  public ContiguousMemoryInterface subRegion(long pOffset, long pLenghInBytes)
  {
    ...
    return mDelegatedContiguousMemoryInterface.subRegion(pOffset, pLenghInBytes);
  }
  ...
  {
    mDelegatedContiguousMemoryInterface.copyTo(pTo, pSrcOffset, pDstOffset, pLength);
  }
  ...
  {
    mDelegatedContiguousMemoryInterface.copyFrom(pFrom, pSrcOffset, pDstOffset, pLength);
  }
