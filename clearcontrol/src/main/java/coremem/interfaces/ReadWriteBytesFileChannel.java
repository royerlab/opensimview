...
public interface ReadWriteBytesFileChannel
{
   ...
   * @param pFilePositionInBytes file position
   * @return file position past the last written byte.
   * @throws IOException Thrown in case of IO problem.
   */
  public long writeBytesToFileChannel(final FileChannel pFileChannel, final long pFilePositionInBytes) throws IOException;
   ...
   *
   * @param pFileChannel         file channel
   * @param pFilePositionInBytes offset in file channel
   * @param pLengthInBytes       length in bytes
   * @return File position past the last byte read.
   * @throws IOException Thrown in case of IO problem.
   */
  public long readBytesFromFileChannel(final FileChannel pFileChannel, final long pFilePositionInBytes, final long pLengthInBytes) throws IOException;
   ...
   * @throws IOException Thrown in case of IO problem.
   */
  public long readBytesFromFileChannel(final long pBufferPositionInBytes, final FileChannel pFileChannel, final long pFilePositionInBytes, final long pLengthInBytes) throws IOException;
