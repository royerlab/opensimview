...
public class TreePanel extends DockNode
{
   ...
   */
  public TreePanel(String pTitle, String pRootNodeName, InputStream pRootIcon, Collection<HalcyonNodeType> pHalcyonNodeTypes)
  {
    super(new VBox());
    setTitle(pTitle);
  ...
  public void setViewManager(ViewManager viewManager)
  {
    ...
    rootContextMenu = ContextMenuBuilder.create().items(MenuItemBuilder.create().text("open").onAction(new EventHandler<ActionEvent>()
            {
              @Override
              public void handle(ActionEvent arg0)
              {
                ...
                list.stream().forEach(c ->
                {
                  ...
                  {
                    if (c.getValue().getNode() == null) c.getChildren().forEach(t -> nodeList.add(t.getValue().getNode()));
                    else nodeList.add(c.getValue().getNode());
                  }
                });

                nodeList.stream().forEach(viewManager::open);
              }
            }).build(), MenuItemBuilder.create().text("open externally").onAction(new EventHandler<ActionEvent>()
            {
              @Override
              public void handle(ActionEvent arg0)
              {
            ...
            MenuItemBuilder.create().text("open vertically grouped panel").onAction(new EventHandler<ActionEvent>()
            {
              @Override
              public void handle(ActionEvent arg0)
              {
                ...
                HalcyonGroupNode lHalcyonGroupNode = new HalcyonGroupNode("", DemoHalcyonNodeType.ONE, HalcyonGroupNode.Grouping.Vertical, nodeList);

                viewManager.makeIndependentWindow(lHalcyonGroupNode);
              }
            }).build(),

            MenuItemBuilder.create().text("open horizontally grouped panel").onAction(new EventHandler<ActionEvent>()
            {
              @Override
              public void handle(ActionEvent arg0)
              {
                ...
                HalcyonGroupNode lHalcyonGroupNode = new HalcyonGroupNode("", DemoHalcyonNodeType.ONE, HalcyonGroupNode.Grouping.Horizontal, nodeList);

                viewManager.makeIndependentWindow(lHalcyonGroupNode);
              }
            }).build(), MenuItemBuilder.create().text("open tab grouped panel").onAction(new EventHandler<ActionEvent>()
            {
              @Override
              public void handle(ActionEvent arg0)
              {
                ...
                HalcyonGroupNode lHalcyonGroupNode = new HalcyonGroupNode("", DemoHalcyonNodeType.ONE, HalcyonGroupNode.Grouping.Tab, nodeList);
