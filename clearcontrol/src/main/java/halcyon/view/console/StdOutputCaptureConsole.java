...
public class StdOutputCaptureConsole extends DockNode
{
  ...
  public StdOutputCaptureConsole()
  {
    ...
    System.setOut(new PrintStream(new StreamAppender(" ", consolePane.getConsolePanel(), System.out)));
    System.setErr(new PrintStream(new StreamAppender("!", consolePane.getConsolePanel(), System.err)));
  }
