 ...
 */
public class HalcyonOtherNode extends HalcyonNodeBase implements HalcyonNodeInterface
{
   ...
   */
  public HalcyonOtherNode(String name, HalcyonNodeType type, Window pWindow)
  {
    super(name, type);
    mWindow = pWindow;
  }
