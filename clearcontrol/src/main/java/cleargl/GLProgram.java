...
public class GLProgram implements GLInterface, GLCloseable
{
  ...
  public static GLProgram buildProgram(final GL pGL, final Class<?> pClass, final String pVertexShaderRessourcePath, final String pFragmentShaderRessourcePath) throws IOException
  {
    final GLShader lVertexShader = new GLShader(pGL, pClass, pVertexShaderRessourcePath, GLShaderType.VertexShader);
    System.out.println(lVertexShader.getShaderInfoLog());

    final GLShader lFragmentShader = new GLShader(pGL, pClass, pFragmentShaderRessourcePath, GLShaderType.FragmentShader);
    System.out.println(lFragmentShader.getShaderInfoLog());
    final GLProgram lGLProgram = new GLProgram(lVertexShader, lFragmentShader);

    return lGLProgram;
  }

  @Deprecated
  public static GLProgram buildProgram(final GL pGL, final String pVertexShaderSourceAsString, final String pFragmentShaderSourceAsString) throws IOException
  {
    final GLShader lVertexShader = new GLShader(pGL, pVertexShaderSourceAsString, GLShaderType.VertexShader);
    System.out.println(lVertexShader.getShaderInfoLog());

    final GLShader lFragmentShader = new GLShader(pGL, pFragmentShaderSourceAsString, GLShaderType.FragmentShader);
    System.out.println(lFragmentShader.getShaderInfoLog());
    final GLProgram lGLProgram = new GLProgram(lVertexShader, lFragmentShader);
  ...
  public static GLProgram buildProgram(final GL pGL, final Class<?> pClass, final String[] shaders) throws IOException
  {
    final GLProgram lGLProgram = new GLProgram(pGL, shaderPipelineFromFilenames(pGL, pClass, shaders));
  ...
  public static GLProgram buildProgram(final GL pGL, final Class<?> pClass, final String[] shaders, final HashMap<String, String> parameters) throws IOException
  {
    final GLProgram lGLProgram = new GLProgram(pGL, shaderPipelineFromFilenames(pGL, pClass, shaders, parameters), parameters);
  ...
  public static GLProgram buildProgram(final GL pGL, final HashMap<GLShaderType, String> shaders) throws IOException
  {
    final GLProgram lGLProgram = new GLProgram(pGL, shaderPipelineFromStrings(pGL, shaders));
  ...
  private static String shaderFileForType(final GLShaderType type, final String[] shaders)
  {
  ...
  private static HashMap<GLShaderType, GLShader> shaderPipelineFromFilenames(final GL pGL, final Class<?> rootClass, final String[] shaders) throws IOException
  {
    ...
    for (final GLShaderType type : GLShaderType.values())
    {
      ...
      if (filename != null)
      {
        final GLShader shader = new GLShader(pGL, rootClass, filename, type);
  ...
  private static HashMap<GLShaderType, GLShader> shaderPipelineFromFilenames(final GL pGL, final Class<?> rootClass, final String[] shaders, final HashMap<String, String> params) throws IOException
  {
    final HashMap<GLShaderType, GLShader> pipeline = new HashMap<>();
    ...
    for (final GLShaderType type : GLShaderType.values())
    {
      ...
      if (filename != null)
      {
        final GLShader shader = new GLShader(pGL, rootClass, filename, type, params);
  ...
  private static HashMap<GLShaderType, GLShader> shaderPipelineFromStrings(final GL pGL, final HashMap<GLShaderType, String> shaders) throws IOException
  {
    ...
    {
      final GLShader shader = new GLShader(pGL, shaders.get(type), type);
  ...
  public GLProgram(final GL pGL, final HashMap<GLShaderType, GLShader> pipeline, final HashMap<String, String> parameters)
  {
    super();
  ...
  {
    final int lAttributeId = mGL.getGL3().glGetAttribLocation(mProgramId, pAttributeName);
  ...
  public String getProgramInfoLog()
  {
    ...
    if (status[0] == GL3.GL_TRUE) return "";

    final int[] lLength = new int[1];
    final byte[] lBytes = new byte[lLogLength + 1];
    mGL.getGL3().glGetProgramInfoLog(mProgramId, lLogLength, lLength, 0, lBytes, 0);
  ...
  public int getProgramParameter(final int pParameterName)
  {
    ...
    mGL.getGL3().glGetProgramiv(mProgramId, pParameterName, lParameter, 0);
    return lParameter[0];
  }
  ...
  public String toString()
  {
    ...
    return "GLProgram [mGL=" + mGL + ", mProgramId=" + mProgramId + "]\n----\nCode:\n" + code;
  }
