...
public class GLVertexArray implements GLCloseable, GLInterface
{
  ...
  {
    mGLInterface.getGL().getGL3().glDeleteVertexArrays(1, mVertexArrayId, 0);
  }

  public void addVertexAttributeArray(final GLVertexAttributeArray pGLVertexAttributeArray, final FloatBuffer pFloatBuffer)
  {
    bind();
    ...
    getGL().getGL3().glVertexAttribPointer(lAttribute.getIndex(), lElementsPerIndex, GL.GL_FLOAT, false, 0, 0);
  }

  public void addIndexArray(final GLVertexAttributeArray pGLVertexAttributeArray, final IntBuffer pIndexBuffer)
  {
    bind();
  ...
  {
    return "GLVertexArray [mGLInterface=" + mGLInterface + ", mVertexArrayId=" + Arrays.toString(mVertexArrayId) + ", mNumberOfIndices=" + mNumberOfIndices + "]";
  }
