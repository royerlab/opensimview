...
public class GLIntArray
{
  ...
  {
    return ByteBuffer.allocateDirect(pNewCapacity * mElementSize * (Integer.SIZE / Byte.SIZE)).order(ByteOrder.nativeOrder()).asIntBuffer();
  }
  ...
  {
    while (mIntBuffer.hasRemaining()) mIntBuffer.put(0);
  }
