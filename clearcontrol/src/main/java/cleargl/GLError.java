...
public class GLError
{
  ...
  public static final String printGLErrors(final GL lGL, final String lDescription)
  {
    if (System.getProperty("ClearGL.CheckForOpenGLErrors") != null)
    {
      ...
      if (lGLErrorCode != 0) System.err.format("OPENGL ERROR %s #%d : %s \n", lDescription, lGLErrorCode, lGLErrorStr);
      return lGLErrorStr;
    } else
    {
      return "";
