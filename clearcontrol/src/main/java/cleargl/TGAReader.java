...
public final class TGAReader
{
  ...
  private static byte[] decodeRLE(final int width, final int height, final int depth, final byte[] buffer, int offset)
  {
  ...
  private static int[] createPixelsFromColormap(final int width, final int height, final int depth, final byte[] bytes, final int offset, final byte[] palette, final int colormapOrigin, final int descriptor, final Order order) throws IOException
  {
    int[] pixels = null;
  ...
  private static int[] createPixelsFromRGB(final int width, final int height, final int depth, final byte[] bytes, final int offset, final int descriptor, final Order order) throws IOException
  {
    int[] pixels = null;
    final int rs = order.redShift;
    final int gs = order.greenShift;
  ...
  private static int[] createPixelsFromGrayscale(final int width, final int height, final int depth, final byte[] bytes, final int offset, final int descriptor, final Order order) throws IOException
  {
    int[] pixels = null;
    final int rs = order.redShift;
    final int gs = order.greenShift;
