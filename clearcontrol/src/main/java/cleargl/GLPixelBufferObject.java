...
public class GLPixelBufferObject implements GLInterface, GLCloseable
{
  ...
  public GLPixelBufferObject(final GLInterface pGLInterface, final int pWidth, final int pHeight)
  {
    super();
  ...
  public void bind()
  {
    mGLInterface.getGL().glBindBuffer(GL2ES3.GL_PIXEL_UNPACK_BUFFER, getId());
  }

  public void unbind()
  {
    mGLInterface.getGL().glBindBuffer(GL2ES3.GL_PIXEL_UNPACK_BUFFER, 0);
  }

  public void copyFrom(final Buffer pBuffer)
  {
    bind();
    mGLInterface.getGL().glBufferData(GL2ES3.GL_PIXEL_UNPACK_BUFFER, mTextureWidth * mTextureHeight * 1 * 4, null, GL.GL_DYNAMIC_DRAW);
    unbind();
  }
  ...
  {
    return "GLPixelBufferObject [mGLInterface=" + mGLInterface + ", mPixelBufferObjectId=" + Arrays.toString(mPixelBufferObjectId) + ", mTextureWidth=" + mTextureWidth + ", mTextureHeight=" + mTextureHeight + "]";
  }
