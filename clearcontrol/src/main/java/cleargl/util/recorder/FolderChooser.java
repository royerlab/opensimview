...
public class FolderChooser extends JFileChooser
{
  ...
  public static File openFolderChooser(Component pParent, String pChooserTitle, File pDefaultFolder)
  {
    FolderChooser lFolderChooser = new FolderChooser(pChooserTitle, pDefaultFolder);
