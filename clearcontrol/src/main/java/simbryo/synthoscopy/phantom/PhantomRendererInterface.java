 ...
 *
 * @param <I> type of image used to store phantom
 * @author royer
 */
public interface PhantomRendererInterface<I> extends SynthoscopyInterface<I>
{
   ...
   * re-render.
   *
   * @param pZPlaneIndexBegin begin of z plane index range
   * @param pZPlaneIndexEnd   end of z plane index range
