...
public enum CameraParameter implements ParameterInterface<Number>
{
  ...
  ROIXMin(0, 0, 2048), ROIXMax(0, 0, 2048), ROIWidth(1024, 0, 2048), ROIHeight(1024, 0, 2048), ROIOffsetX(0, -1024, 1024), ROIOffsetY(0, -1024, 1024),

  Magnification(1, 0, 10), ShiftX(0, -1, 1), ShiftY(0, -1, 1);

  Number mDefaultValue, mMinValue, mMaxValue;

  private CameraParameter(Number pDefaultValue, Number pMinValue, Number pMaxValue)
  {
