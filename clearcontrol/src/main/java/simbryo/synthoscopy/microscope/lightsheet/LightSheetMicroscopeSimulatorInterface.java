 ...
 * @author royer
 */
public interface LightSheetMicroscopeSimulatorInterface extends MicroscopeSimulatorInterface
{
   ...
   * @param pDownUpVector             updown vector
   * @param pMaxCameraWidth           max camera width
   * @param pMaxCameraHeight          max camera height
   */
  void addDetectionPath(Matrix4f pDetectionTransformMatrix, Vector3f pDownUpVector, int pMaxCameraWidth, int pMaxCameraHeight);
