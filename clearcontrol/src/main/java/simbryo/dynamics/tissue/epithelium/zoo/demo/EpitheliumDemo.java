...
public class EpitheliumDemo
{
  ...
  public void demoTwoLayeredEpithelium() throws InterruptedException
  {
    ...
    TwoLayeredEpithelium lTwoLayeredEpithelium = new TwoLayeredEpithelium(128, 2f * radius - 0.00000001f, radius);

    ParticleViewer3D lOpen3dViewer = lTwoLayeredEpithelium.open3DViewer();

    lOpen3dViewer.setColorClosure((id) ->
    {
      int lCellLabel = (int) lTwoLayeredEpithelium.getCellLabelProperty().getArray().getCurrentArray()[id];
