...
public class CellProperty implements Serializable
{
   ...
   *
   * @param pTissueDynamics tissue dynamics
   * @param pDimension      dimension of cell property
   */
  public CellProperty(TissueDynamics pTissueDynamics, int pDimension)
  {
    ...
    mPropertyArray = new DoubleBufferingFloatArray(getDimension() * mEmbryo.getMaxNumberOfParticles());
  }
   ...
   *
   * @param pBeginId begin id of range
   * @param pEndId   end id of range
   */
  public void copyDefault(int pBeginId, int pEndId)
  {
    mPropertyArray.copyDefault(pBeginId * mDimension, pEndId * mDimension);
  }
   ...
   * @param pDestParticleId   destination id
   */
  public void copyValue(int pSourceParticleId, int pDestParticleId)
  {
    float[] lMorphogenArray = mPropertyArray.getCurrentArray();
    lMorphogenArray[getDimension() * pDestParticleId] = lMorphogenArray[getDimension() * pSourceParticleId];
  }
