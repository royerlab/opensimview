 ...
 * @author royer
 */
public class SimplexNoise extends TextureGeneratorBase implements TextureGeneratorInterface
{
  ...
  {
    if (getDimension() != pCoordinate.length) throw new IllegalArgumentException("Incompatible dimensions!");
    ...
    {
      float lValue = (float) noise(pCoordinate[0] * getScale(0), pCoordinate[1] * getScale(1));
      return lValue;
    } else if (getDimension() == 3)
    {
      float lValue = (float) noise(pCoordinate[0] * getScale(0), pCoordinate[2] * getScale(2), pCoordinate[1] * getScale(1));
      return lValue;
    }
