...
public class Collider extends Application
{
  ...
  public void start(Stage primaryStage)
  {
    ...
    try
    {
      ...
      CollisionForceField lCollisionForceField = new CollisionForceField(cCollisionForce, cDragCoeficient, true);

      ParticleSystem lParticleSystem = new ParticleSystem(2, cNumberOfParticles, 0.5f * cRadius, cRadius);

      ParticleViewer2D lParticleViewer = new ParticleViewer2D(lParticleSystem, "Particles Are Fun", 768, 768);
  ...
  {
    if (lParticleSystem.getNumberOfParticles() >= lParticleSystem.getMaxNumberOfParticles()) return;
