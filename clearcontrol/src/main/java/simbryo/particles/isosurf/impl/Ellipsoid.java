...
public class Ellipsoid extends IsoSurfaceBase implements IsoSurfaceInterface
{
   ...
   * @param pCenterAndAxis center and axis {cx, cy, cz, ..., a, b, c, ,...}
   */
  ...
  public void addCoordinate(float pValue)
  {
    ...
    if (mIndex == mDimension - 1)
    {
      ...
      float lGradientlength = (float) Math.sqrt(mAccumulatorGradientLength);
