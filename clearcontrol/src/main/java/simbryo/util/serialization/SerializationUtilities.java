...
public class SerializationUtilities
{
   ...
   *
   * @param pObject object to save
   * @param pFile   file to save to
   * @throws IOException thrown if problem occurs while writing file
   */
  public static <O extends Serializable> void saveToFile(O pObject, File pFile) throws IOException
  {
    pFile.getParentFile().mkdirs();
    try (FileOutputStream lFileOutputStream = new FileOutputStream(pFile))
    {
   ...
   * @throws IOException thrown if problem occurs while reading file
   */
  ...
  public static <O extends Serializable> O loadFromFile(Class<O> pClass, File pFile) throws IOException
  {
    ...
    try (FileInputStream lFileInputStream = new FileInputStream(pFile))
    {
