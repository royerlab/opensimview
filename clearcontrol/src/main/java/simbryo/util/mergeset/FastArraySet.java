...
public class FastArraySet
{
   ...
   */
  public static final int merge(final int[] pSetA, final int[] pSetB, final int[] pSetAuB)
  {
    return merge(pSetA, 0, pSetA.length, pSetB, 0, pSetB.length, pSetAuB, 0);
  }
   ...
   * @return size of resulting set
   */
  public static final int merge(final int[] pSetA, final int pStartA, final int[] pSetB, final int pStartB, final int[] pSetAuB, final int pStartAuB)
  {
    return merge(pSetA, pStartA, Integer.MAX_VALUE / 2, pSetB, pStartB, Integer.MAX_VALUE / 2, pSetAuB, pStartAuB);
  }
   ...
   * @return size of resulting set
   */
  public static final int merge(final int[] pSetA, final int pStartA, final int pLengthA, final int[] pSetB, final int pStartB, final int pLengthB, final int[] pSetAuB, final int pStartAuB)
  {
    ...
    for (; lIndexA < pStartA + pLengthA && lIndexB < pStartB + pLengthB; )
    {
      int lValueA = pSetA[lIndexA];
      int lValueB = pSetB[lIndexB];

      if (lValueA == -1 || lValueB == -1) break;
