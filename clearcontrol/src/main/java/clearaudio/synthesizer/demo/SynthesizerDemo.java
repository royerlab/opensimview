...
public class SynthesizerDemo
{
  ...
  public void demoHighlyFilteredGuitar() throws LineUnavailableException
  {
    ...
    Synthesizer lSynthesizer = new Synthesizer(lLowPassFilter, lSoundOut);
    ...
    for (int i = 0; i < 100000; i++)
    {
      ...
      lGuitar.setFrequencyInHertz((float) (220 + 440 + 440 * sin(2 * PI * i / 1000)));
      if (i % 10 == 0) lGuitar.strike(0.5f);
  ...
  public void demoShepardRissetGlissando() throws LineUnavailableException
  {
    ...
    Synthesizer lSynthesizer = new Synthesizer(lShepardRissetGlissando, lSoundOut);
