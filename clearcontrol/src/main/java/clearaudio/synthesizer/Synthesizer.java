...
public class Synthesizer
{
   ...
   *
   * @param pReentrantLock reentrant lock to unlock.
   * @return estimated time in seconds spent in the call.
   */
   ...
   *
   * @param pNumberOfSamples number of samples to play.
   * @return estimated time in seconds spent in the call.
   */
   ...
   */
  public double playSamples(int pNumberOfSamples, ReentrantLock pReentrantLock)
  {
    if (mBuffer == null || mBuffer.length < pNumberOfSamples) mBuffer = new float[pNumberOfSamples];
