 ...
 * @author royer
 */
public class ClearCLBuffer extends ClearCLMemBase implements ClearCLMemInterface, ClearCLImageInterface, Cleanable

{
   ...
   */
  ClearCLBuffer(ClearCLContext pClearCLContext, ClearCLPeerPointer pBufferPointer, MemAllocMode pMemAllocMode, HostAccessType pHostAccessType, KernelAccessType pKernelAccessType, long pNumberOfChannels, NativeTypeEnum pNativeType, long... pDimensions)
  {
   ...
   * @param pBlockingFill   true -> blocking call, false -> asynchronous call
   */
  public void fill(byte[] pPattern, long pOffsetInBuffer, long pLengthInBuffer, boolean pBlockingFill)
  {
    if (!(pOffsetInBuffer + pLengthInBuffer <= getVolume())) throw new ClearCLException("Incompatible length");

    getBackend().enqueueFillBuffer(mClearCLContext.getDefaultQueue().getPeerPointer(), getPeerPointer(), pBlockingFill, pOffsetInBuffer * getNativeType().getSizeInBytes(), pLengthInBuffer * getNativeType().getSizeInBytes(), pPattern);
   ...
   * @param pBlockingCopy      true -> blocking call, false -> asynchronous call
   */
  public void copyTo(ClearCLBuffer pDstBuffer, long pOffsetInSrcBuffer, long pOffsetInDstBuffer, long pLengthInElements, boolean pBlockingCopy)
  {
    if ((pOffsetInSrcBuffer + pLengthInElements) * getPixelSizeInBytes() > getSizeInBytes() || (pOffsetInDstBuffer + pLengthInElements) * getPixelSizeInBytes() > pDstBuffer.getSizeInBytes())
      throw new ClearCLException("Incompatible length");

    getBackend().enqueueCopyBuffer(mClearCLContext.getDefaultQueue().getPeerPointer(), getPeerPointer(), pDstBuffer.getPeerPointer(), pBlockingCopy, pOffsetInSrcBuffer * getNativeType().getSizeInBytes(), pOffsetInDstBuffer * getNativeType().getSizeInBytes(), pLengthInElements * getNativeType().getSizeInBytes());
   ...
   * @param pBlockingCopy      true -> blocking call, false -> asynchronous call
   */
  public void copyTo(ClearCLBuffer pDstBuffer, long[] pOriginInSrcBuffer, long[] pOriginInDstBuffer, long[] pRegion, boolean pBlockingCopy)
  {
    getBackend().enqueueCopyBufferRegion(mClearCLContext.getDefaultQueue().getPeerPointer(), getPeerPointer(), pDstBuffer.getPeerPointer(), pBlockingCopy, Region3.origin(pOriginInSrcBuffer), Region3.origin(pOriginInDstBuffer), Region3.region(pRegion));
    pDstBuffer.notifyListenersOfChange(mClearCLContext.getDefaultQueue());
  }
  ...
  {
    copyTo(pDstImage, 0, Region3.originZero(), Region3.region(pDstImage.getDimensions()), pBlockingCopy);
  }
   ...
   * @param pBlockingCopy      true -> blocking call, false -> asynchronous call
   */
  public void copyTo(ClearCLImage pDstImage, long pOffsetInSrcBuffer, long[] pDstOrigin, long[] pDstRegion, boolean pBlockingCopy)
  {
    getBackend().enqueueCopyBufferToImage(mClearCLContext.getDefaultQueue().getPeerPointer(), getPeerPointer(), pDstImage.getPeerPointer(), pBlockingCopy, pOffsetInSrcBuffer * getNativeType().getSizeInBytes(), Region3.origin(pDstOrigin), Region3.region(pDstRegion));
  ...
  public void copyTo(ClearCLHostImageBuffer pClearCLHostImage, boolean pBlockingCopy)
  {
    ...
    if (getSizeInBytes() != pClearCLHostImage.getSizeInBytes()) throw new ClearCLException("Incompatible sizes");

    getBackend().enqueueReadFromBuffer(mClearCLContext.getDefaultQueue().getPeerPointer(), getPeerPointer(), pBlockingCopy, 0, getSizeInBytes(), getBackend().wrap(pClearCLHostImage.getContiguousMemory()));
   ...
   */
  @Override
  public void writeTo(ContiguousMemoryInterface pContiguousMemory, boolean pBlockingWrite)
  {
   ...
   * @param pBlockingWrite    true -> blocking call, false -> asynchronous call
   */
  public void writeTo(ContiguousMemoryInterface pContiguousMemory, long pOffsetInBuffer, long pLengthInBuffer, boolean pBlockingWrite)
  {
    if (!getHostAccessType().isReadableFromHost()) throw new ClearCLHostAccessException("Image not readable from host");

    if ((pOffsetInBuffer + pLengthInBuffer) * getPixelSizeInBytes() > pContiguousMemory.getSizeInBytes() || (pOffsetInBuffer + pLengthInBuffer) * getPixelSizeInBytes() > getSizeInBytes())
      throw new ClearCLException("Incompatible length");

    ClearCLPeerPointer lHostMemPointer = getBackend().wrap(pContiguousMemory);

    getBackend().enqueueReadFromBuffer(mClearCLContext.getDefaultQueue().getPeerPointer(), getPeerPointer(), pBlockingWrite, pOffsetInBuffer * getNativeType().getSizeInBytes(), pLengthInBuffer * getNativeType().getSizeInBytes(), lHostMemPointer);
  }
   ...
   * @param pBlockingWrite  true -> blocking call, false -> asynchronous call
   */
  public void writeTo(Buffer pBuffer, long pOffsetInBuffer, long pLengthInBuffer, boolean pBlockingWrite)
  {
    if (!getHostAccessType().isReadableFromHost()) throw new ClearCLHostAccessException("Image not readable from host");

    if ((pOffsetInBuffer + pLengthInBuffer) * getPixelSizeInBytes() > Size.ofBuffer(pBuffer) || (pOffsetInBuffer + pLengthInBuffer) * getPixelSizeInBytes() > getSizeInBytes())
      throw new ClearCLException("Incompatible length");
   ...
   * @param pBlockingRead     true -> blocking call, false -> asynchronous call
   */
  public void readFrom(ContiguousMemoryInterface pContiguousMemory, long pOffsetInBuffer, long pLengthInBuffer, boolean pBlockingRead)
  {
    ...
    getBackend().enqueueWriteToBuffer(mClearCLContext.getDefaultQueue().getPeerPointer(), getPeerPointer(), pBlockingRead, pOffsetInBuffer * getNativeType().getSizeInBytes(), pLengthInBuffer * getNativeType().getSizeInBytes(), lHostMemPointer);
    notifyListenersOfChange(mClearCLContext.getDefaultQueue());
  }
   ...
   * @param pBlockingRead   true -> blocking call, false -> asynchronous call
   */
  public void readFrom(Buffer pBuffer, long pOffsetInBuffer, long pLengthInBuffer, boolean pBlockingRead)
  {
    if (!getHostAccessType().isWritableFromHost()) throw new ClearCLHostAccessException("Image not writable from host");
   ...
   * @param pBlockingWrite     true -> blocking call, false -> asynchronous call
   */
  public void writeTo(ContiguousMemoryInterface pContiguousMemory, long[] pSourceOrigin, long[] pDestinationOrigin, long[] pRegion, boolean pBlockingWrite)
  {
    if (!getHostAccessType().isReadableFromHost()) throw new ClearCLHostAccessException("Image not readable from host");

    ClearCLPeerPointer lHostMemPointer = getBackend().wrap(pContiguousMemory);

    getBackend().enqueueReadFromBufferRegion(mClearCLContext.getDefaultQueue().getPeerPointer(), getPeerPointer(), pBlockingWrite, Region3.origin(pSourceOrigin), Region3.origin(pDestinationOrigin), Region3.region(pRegion), lHostMemPointer);
  }
   ...
   * @param pBlockingWrite     true -> blocking call, false -> asynchronous call
   */
  public void writeTo(Buffer pBuffer, long[] pSourceOrigin, long[] pDestinationOrigin, long[] pRegion, boolean pBlockingWrite)
  {
    if (!getHostAccessType().isReadableFromHost()) throw new ClearCLHostAccessException("Image not readable from host");
   ...
   * @param pBlockingRead      true -> blocking call, false -> asynchronous call
   */
  public void readFrom(ContiguousMemoryInterface pContiguousMemory, long[] pSourceOrigin, long[] pDestinationOrigin, long[] pRegion, boolean pBlockingRead)
  {
    if (!getHostAccessType().isWritableFromHost()) throw new ClearCLHostAccessException("Image not writable from host");

    ClearCLPeerPointer lHostMemPointer = getBackend().wrap(pContiguousMemory);

    getBackend().enqueueWriteToBufferRegion(mClearCLContext.getDefaultQueue().getPeerPointer(), getPeerPointer(), pBlockingRead, Region3.origin(pDestinationOrigin), Region3.origin(pSourceOrigin), Region3.region(pRegion), lHostMemPointer);
   ...
   * @param pBlockingRead      true -> blocking call, false -> asynchronous call
   */
  public void readFrom(Buffer pBuffer, long[] pSourceOrigin, long[] pDestinationOrigin, long[] pRegion, boolean pBlockingRead)
  {
    if (!getHostAccessType().isWritableFromHost()) throw new ClearCLHostAccessException("Image not writable from host");
  ...
  {
    return String.format("ClearCLBuffer [mClearCLContext=%s, mNativeType=%s, mNumberOfChannels=%s, mDimensions=%s, getMemAllocMode()=%s, getHostAccessType()=%s, getKernelAccessType()=%s, getBackend()=%s, getPeerPointer()=%s]", mClearCLContext, mNativeType, mNumberOfChannels, Arrays.toString(mDimensions), getMemAllocMode(), getHostAccessType(), getKernelAccessType(), getBackend(), getPeerPointer());
  }
  ...
  public void close()
  {
    ...
    if (getPeerPointer() != null)
    {
      ...
      if (mBufferCleaner != null) mBufferCleaner.mClearCLPeerPointer = null;
  ...
  private static class BufferCleaner implements Cleaner
  {
    ...
    public BufferCleaner(ClearCLBackendInterface pBackend, ClearCLPeerPointer pClearCLPeerPointer)
    {
      mBackend = pBackend;
    ...
    public void run()
    {
      ...
      try
      {
        ...
        {
          if (ClearCL.sDebugRGC) System.out.println("Releasing buffer: " + mClearCLPeerPointer.toString());
