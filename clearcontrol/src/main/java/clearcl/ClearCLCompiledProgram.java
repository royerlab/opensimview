...
public class ClearCLCompiledProgram extends ClearCLBase implements Cleanable
{
   ...
   */
  ClearCLCompiledProgram(ClearCLDevice pDevice, ClearCLContext pClearCLContext, ClearCLProgram pClearCLProgram, String pSourceCode, ClearCLPeerPointer pProgramPointer)
  {
  ...
  public ClearCLKernel createKernel(String pKernelName)
  {
    ...
    ClearCLPeerPointer lKernelPointer = getBackend().getKernelPeerPointer(this.getPeerPointer(), pKernelName);

    ClearCLKernel lClearCLKernel = new ClearCLKernel(getContext(), this, lKernelPointer, pKernelName, mSourceCode);
  ...
  public void close()
  {
    ...
    {
      if (mCompiledProgramCleaner != null) mCompiledProgramCleaner.mClearCLPeerPointer = null;
  ...
  private static class CompiledProgramCleaner implements Cleaner
  {
    ...
    public CompiledProgramCleaner(ClearCLBackendInterface pBackend, ClearCLPeerPointer pClearCLPeerPointer)
    {
      mBackend = pBackend;
    ...
    public void run()
    {
      ...
      try
      {
        ...
        {
          if (ClearCL.sDebugRGC) System.out.println("Releasing compiled program: " + mClearCLPeerPointer);
