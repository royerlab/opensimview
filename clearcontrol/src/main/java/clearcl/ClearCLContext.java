...
public class ClearCLContext implements Cleanable, Closeable
{
   ...
   */
  ClearCLContext(final ClearCLDevice pClearCLDevice, ClearCLRecyclablePeerPointer pContextPointer)
  {
    super();
  ...
  public ClearCLQueue createQueue()
  {
    ...
    final ClearCLPeerPointer lQueuePointer = getBackend().getQueuePeerPointer(getDevice().getPeerPointer(), getPeerPointer(), true);
   ...
   */
  public ClearCLBuffer createBuffer(final MemAllocMode pMemAllocMode, final HostAccessType pHostAccessType, final KernelAccessType pKernelAccessType, final ClearCLImage pTemplate)
  {
    return createBuffer(pMemAllocMode, pHostAccessType, pKernelAccessType, pTemplate.getNumberOfChannels(), pTemplate.getNativeType(), pTemplate.getDimension());
  }
   ...
   * @return created buffer
   */
  public ClearCLBuffer createBuffer(final NativeTypeEnum pNativeType, final long pBufferLengthInElements)
  {
    return createBuffer(MemAllocMode.Best, HostAccessType.ReadWrite, KernelAccessType.ReadWrite, pNativeType, pBufferLengthInElements);
  }
   ...
   * @return created buffer
   */
  public ClearCLBuffer createBuffer(final HostAccessType pHostAccessType, final KernelAccessType pKernelAccessType, final NativeTypeEnum pNativeType, final long pBufferLengthInElements)
  {
    return createBuffer(MemAllocMode.Best, pHostAccessType, pKernelAccessType, pNativeType, pBufferLengthInElements);
  }
   ...
   * @return created buffer
   */
  public ClearCLBuffer createBuffer(final MemAllocMode pMemAllocMode, final NativeTypeEnum pNativeType, final long pBufferLengthInElements)
  {
    return createBuffer(pMemAllocMode, HostAccessType.ReadWrite, KernelAccessType.ReadWrite, pNativeType, pBufferLengthInElements);
  }
   ...
   * @return created buffer
   */
  public ClearCLBuffer createBuffer(final MemAllocMode pMemAllocMode, final HostAccessType pHostAccessType, final KernelAccessType pKernelAccessType, final NativeTypeEnum pNativeType, final long pBufferLengthInElements)
  {
    return createBuffer(pMemAllocMode, pHostAccessType, pKernelAccessType, 1, pNativeType, pBufferLengthInElements);
  }
   ...
   * @return created buffer
   */
  public ClearCLBuffer createBuffer(final MemAllocMode pMemAllocMode, final HostAccessType pHostAccessType, final KernelAccessType pKernelAccessType, final long pNumberOfChannels, final NativeTypeEnum pNativeType, final long... pDimensions)
  {
    ...
    final long lBufferSizeInBytes = lVolume * pNumberOfChannels * pNativeType.getSizeInBytes();

    if (lBufferSizeInBytes < 0) throw new OpenCLException(-61);

    final ClearCLPeerPointer lBufferPointer = getBackend().getBufferPeerPointer(getDevice().getPeerPointer(), getPeerPointer(), pMemAllocMode, pHostAccessType, pKernelAccessType, lBufferSizeInBytes);

    final ClearCLBuffer lClearCLBuffer = new ClearCLBuffer(this, lBufferPointer, pMemAllocMode, pHostAccessType, pKernelAccessType, pNumberOfChannels, pNativeType, pDimensions);
   ...
   * @return created image
   */
  public ClearCLImage createImage(ClearCLImage pImage, ImageChannelDataType pChannelDataType)
  {
    return createImage(pImage.getMemAllocMode(), pImage.getHostAccessType(), pImage.getKernelAccessType(), pImage.getChannelOrder(), pChannelDataType == null ? pImage.getChannelDataType() : pChannelDataType, pImage.getDimensions());
  }
   ...
   */
  public ClearCLImage createSingleChannelImage(final ImageChannelDataType pImageChannelType, final long... pDimensions)
  {
    return createImage(MemAllocMode.Best, HostAccessType.ReadWrite, KernelAccessType.ReadWrite, getDevice().getType().isCPU() ? ImageChannelOrder.Intensity : ImageChannelOrder.R, pImageChannelType, pDimensions);
  }
   ...
   * @return 1D, 2D, or 3D image
   */
  public ClearCLImage createImage(final ImageChannelOrder pImageChannelOrder, final ImageChannelDataType pImageChannelType, final long... pDimensions)
  {
    return createImage(MemAllocMode.Best, HostAccessType.ReadWrite, KernelAccessType.ReadWrite, pImageChannelOrder, pImageChannelType, pDimensions);
  }
   ...
   * @return 1D, 2D, or 3D image
   */
  public ClearCLImage createSingleChannelImage(final HostAccessType pHostAccessType, final KernelAccessType pKernelAccessType, final ImageChannelDataType pImageChannelType, final long... pDimensions)
  {
    return createImage(MemAllocMode.Best, pHostAccessType, pKernelAccessType, getDevice().getType().isCPU() ? ImageChannelOrder.Intensity : ImageChannelOrder.R, pImageChannelType, pDimensions);
  }
   ...
   * @return 1D, 2D, or 3D image
   */
  public ClearCLImage createImage(final HostAccessType pHostAccessType, final KernelAccessType pKernelAccessType, final ImageChannelOrder pImageChannelOrder, final ImageChannelDataType pImageChannelType, final long... pDimensions)
  {
    return createImage(MemAllocMode.Best, pHostAccessType, pKernelAccessType, pImageChannelOrder, pImageChannelType, pDimensions);
  }
   ...
   * @return 1D, 2D, or 3D image
   */
  public ClearCLImage createImage(final MemAllocMode pMemAllocMode, final HostAccessType pHostAccessType, final KernelAccessType pKernelAccessType, final ImageChannelOrder pImageChannelOrder, final ImageChannelDataType pImageChannelType, final long... pDimensions)
  {
    ...
    final ClearCLPeerPointer lImage = getBackend().getImagePeerPointer(getDevice().getPeerPointer(), getPeerPointer(), pMemAllocMode, pHostAccessType, pKernelAccessType, lImageType, pImageChannelOrder, pImageChannelType, pDimensions);

    final ClearCLImage lClearCLImage = new ClearCLImage(this, lImage, pMemAllocMode, pHostAccessType, pKernelAccessType, lImageType, pImageChannelOrder, pImageChannelType, pDimensions);
   ...
   */
  public ClearCLProgram createProgram(final Class<?> pClassForRessource, final String... pRessourceNames) throws IOException
  {
  ...
  public void close()
  {
    ...
    {
      if (mContextCleaner != null) mContextCleaner.mClearCLContextPeerPointer = null;
  ...
  private static class ContextCleaner implements Cleaner
  {
    ...
    public ContextCleaner(ClearCLBackendInterface pBackend, ClearCLRecyclablePeerPointer pClearCLContextPeerPointer)
    {
      mBackend = pBackend;
    ...
    public void run()
    {
      ...
      try
      {
        if (mClearCLContextPeerPointer != null)
        {
          ...
          {
            System.out.println("Releasing context: " + mClearCLContextPeerPointer.toString());
            System.out.println("          pointer: " + mClearCLContextPeerPointer.getPointer());
          }
