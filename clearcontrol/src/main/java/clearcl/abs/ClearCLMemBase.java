...
public abstract class ClearCLMemBase extends ClearCLBase implements ClearCLMemInterface
{
   ...
   * @param pMemAllocMode            mem allocation mode
   * @param pHostAccessType          host access type
   * @param pKernelAccessType        kernel access type
   */
  public ClearCLMemBase(ClearCLBackendInterface pClearCLBackendInterface, ClearCLPeerPointer pPointer, MemAllocMode pMemAllocMode, HostAccessType pHostAccessType, KernelAccessType pKernelAccessType)
  {
  ...
  {
    return String.format("ClearCLMemBase [mMemAllocMode=%s, mHostAccessType=%s, mKernelAccessType=%s, mListener=%s, getBackend()=%s, getPeerPointer()=%s]", mMemAllocMode, mHostAccessType, mKernelAccessType, mListener, getBackend(), getPeerPointer());
  }
