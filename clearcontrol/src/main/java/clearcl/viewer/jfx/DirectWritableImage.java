...
public class DirectWritableImage extends WritableImage
{
  ...
  public void replaceBuffer(ContiguousMemoryInterface pMemory)
  {
    ...
    {
      throw new RuntimeException("Error while replacing internal buffer", e);
    }
  }
  ...
  private static void writeToImageDirectly(ByteBuffer direct, WritableImage writableImg) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, NoSuchFieldException
  {
  ...
  @SuppressWarnings("restriction")
  private static void replaceImageBuffer(ByteBuffer direct, WritableImage writableImg) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, NoSuchFieldException
  {
    // Get the platform image
    Method getWritablePlatformImage = javafx.scene.image.Image.class.getDeclaredMethod("getWritablePlatformImage");
    getWritablePlatformImage.setAccessible(true);
  ...
  @SuppressWarnings("restriction")
  private static void forceUpdate(WritableImage writableImg, com.sun.prism.Image prismImg) throws NoSuchFieldException, IllegalAccessException, NoSuchMethodException, InvocationTargetException
  {
