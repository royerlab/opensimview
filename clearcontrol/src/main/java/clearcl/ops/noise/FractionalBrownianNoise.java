...
public class FractionalBrownianNoise extends OpsBase
{
  ...
  public FractionalBrownianNoise(ClearCLQueue pClearCLQueue) throws IOException
  {
    ...
    ClearCLProgram lNoiseProgram = getContext().createProgram(OCLlib.class, "noise/noisetexture.cl");
   ...
   *
   * @param pBuffer      buffer to store noise data
   * @param pBlockingRun true -> blocking call
   */
