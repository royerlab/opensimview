...
{
  SignedNormalizedInt8(NativeTypeEnum.Byte, true, true), SignedNormalizedInt16(NativeTypeEnum.Short, true, true), UnsignedNormalizedInt8(NativeTypeEnum.UnsignedByte, true, false), UnsignedNormalizedInt16(NativeTypeEnum.UnsignedShort, true, false), SignedInt8(NativeTypeEnum.Byte, false, true), SignedInt16(NativeTypeEnum.Short, false, true), SignedInt32(NativeTypeEnum.Int, false, true), UnsignedInt8(NativeTypeEnum.UnsignedByte, false, false), UnsignedInt16(NativeTypeEnum.UnsignedShort, false, false), UnsignedInt32(NativeTypeEnum.UnsignedInt, false, false), HalfFloat(NativeTypeEnum.HalfFloat, false, true), Float(NativeTypeEnum.Float, false, true);

  NativeTypeEnum mNativeType;
  boolean mIsNormalized;
  boolean mIsSigned;

  private ImageChannelDataType(NativeTypeEnum pNativeDataType, boolean pIsNormalized, boolean pIsSigned)
  {
