...
public class OpenCLException extends ClearCLException
{
   ...
   *
   * @param pOpenCLErrorCode OpenCL error code.
   */
  public OpenCLException(int pOpenCLErrorCode)
  {
    super("OpenCL error: " + pOpenCLErrorCode + " -> " + getErrorString(pOpenCLErrorCode));
  ...
  public static String getErrorString(int pOpenCLErrorCode)
  {
    switch (pOpenCLErrorCode)
    {
      ...
      default:
        return "Unknown OpenCL error:" + pOpenCLErrorCode;
    }
  }
  ...
  {
    if (mOpenCLErrorCode != 0) throw this;
  }
