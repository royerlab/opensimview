...
public class StringUtils
{
   ...
   * @throws IOException if file cannot be writen
   */
   ...
   *
   * @param pResourceAsStream stream
   * @param pCharSetName      charset
   * @return string
   */
  public static String streamToString(InputStream pResourceAsStream, String pCharSetName)
  {
