...
public class GSSplitterBuffer
{
  ...
  public void appendValue(double value, int i)
  {
    ...
    if (lCurrentBuffer.getValsWritten() * 4 == lCurrentBuffer.getMaxSizeInBytes()) mCurrentBufferIndex++;
  ...
  public ArrayDeque<GSBuffer> getData()
  {
    return new ArrayDeque<>(this.mData);
  }

  public int getmCurrentBufferIndex()
  {
