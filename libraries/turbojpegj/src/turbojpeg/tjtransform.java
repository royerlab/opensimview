...
public class tjtransform extends StructObject
{
  ...
  // / <i>native declaration : libjpeg-turbo\win64\include\turbojpeg.h</i>
  public static abstract class customFilter_callback extends Callback<customFilter_callback>
  {
    public abstract int apply(Pointer<Short> coeffs, tjregion arrayRegion, tjregion planeRegion, int componentIndex, int transformIndex, Pointer<tjtransform> transform);
  }
