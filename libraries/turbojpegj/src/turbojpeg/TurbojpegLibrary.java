...
public class TurbojpegLibrary
{
   ...
   * @param pitch       bytes per line of the source image. Normally, this should be<br>
   ...
   */
  public static native int tjCompress2(Pointer<?> handle, Pointer<Byte> srcBuf, int width, int pitch, int height, int pixelFormat, Pointer<Pointer<Byte>> jpegBuf, Pointer<org.bridj.CLong> jpegSize, int jpegSubsamp, int jpegQual, int flags);
   ...
   */
  public static native int tjEncodeYUV2(Pointer<?> handle, Pointer<Byte> srcBuf, int width, int pitch, int height, int pixelFormat, Pointer<Byte> dstBuf, int subsamp, int flags);
   ...
   */
  public static native int tjDecompressHeader2(Pointer<?> handle, Pointer<Byte> jpegBuf, @CLong long jpegSize, Pointer<Integer> width, Pointer<Integer> height, Pointer<Integer> jpegSubsamp);
   ...
   * @param pitch       bytes per line of the destination image. Normally, this is<br>
   ...
   */
  public static native int tjDecompress2(Pointer<?> handle, Pointer<Byte> jpegBuf, @CLong long jpegSize, Pointer<Byte> dstBuf, int width, int pitch, int height, int pixelFormat, int flags);
   ...
   */
  public static native int tjDecompressToYUV(Pointer<?> handle, Pointer<Byte> jpegBuf, @CLong long jpegSize, Pointer<Byte> dstBuf, int flags);
   ...
   *
   * @param jpegBuf    pointer to a buffer containing the JPEG image to transform<br>
   * @param jpegSize   size of the JPEG image (in bytes)<br>
   ...
   */
  public static native int tjTransform(Pointer<?> handle, Pointer<Byte> jpegBuf, @CLong long jpegSize, int n, Pointer<Pointer<Byte>> dstBufs, Pointer<CLong> dstSizes, Pointer<tjtransform> transforms, int flags);
   ...
   */
  public static native int tjCompress(Pointer<?> handle, Pointer<Byte> srcBuf, int width, int pitch, int height, int pixelSize, Pointer<Byte> dstBuf, Pointer<CLong> compressedSize, int jpegSubsamp, int jpegQual, int flags);
   ...
   */
  public static native int tjEncodeYUV(Pointer<?> handle, Pointer<Byte> srcBuf, int width, int pitch, int height, int pixelSize, Pointer<Byte> dstBuf, int subsamp, int flags);
   ...
   */
  public static native int tjDecompressHeader(Pointer<?> handle, Pointer<Byte> jpegBuf, @CLong long jpegSize, Pointer<Integer> width, Pointer<Integer> height);
   ...
   */
  public static native int tjDecompress(Pointer<?> handle, Pointer<Byte> jpegBuf, @CLong long jpegSize, Pointer<Byte> dstBuf, int width, int pitch, int height, int pixelSize, int flags);
}
