...
public class EccLibrary
{
  ...
  /**
   * @param info Output: Pointer to array of struct 'EccInfo'. The parameter may be
   *             NULL<br>
  ...
  /**
   * @param deviceNo Index of the device, must be smaller than the number of found
   *                 devices.<br>
   * @param devId    Output: Device ID, only valid if unlocked.<br>
  ...
  /**
   * @param deviceNo:     Index of the device to connect (0..n)<br>
   * @param deviceHandle: Pointer to (user)memory which will retrieve the Handle.<br>
   *                      <br>
  ...
  /**
   * @param deviceHandle: Handle of device<br>
   *                      <br>
  ...
  /**
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param enable       Switches the output relais<br>
   * @param set          1: Send the supplied values to the controller<br>
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param amplitude    Amplitude in mV<br>
   * @param set          1: Send the supplied values to the controller<br>
   *                     0: Ignore input; only retreive the results<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param frequency    Frequency in mHz<br>
   * @param set          1: Send the supplied values to the controller<br>
   *                     0: Ignore input; only retreive the results<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param actor        Actor selection [0..255]<br>
   * @param set          1: Send the supplied values to the controller<br>
   *                     0: Ignore input; only retreive the results<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param name         Name of the actor coded as NULL-terminated c-string. User must
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param type         Type of the actor. See @ref ECC_actorType<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param enable       Enables/ disables the approach<br>
   * @param set          1: Send the supplied values to the controller<br>
   *                     0: Ignore input; only retreive the results<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param backward     Selects the desired direction. False triggers a forward step,<br>
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param enable       Enables/ disables the movement<br>
   * @param set          1: Send the supplied values to the controller<br>
   *                     0: Ignore input; only retreive the results<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param target       Target position in nm or \u00b5\u00b0 depending on actor type.<br>
   * @param set          1: Send the supplied values to the controller<br>
   *                     0: Ignore input; only retreive the results<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param valid        Status of the reference position.<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param moving       Moving status, 0: Idle; 1: Moving; 2: Pending<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param error        Error status. "True" means the occurrence of an error.<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param reference    Reference position in nm or \u00b5\u00b0 depending on actor
   *                     type.<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param position     Actor position in nm or \u00b5\u00b0 depending on actor type.<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param enable       enable/disable auto update<br>
   * @param set          1: Send the supplied values to the controller<br>
   *                     0: Ignore input; only retreive the results<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param enable       enables/ disable functionality<br>
   * @param set          1: Send the supplied values to the controller<br>
   *                     0: Ignore input; only retreive the results<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param range        range in nm or \u00b5\u00b0 depending on actor type.<br>
   * @param set          1: Send the supplied values to the controller<br>
   *                     0: Ignore input; only retreive the results<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param target       actual position is within target range<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param enable       true: Output will be deactiveted on EOT.<br>
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param voltage      Output voltage in \u00b5V<br>
   * @param set          1: Send the supplied values to the controller<br>
   *                     0: Ignore input; only retreive the results<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param enable       true: External trigger enabled<br>
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param enable       true: AQuadB input enabled<br>
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param resolution   resolution in nm<br>
   * @param set          1: Send the supplied values to the controller<br>
   *                     0: Ignore input; only retreive the results<br>
   * @return Result of function<br>
   * Original signature :
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param enable       true: AQuadB output enabled<br>
   ...
   * @param deviceHandle Handle of device<br>
   * @param axis         Number of the axis to be configured<br>
   * @param clock        Clock in multiples of 20ns. Minimum 2 (40ns), maximum 65535
   *                     (1,310700ms)<br>
   * @param set          1: Send the supplied values to the controller<br>
   *                     0: Ignore input; only retreive the results<br>
   * @return Result of function<br>
