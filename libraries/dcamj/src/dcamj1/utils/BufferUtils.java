...
public class BufferUtils
{
   ...
   *
   * @param pToBeDestroyed The DirectByteBuffer that will be "cleaned". Utilizes reflection.
   ...
   * @throws SecurityException         exception thrown
   * @throws NoSuchMethodException     exception thrown
   */
  public static void destroyDirectByteBuffer(final ByteBuffer pToBeDestroyed) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException, SecurityException, NoSuchMethodException
  {
    ...
    final Runnable lCleaner = new Runnable()
    {
      ...
      public void run()
      {
        try
        {
          final Method cleanerMethod = pToBeDestroyed.getClass().getMethod("cleaner");
