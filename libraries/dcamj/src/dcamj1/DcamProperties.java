...
public class DcamProperties extends DcamBase
{
  ...
  public final boolean updatePropertyList()
  {
    ...
    @SuppressWarnings({"unchecked"}) final Pointer<IntValuedEnum<DcamapiLibrary.DCAMIDPROP>> lPointerToPropertyId = (Pointer) Pointer.allocateCLong();

    while (DcamLibrary.hasSucceeded(DcamapiLibrary.dcampropGetnextid(mDcamDevice.getHDCAMPointer(), lPointerToPropertyId, DcamapiLibrary.DCAMPROPOPTION.DCAMPROP_OPTION_SUPPORT.value)))
    {
...

      {
        ...
        final IntValuedEnum<DCAMERR> lError = DcamapiLibrary.dcampropGetname(mDcamDevice.getHDCAMPointer(), lPointerToPropertyId.getCLong(), lNameBytes, 64L);
...

      {
        ...
        final IntValuedEnum<DcamapiLibrary.DCAMERR> lError = DcamapiLibrary.dcampropGetattr(mDcamDevice.getHDCAMPointer(), Pointer.getPointer(lDCAM_PROPERTYATTR));
        ...
        if (lSuccessGetAttribute)
        {
          ...
          final FlagSet<DCAMPROPATTRIBUTE> lFlagSetForAttribute = FlagSet.createFlagSet(lDCAM_PROPERTYATTR.attribute().value(), DCAMPROPATTRIBUTE.class);

          final FlagSet<DCAMPROPUNIT> lFlagSetForUnit = FlagSet.createFlagSet(lDCAM_PROPERTYATTR.iUnit().value(), DCAMPROPUNIT.class);
          /*
  ...
  public double getPropertyValue(final DCAMIDPROP pDCAMIDPROP)
  {
    ...
    final IntValuedEnum<DCAMERR> lError = DcamapiLibrary.dcampropGetvalue(mDcamDevice.getHDCAMPointer(), pDCAMIDPROP.value, lPointerToDouble);
  ...
  public final double getPropertyValue(final String pPropertyName)
  {
    ...
    final IntValuedEnum<DCAMERR> lError = DcamapiLibrary.dcampropGetvalue(mDcamDevice.getHDCAMPointer(), lProperty.id, lPointerToDouble);
    final boolean lSuccess = addErrorToListAndCheckHasSucceeded(lError);
  ...
  public final boolean setPropertyValue(final String pPropertyName, final double pValue)
  {
    final DcamProperty lProperty = getProperty(pPropertyName);

    final IntValuedEnum<DCAMERR> lError = DcamapiLibrary.dcampropSetvalue(mDcamDevice.getHDCAMPointer(), lProperty.id, pValue);
    final boolean lSuccess = addErrorToListAndCheckHasSucceeded(lError);

    return lSuccess;
  }

  public final boolean setPropertyValue(final DCAMIDPROP pDCAMIDPROP, final double pValue)
  {

    final IntValuedEnum<DCAMERR> lError = DcamapiLibrary.dcampropSetvalue(mDcamDevice.getHDCAMPointer(), pDCAMIDPROP.value, pValue);
    final boolean lSuccess = addErrorToListAndCheckHasSucceeded(lError);

    return lSuccess;
  }

  public final boolean setPropertyValue(final DCAMIDPROP pDCAMIDPROP, final DCAMPROPMODEVALUE pDCAMPROPMODEVALUE)
  {

    final IntValuedEnum<DCAMERR> lError = DcamapiLibrary.dcampropSetvalue(mDcamDevice.getHDCAMPointer(), pDCAMIDPROP.value, pDCAMPROPMODEVALUE.value);
    final boolean lSuccess = addErrorToListAndCheckHasSucceeded(lError);

    return lSuccess;
  }

  private double setAndGetPropertyValue(final DCAMIDPROP pDCAMIDPROP, final double pValue)
  {
    final Pointer<Double> lPointerToDouble = Pointer.allocateDouble();
    lPointerToDouble.set(pValue);

    final IntValuedEnum<DCAMERR> lError = DcamapiLibrary.dcampropSetgetvalue(mDcamDevice.getHDCAMPointer(), pDCAMIDPROP.value, lPointerToDouble, 0);
    final boolean lSuccess = addErrorToListAndCheckHasSucceeded(lError);
  ...
  {
    final double lEffectiveExposure = setAndGetPropertyValue(DCAMIDPROP.DCAM_IDPROP_EXPOSURETIME, pExposure);
  ...
  public boolean setCenteredROI(final long pCenteredWidth, final long pCenteredHeight)
  {
    ...
    boolean lSuccess = true;
    lSuccess &= setPropertyValue(DCAMIDPROP.DCAM_IDPROP_SUBARRAYHPOS, hpos);
    lSuccess &= setPropertyValue(DCAMIDPROP.DCAM_IDPROP_SUBARRAYVPOS, vpos);
    lSuccess &= setPropertyValue(DCAMIDPROP.DCAM_IDPROP_SUBARRAYHSIZE, lWidth);
    lSuccess &= setPropertyValue(DCAMIDPROP.DCAM_IDPROP_SUBARRAYVSIZE, lHeight);

    lSuccess &= setPropertyValue(DCAMIDPROP.DCAM_IDPROP_SUBARRAYMODE, 2);
  ...
  {
    boolean lSuccess = true;
    lSuccess &= setPropertyValue(DCAMIDPROP.DCAM_IDPROP_BINNING, pBinSize);
  ...
  {
    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_TRIGGER_MODE, DCAMPROPMODEVALUE.DCAMPROP_TRIGGER_MODE__NORMAL);
    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_TRIGGERPOLARITY, DCAMPROPMODEVALUE.DCAMPROP_TRIGGERPOLARITY__POSITIVE);

    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_TRIGGER_CONNECTOR, DCAMPROPMODEVALUE.DCAMPROP_TRIGGER_CONNECTOR__BNC);
  ...
  {
    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_TRIGGERSOURCE, DCAMPROPMODEVALUE.DCAMPROP_TRIGGERSOURCE__INTERNAL);
  }

  public void setInputTriggerToExternalEdge()
  {
    setInputTriggerDefaults();
    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_TRIGGERSOURCE, DCAMPROPMODEVALUE.DCAMPROP_TRIGGERSOURCE__EXTERNAL);
    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_TRIGGERACTIVE, DCAMPROPMODEVALUE.DCAMPROP_TRIGGERACTIVE__EDGE);
  ...
  public void setInputTriggerToExternalLevel()
  {
    setInputTriggerDefaults();
    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_TRIGGERSOURCE, DCAMPROPMODEVALUE.DCAMPROP_TRIGGERSOURCE__EXTERNAL);
    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_TRIGGERACTIVE, DCAMPROPMODEVALUE.DCAMPROP_TRIGGERACTIVE__LEVEL);
    setOutputTriggerToExposure();
  }
  ...
  public void setInputTriggerToExternalFastEdge()
  {
    setInputTriggerDefaults();
    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_TRIGGERSOURCE, DCAMPROPMODEVALUE.DCAMPROP_TRIGGERSOURCE__EXTERNAL);
    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_TRIGGERACTIVE, DCAMPROPMODEVALUE.DCAMPROP_TRIGGERACTIVE__SYNCREADOUT);
    setOutputTriggerToExposure();
  }

  public void setInputTriggerToSoftware()
  {
    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_TRIGGERSOURCE, DCAMPROPMODEVALUE.DCAMPROP_TRIGGERSOURCE__SOFTWARE);
  }

  public void setOutputTriggerToExposure()
  {
    setOutputTriggerDefaults();
    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_OUTPUTTRIGGER_POLARITY, DCAMPROPMODEVALUE.DCAMPROP_OUTPUTTRIGGER_POLARITY__POSITIVE);

    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_OUTPUTTRIGGER_KIND, DCAMPROPMODEVALUE.DCAMPROP_OUTPUTTRIGGER_KIND__EXPOSURE);
  ...
  public void setOutputTriggerToProgrammable()
  {
    ...
    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_OUTPUTTRIGGER_KIND, DCAMPROPMODEVALUE.DCAMPROP_OUTPUTTRIGGER_KIND__PROGRAMABLE);

  }

  public void setDefectCorectionMode(final boolean pDefectCorrections)
  {
    setPropertyValue(DCAMIDPROP.DCAM_IDPROP_DEFECTCORRECT_MODE, pDefectCorrections ? DCAMPROPMODEVALUE.DCAMPROP_MODE__ON : DCAMPROPMODEVALUE.DCAMPROP_MODE__OFF);
  }
