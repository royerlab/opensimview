...
public class DcamJDemo
{
   ...
   */
  @Test
  public void testSingleImageAcquisition() throws InterruptedException, ExecutionException
  {
    int lWidth = 2048;
    int lHeight = 2048;
    int lDepth = 1;
  ...
  public void testSequenceAcquisitionTwoCameras() throws InterruptedException, ExecutionException
  {
    ...
    DcamSequenceAcquisition lDcamSequenceAcquisition0 = new DcamSequenceAcquisition(lDcamDevice0);
    lDcamSequenceAcquisition0.mDebug = true;
    System.out.println("FIRST CAMERA");
    DcamImageSequence lSequence0 = new DcamImageSequence(lDcamDevice0, 2, lWidth, lHeight, lDepth);


    DcamSequenceAcquisition lDcamSequenceAcquisition1 = new DcamSequenceAcquisition(lDcamDevice1);
    lDcamSequenceAcquisition1.mDebug = true;
    System.out.println("SECOND CAMERA");
    DcamImageSequence lSequence1 = new DcamImageSequence(lDcamDevice1, 2, lWidth, lHeight, lDepth);
    lDcamSequenceAcquisition1.mDebug = true;
  ...
  public void testRepeatedSequenceAcquisitionWithRecycler() throws InterruptedException
  {
    ...
    DcamImageSequenceFactory lDcamImageSequenceFactory = new DcamImageSequenceFactory();
    BasicRecycler<DcamImageSequence, DcamImageSequenceRequest> lRecycler = new BasicRecycler<>(lDcamImageSequenceFactory, 10);
    ...
    for (int i = 0; i < 25; i++)
    {
      ...
      int lHeight = (int) (512);
      int lDepth = (int) (10);
      DcamImageSequenceRequest lRequest = DcamImageSequenceRequest.build(lDcamDevice, 2, lWidth, lHeight, lDepth, true);

      System.out.println(lRequest);

      DcamImageSequence lSequence = lRecycler.getOrWait(1, TimeUnit.SECONDS, lRequest);
