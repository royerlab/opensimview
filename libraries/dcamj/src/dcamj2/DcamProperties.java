...
public class DcamProperties extends DcamBase
{
   ...
   * Dcam properties
   *
   * @param pDcamDevice Dcam camera device
   */
  ...
  public final boolean updatePropertyList()
  {
    ...
    @SuppressWarnings({"unchecked", "rawtypes"}) final Pointer<IntValuedEnum<DcamapiLibrary.DCAMIDPROP>> lPointerToPropertyId = (Pointer) Pointer.allocateCLong();
    ...
    while (DcamLibrary.hasSucceeded(DcamapiLibrary.dcampropGetnextid(mDcamDevice.getHDCAMPointer(), lPointerToPropertyId, DcamapiLibrary.DCAMPROPOPTION.DCAMPROP_OPTION_SUPPORT.value)))
    {
...

      {
        ...
        @SuppressWarnings("unused") final IntValuedEnum<DcamapiLibrary.DCAMERR> lError = DcamapiLibrary.dcampropGetattr(mDcamDevice.getHDCAMPointer(), Pointer.getPointer(lDCAM_PROPERTYATTR));
   ...
   * @return true: success, false otherwise
   */
  public final boolean setDoublePropertyValue(final String pPropertyName, final double pValue)
  {
    final DcamProperty lProperty = getProperty(pPropertyName);
  ...
  boolean setDoublePropertyValue(final DCAMIDPROP pDCAMIDPROP, final double pValue)
  {
  ...
  final boolean setModePropertyValue(final DCAMIDPROP pDCAMIDPROP, final DCAMPROPMODEVALUE pDCAMPROPMODEVALUE)
  {
  ...
  double setAndGetDoublePropertyValue(final DCAMIDPROP pDCAMIDPROP, final double pValue)
  {
    final Pointer<Double> lPointerToDouble = Pointer.allocateDouble();
