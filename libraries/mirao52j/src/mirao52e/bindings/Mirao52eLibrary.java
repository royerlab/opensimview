...
public class Mirao52eLibrary
{
   ...
   */
  public static abstract class MroRegisterCallbackCallbackCallback extends Callback<MroRegisterCallbackCallbackCallback>
  {
    ...
    {
      apply((Pointer) Pointer.pointerToAddress(MiraoInfoPtr1, MroInfo.class));
    }
  }
   ...
   * <br>
   *
   * @param version Pointer to a character string to put the version.<br>
   *                <br>
   * @param status  Pointer to an integer containing the error code if an error<br>
  ...
  @Name("mro_getVersion")
  public static byte mroGetVersion(Pointer<Byte> version, Pointer<Integer> status)
  {
    return mroGetVersion(Pointer.getPeer(version), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getVersion")
  protected native static byte mroGetVersion(@Ptr long version, @Ptr long status);
   ...
   * <br>
   *
   * @param command Command to apply to the mirror.<br>
   *                <br>
   * @param trig    If MRO_TRUE, a hardware trig will follow the command<br>
   *                application.<br>
   *                <br>
   * @param status  Pointer to an integer containing the error code if an error<br>
   *                occurs or MRO_OK if the call returns successfully.<br>
  ...
  public static byte mroApplyCommand(Pointer<Double> command, byte trig, Pointer<Integer> status)
  {
    return mroApplyCommand(Pointer.getPeer(command), trig, Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_applyCommand")
  protected native static byte mroApplyCommand(@Ptr long command, byte trig, @Ptr long status);
  ...
  public static byte mroApplyIoCommand(Pointer<Double> command, byte trig, Pointer<Integer> status)
  {
    return mroApplyIoCommand(Pointer.getPeer(command), trig, Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_applyIoCommand")
  protected native static byte mroApplyIoCommand(@Ptr long command, byte trig, @Ptr long status);
   ...
   *
   * @param command Command to apply to the mirror.<br>
   * @param trig    If MRO_TRUE, a hardware trig follow the command<br>
   *                application.<br>
   * @param status  Pointer to an integer containing the error code if an<br>
  ...
  public static byte mroApplySmoothCommand(Pointer<Double> command, byte trig, Pointer<Integer> status)
  {
    return mroApplySmoothCommand(Pointer.getPeer(command), trig, Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_applySmoothCommand")
  protected native static byte mroApplySmoothCommand(@Ptr long command, byte trig, @Ptr long status);
   ...
   * <br>
   *
   * @param command Array where the last applied command is copied.<br>
   *                <br>
   * @param status  Pointer to an integer containing the error code if an<br>
  ...
  public static byte mroGetLastAppliedCommand(Pointer<Double> command, Pointer<Integer> status)
  {
    return mroGetLastAppliedCommand(Pointer.getPeer(command), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getLastAppliedCommand")
  protected native static byte mroGetLastAppliedCommand(@Ptr long command, @Ptr long status);
   ...
   * <br>
   *
   * @param date   Pointer to the MroDate variable where date is copied.<br>
   *               <br>
   * @param status Pointer to an integer containing the error code if an<br>
   *               error occurs or MRO_OK if the call returns<br>
   *               successfully.<br>
  ...
  public static byte mroGetLastAppliedCommandDate(Pointer<TimeT> date, Pointer<Integer> status)
  {
    return mroGetLastAppliedCommandDate(Pointer.getPeer(date), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getLastAppliedCommandDate")
  protected native static byte mroGetLastAppliedCommandDate(@Ptr long date, @Ptr long status);
   ...
   * <br>
   *
   * @param command Command to add to the command stock.<br>
   *                <br>
   * @param index   Index of the command stock where to put the command.<br>
   *                <br>
   * @param status  Pointer to an integer containing the error code if an<br>
   *                error occurs or MRO_OK if the call returns<br>
   *                successfully.<br>
  ...
  public static byte mroSetStockCommand(Pointer<Double> command, int index, Pointer<Integer> status)
  {
    return mroSetStockCommand(Pointer.getPeer(command), index, Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_setStockCommand")
  protected native static byte mroSetStockCommand(@Ptr long command, int index, @Ptr long status);
   ...
   * <br>
   *
   * @param command Pointer to the array where to put the retrieved command.<br>
   * @param index   Index of the command stock of the command to retrieve.<br>
   * @param status  Pointer to an integer containing the error code if an<br>
   *                error occurs or MRO_OK if the call returns<br>
   *                successfully.<br>
   *                <br>
  ...
  public static byte mroGetStockCommand(Pointer<Double> command, int index, Pointer<Integer> status)
  {
    return mroGetStockCommand(Pointer.getPeer(command), index, Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getStockCommand")
  protected native static byte mroGetStockCommand(@Ptr long command, int index, @Ptr long status);
   ...
   * <br>
   *
   * @param index  Index of the command stock of the command to apply.<br>
   *               <br>
   * @param trig   If MRO_TRUE, a hardware trig follow the command application.<br>
   *               <br>
   * @param status Pointer to an integer containing the error code if an<br>
   *               error occurs or MRO_OK if the call returns<br>
   *               successfully.<br>
  ...
  public static byte mroApplyStockCommand(int index, byte trig, Pointer<Integer> status)
  {
  ...
  @Convention(Convention.Style.StdCall)
  @Name("mro_applyStockCommand")
  protected native static byte mroApplyStockCommand(int index, byte trig, @Ptr long status);
  ...
  public static byte mroApplySmoothStockCommand(int index, byte trig, Pointer<Integer> status)
  {
    return mroApplySmoothStockCommand(index, trig, Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_applySmoothStockCommand")
  protected native static byte mroApplySmoothStockCommand(int index, byte trig, @Ptr long status);
   ...
   * <br>
   *
   * @param index  Command of the command stock to remove.<br>
   *               <br>
   * @param status Pointer to an integer containing the error code if an error<br>
   *               occurs or MRO_OK if the call returns successfully.<br>
   *               <br>
  ...
  public static byte mroRemoveStockCommand(int index, Pointer<Integer> status)
  {
  ...
  @Convention(Convention.Style.StdCall)
  @Name("mro_removeStockCommand")
  protected native static byte mroRemoveStockCommand(int index, @Ptr long status);
   ...
   * <br>
   *
   * @param index  Index of the command stock.<br>
   *               <br>
   * @param result Pointer to a MroBoolean where to put the result.<br>
  ...
  public static byte mroIsStockCommandDefined(int index, Pointer<Byte> result, Pointer<Integer> status)
  {
    return mroIsStockCommandDefined(index, Pointer.getPeer(result), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_isStockCommandDefined")
  protected native static byte mroIsStockCommandDefined(int index, @Ptr long result, @Ptr long status);
   ...
   * <br>
   *
   * @param size   Pointer to an integer to put the number of defined commands.<br>
   *               <br>
   * @param status Pointer to an integer containing the error code if an error<br>
   *               occurs or MRO_OK if the call returns successfully.<br>
   *               <br>
  ...
  public static byte mroGetCommandStockSize(Pointer<Integer> size, Pointer<Integer> status)
  {
    return mroGetCommandStockSize(Pointer.getPeer(size), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getCommandStockSize")
  protected native static byte mroGetCommandStockSize(@Ptr long size, @Ptr long status);
   ...
   * <br>
   *
   * @param size   Pointer to the variable where to copy the command stock<br>
   *               capacity.<br>
   *               <br>
   * @param status Pointer to an integer containing the error code if an error<br>
   *               occurs or MRO_OK if the call returns successfully.<br>
  ...
  public static byte mroGetCommandStockMaxSize(Pointer<Integer> size, Pointer<Integer> status)
  {
    return mroGetCommandStockMaxSize(Pointer.getPeer(size), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getCommandStockMaxSize")
  protected native static byte mroGetCommandStockMaxSize(@Ptr long size, @Ptr long status);
   ...
   * <br>
   *
   * @param enabled Pointer of the MroBoolean where to put the result.<br>
   *                <br>
   * @param status  Pointer to an integer containing the error code if an error<br>
   *                occurs or MRO_OK if the call returns successfully.<br>
   *                <br>
  ...
  public static byte mroIsMonitoringEnabled(Pointer<Byte> enabled, Pointer<Integer> status)
  {
    return mroIsMonitoringEnabled(Pointer.getPeer(enabled), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_isMonitoringEnabled")
  protected native static byte mroIsMonitoringEnabled(@Ptr long enabled, @Ptr long status);
   ...
   * <br>
   *
   * @param enabled If MRO_TRUE, the monitoring is enabled,<br>
  ...
  public static byte mroSetMonitoringEnabled(byte enabled, Pointer<Integer> status)
  {
  ...
  @Convention(Convention.Style.StdCall)
  @Name("mro_setMonitoringEnabled")
  protected native static byte mroSetMonitoringEnabled(byte enabled, @Ptr long status);
   ...
   * <br>
   *
   * @param val    Pointer to the MroTemperature where to put the mirror<br>
   *               temperature.<br>
   *               <br>
   * @param status Pointer to an integer containing the error code if an error<br>
   *               occurs or MRO_OK if the call returns successfully.<br>
  ...
  public static byte mroGetMirrorTemperature(Pointer<Double> val, Pointer<Integer> status)
  {
    return mroGetMirrorTemperature(Pointer.getPeer(val), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getMirrorTemperature")
  protected native static byte mroGetMirrorTemperature(@Ptr long val, @Ptr long status);
   ...
   * <br>
   *
   * @param val    Pointer to the MroTemperature where to put the power supply<br>
   *               temperature.<br>
   *               <br>
   * @param status Pointer to an integer containing the error code if an error<br>
   *               occurs or MRO_OK if the call returns successfully.<br>
  ...
  public static byte mroGetPowerSupplyTemperature(Pointer<Double> val, Pointer<Integer> status)
  {
    return mroGetPowerSupplyTemperature(Pointer.getPeer(val), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getPowerSupplyTemperature")
  protected native static byte mroGetPowerSupplyTemperature(@Ptr long val, @Ptr long status);
   ...
   * <br>
   *
   * @param val    Pointer of the MroIntensity where to put the intensity in<br>
  ...
  public static byte mroGetNegativeCoilsIntensity(Pointer<Double> val, Pointer<Integer> status)
  {
    return mroGetNegativeCoilsIntensity(Pointer.getPeer(val), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getNegativeCoilsIntensity")
  protected native static byte mroGetNegativeCoilsIntensity(@Ptr long val, @Ptr long status);
  ...
  public static byte mroGetPositiveCoilsIntensity(Pointer<Double> val, Pointer<Integer> status)
  {
    return mroGetPositiveCoilsIntensity(Pointer.getPeer(val), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getPositiveCoilsIntensity")
  protected native static byte mroGetPositiveCoilsIntensity(@Ptr long val, @Ptr long status);
   ...
   * <br>
   *
   * @param val    Pointer of the MroTemperature where to put the mirror<br>
   *               lock temperature.<br>
   *               <br>
   * @param status Pointer to an integer containing the error code if an error<br>
   *               occurs or MRO_OK if the call returns successfully.<br>
  ...
  public static byte mroGetMirrorLockTemperature(Pointer<Double> val, Pointer<Integer> status)
  {
    return mroGetMirrorLockTemperature(Pointer.getPeer(val), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getMirrorLockTemperature")
  protected native static byte mroGetMirrorLockTemperature(@Ptr long val, @Ptr long status);
   ...
   * <br>
   *
   * @param val    Pointer of the MroTemperature where to put the power supply<br>
   *               lock temperature.<br>
   *               <br>
   * @param status Pointer to an integer containing the error code if an error<br>
   *               occurs or MRO_OK if the call returns successfully.<br>
  ...
  public static byte mroGetPowerSupplyLockTemperature(Pointer<Double> val, Pointer<Integer> status)
  {
    return mroGetPowerSupplyLockTemperature(Pointer.getPeer(val), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getPowerSupplyLockTemperature")
  protected native static byte mroGetPowerSupplyLockTemperature(@Ptr long val, @Ptr long status);
   ...
   * <br>
   *
   * @param val    Pointer of the MroIntensity where to put the negative coils<br>
   *               lock intensity.<br>
   *               <br>
   * @param status Pointer to an integer containing the error code if an error<br>
   *               occurs or MRO_OK if the call returns successfully.<br>
  ...
  public static byte mroGetNegativeCoilsLockIntensity(Pointer<Double> val, Pointer<Integer> status)
  {
    return mroGetNegativeCoilsLockIntensity(Pointer.getPeer(val), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getNegativeCoilsLockIntensity")
  protected native static byte mroGetNegativeCoilsLockIntensity(@Ptr long val, @Ptr long status);
   ...
   * <br>
   *
   * @param val    Pointer of the MroIntensity where to put the positive coils<br>
   *               lock intensity.<br>
   *               <br>
   * @param status Pointer to an integer containing the error code if an error<br>
   *               occurs or MRO_OK if the call returns successfully.<br>
  ...
  public static byte mroGetPositiveCoilsLockIntensity(Pointer<Double> val, Pointer<Integer> status)
  {
    return mroGetPositiveCoilsLockIntensity(Pointer.getPeer(val), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_getPositiveCoilsLockIntensity")
  protected native static byte mroGetPositiveCoilsLockIntensity(@Ptr long val, @Ptr long status);
   ...
   * <br>
   *
   * @param val    Pointer to the MroBoolean where to put the result.<br>
   *               <br>
   * @param status Pointer to an integer containing the error code if an error<br>
   *               occurs or MRO_OK if the call returns successfully.<br>
   *               <br>
  ...
  @Convention(Convention.Style.StdCall)
  @Name("mro_isLocked")
  public static byte mroIsLocked(Pointer<Byte> val, Pointer<Integer> status)
  {
  ...
  @Convention(Convention.Style.StdCall)
  @Name("mro_isLocked")
  protected native static byte mroIsLocked(@Ptr long val, @Ptr long status);
  ...
  public static byte mroIsConnected(Pointer<Byte> val, Pointer<Integer> status)
  {
    return mroIsConnected(Pointer.getPeer(val), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_isConnected")
  protected native static byte mroIsConnected(@Ptr long val, @Ptr long status);
   ...
   * <br>
   *
   * @param callback Pointer to the callback function.<br>
   *                 <br>
   * @param status   Pointer to an integer containing the error code if an error<br>
   *                 occurs or MRO_OK if the call returns successfully.<br>
   *                 <br>
  ...
  public static byte mroRegisterCallback(Pointer<Mirao52eLibrary.MroRegisterCallbackCallbackCallback> callback, Pointer<Integer> status)
  {
    return mroRegisterCallback(Pointer.getPeer(callback), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_registerCallback")
  protected native static byte mroRegisterCallback(@Ptr long callback, @Ptr long status);
   ...
   * <br>
   *
   * @param command   Command to save.<br>
   *                  <br>
   * @param filaPath  Null terminated character string containing the path of<br>
   *                  the file to create.<br>
   *                  <br>
   * @param overwrite If MRO_TRUE, if the file already exists it is overwritten,<br>
  ...
  public static byte mroWriteCommandFile(Pointer<Double> command, Pointer<Byte> filePath, byte overwrite, Pointer<Integer> status)
  {
    return mroWriteCommandFile(Pointer.getPeer(command), Pointer.getPeer(filePath), overwrite, Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_writeCommandFile")
  protected native static byte mroWriteCommandFile(@Ptr long command, @Ptr long filePath, byte overwrite, @Ptr long status);
   ...
   * <br>
   *
   * @param filePath Null terminated character string containing the path of<br>
   *                 the file to create.<br>
   *                 <br>
   * @param command  Array into which to put the command read.<br>
   *                 <br>
   * @param status   Pointer to an integer containing the error code if an error<br>
   *                 occurs or MRO_OK if the call returns successfully.<br>
   *                 <br>
  ...
  public static byte mroReadCommandFile(Pointer<Byte> filePath, Pointer<Double> command, Pointer<Integer> status)
  {
    return mroReadCommandFile(Pointer.getPeer(filePath), Pointer.getPeer(command), Pointer.getPeer(status));
  }

  @Convention(Convention.Style.StdCall)
  @Name("mro_readCommandFile")
  protected native static byte mroReadCommandFile(@Ptr long filePath, @Ptr long command, @Ptr long status);
}
