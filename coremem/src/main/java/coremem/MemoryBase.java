...

{
  ...
  void checkMappableMemory(ContiguousMemoryInterface pContiguousMemoryInterface)
  {
    ...
    {
      final MappableMemory lMappableMemory =
  ...
  {
    OffHeapMemoryAccess.setByte(mAddressInBytes
                                + (pOffset << Size.BYTESHIFT),
                                pValue);
  }
  ...
  {
    OffHeapMemoryAccess.setChar(mAddressInBytes
                                + (pOffset << Size.CHARSHIFT),
                                pValue);
  }
  ...
  {
    OffHeapMemoryAccess.setShort(mAddressInBytes
                                 + (pOffset << Size.SHORTSHIFT),
                                 pValue);
  }
  ...
  {
    OffHeapMemoryAccess.setInt(mAddressInBytes
                               + (pOffset << Size.INTSHIFT), pValue);
  }

  @Override
  public void setLongAligned(long pOffset, long pValue)
  {
    OffHeapMemoryAccess.setLong(mAddressInBytes
                                + (pOffset << Size.LONGSHIFT),
                                pValue);
  }
  ...
  {
    OffHeapMemoryAccess.setFloat(mAddressInBytes
                                 + (pOffset << Size.FLOATSHIFT),
                                 pValue);
  }
  ...
  {
    OffHeapMemoryAccess.setDouble(mAddressInBytes
                                  + (pOffset << Size.DOUBLESHIFT),
                                  pValue);
  }
  ...
  {
    return OffHeapMemoryAccess.getByte(mAddressInBytes
                                       + (pOffset << Size.BYTESHIFT));
  }
  ...
  {
    return OffHeapMemoryAccess.getChar(mAddressInBytes
                                       + (pOffset << Size.CHARSHIFT));
  }
  ...
  {
    return OffHeapMemoryAccess.getShort(mAddressInBytes
                                        + (pOffset << Size.SHORTSHIFT));
  }
  ...
  {
    return OffHeapMemoryAccess.getInt(mAddressInBytes
                                      + (pOffset << Size.INTSHIFT));
  }

  @Override
  public long getLongAligned(long pOffset)
  {
    return OffHeapMemoryAccess.getLong(mAddressInBytes
                                       + (pOffset << Size.LONGSHIFT));
  }
  ...
  {
    return OffHeapMemoryAccess.getFloat(mAddressInBytes
                                        + (pOffset << Size.FLOATSHIFT));
  }
  ...
  {
    return OffHeapMemoryAccess.getDouble(mAddressInBytes
                                         + (pOffset << Size.DOUBLESHIFT));
  }
