...
public class FragmentedMemoryTests
{
  ...
  public void testWriteToReadFromFileChannel() throws IOException
  {
    ...
    final FragmentedMemory lFragmentedMemory1 =
    ...
    final FragmentedMemory lFragmentedMemory2 =
                                              new FragmentedMemory();
    for (int i = 0; i < 100; i++)
    {
      final OffHeapMemory lOffHeapMemory = new OffHeapMemory(129);
    ...
    for (int i = 0; i < 100; i++)
    {
      ...
      final ContiguousMemoryInterface lContiguousMemoryInterface =
                                                                 lFragmentedMemory2.get(i);
      for (int j =
                 0; j < lContiguousMemoryInterface.getSizeInBytes(); j++)
  ...
  {
    final ContiguousMemoryInterface lMemory =
                                            OffHeapMemory.allocateShorts(3
                                                                         * 5);
    final FragmentedMemory lSplit =
                                  FragmentedMemory.split(lMemory, 3);
