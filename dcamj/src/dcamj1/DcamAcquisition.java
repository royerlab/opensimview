...
public class DcamAcquisition implements AutoCloseable
{
  ...
  private final ArrayList<DcamAcquisitionListener> mListenersList =
                                                                  new ArrayList<DcamAcquisitionListener>();
  ...
  public double setExposureInSeconds(final double exposure)
  {
    ...
    if (mProperties != null)
      mExposureInSeconds =
                         mProperties.setAndGetExposure(mExposureInSeconds);
  ...
  {
    return mTriggerType == TriggerType.ExternalEdge
           || mTriggerType == TriggerType.ExternalFastEdge
  ...
  private void setCurrentProperties()
  {
    ...
    final double lEffectiveExposure =
                                    setExposureInSeconds(lExposureRequested);
    if (mDebug)
                                        ...
                                        final DcamFrame pDcamFrame)
  {
    ...
    mDcamAquisitionRunnable =
                            new DcamAquisitionRunnable(this,
                                                       pDcamFrame.getDepth(),
                                                       pContinuousAcquisition,
                                                       pStackAcquisition);
  ...
  {
    final boolean isEverythingFine =
                                   pDcamFrame.getWidth() == getWidth()
                                     && pDcamFrame.getHeight() == getHeight();
  ...
  public final boolean isAcquiring()
  {
    if (mDcamAquisitionRunnable == null)
      return false;
    return mDcamAquisitionRunnable.mTrueIfStarted
           && !mDcamAquisitionRunnable.mTrueIfStopped;
  }
  ...
  DCAMCAP_TRANSFERINFO getTransferinfo()
  {
    ...
    final IntValuedEnum<DCAMERR> lError =
                                        DcamapiLibrary.dcamcapTransferinfo(mDcamDevice.getHDCAMPointer(),
