...
public class DcamDevice extends DcamBase implements AutoCloseable
{
   ...
   * @param pExternalTrigger
   *          true: external triggering active
   */
  ...
  public boolean isExternalTriggering() { return mExternalTriggering; }
  ...
  public final boolean open()
  {
    ...
    if (mExternalTriggering)
      setInputTriggerToExternalFastEdge();
    else
      setInputTriggerToInternal();
