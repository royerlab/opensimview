...
public class ClearCLArgumentMissingException extends ClearCLException
{
   ...
   * index.
   * 
   * @param pClearCLKernel
   *          kernel
   * @param pArgumentName
   *          argument name
   * @param pArgumentIndex
   *          argument index
   */
  public ClearCLArgumentMissingException(ClearCLKernel pClearCLKernel,
                                         String pArgumentName,
                                         Integer pArgumentIndex)
  {
    super(String.format("Argument: '%s' missing at index: %s in kernel: '%s'",
                        pArgumentName,
                        pArgumentIndex,
                        pClearCLKernel.getName()));
  }
