...
public class Utils
{
   ...
   * @return The value
   */
  public static int[] getInts(cl_device_id device,
                              int paramName,
                              int numValues)
  {
   ...
   * @return The value
   */
  public static long[] getLongs(cl_device_id device,
                                int paramName,
                                int numValues)
  {
   ...
   * @return The value
   */
  public static String getString(cl_platform_id platform,
                                 int paramName)
  {
    // Obtain the length of the string that will be queried
    long size[] = new long[1];
    BackendUtils.checkOpenCLError(clGetPlatformInfo(platform,
                                                    paramName,
                                                    0,
                                                    null,
                                                    size));
   ...
   * @return The value
   */
  public static long[] getSizes(cl_device_id device,
                                int paramName,
                                int numValues)
  {
