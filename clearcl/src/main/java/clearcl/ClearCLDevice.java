...
public class ClearCLDevice extends ClearCLBase
{
  ...
  private final RecyclerInterface<ClearCLRecyclablePeerPointer, ClearCLRecyclableRequest>
      mContextRecycler;
  ...
  ClearCLDevice(ClearCLPlatform pClearCLPlatform, ClearCLPeerPointer pDevicePointer)
  {
    ...
    final RecyclableFactoryInterface<ClearCLRecyclablePeerPointer, ClearCLRecyclableRequest>
        lRecyclableContextPeerPointerFactory =
        new RecyclableFactoryInterface<ClearCLRecyclablePeerPointer, ClearCLRecyclableRequest>()
        {
          @Override public ClearCLRecyclablePeerPointer create(ClearCLRecyclableRequest pParameters)
          {
    ...
    mContextRecycler =
        new BasicRecycler<ClearCLRecyclablePeerPointer, ClearCLRecyclableRequest>(
            lRecyclableContextPeerPointerFactory,
            cMaxContexts,
            cMaxContexts,
            false);
  ...
  public double getVersion()
  {
    String
        lStringVersion =
        getBackend().getDeviceVersion(mDevicePointer).replace("OpenCL C", "").trim();
  ...
  public String getInfoString()
  {
    ...
    lStringBuilder.append(String.format(
        "Device name: %s, type: %s, OpenCL version: %g \n max global memory: %d \n max local memory: %d \n clock freq: %dMhz \n nb compute units: %d \n extensions: %s  \n",
        getName(),
        getType(),
        getVersion(),
  ...
  public ClearCLContext createContext()
  {
    ...
    final ClearCLRecyclablePeerPointer
