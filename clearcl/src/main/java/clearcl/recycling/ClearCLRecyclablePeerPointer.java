 ...
 */
public class ClearCLRecyclablePeerPointer extends ClearCLPeerPointer implements
                                                                     RecyclableInterface<ClearCLRecyclablePeerPointer, ClearCLRecyclableRequest>
{

  private RecyclerInterface<ClearCLRecyclablePeerPointer, ClearCLRecyclableRequest>
      mRecycler;
  ...
  @Override public boolean isCompatible(ClearCLRecyclableRequest pRequest)
  {
    return pRequest.mClass.equals(mClass);
  }

  @Override public void recycle(ClearCLRecyclableRequest pRequest)
  {
    // nothing to do as we just use the same pointer contained here.
  }

  @Override public void setRecycler(RecyclerInterface pRecycler)
  {
    mRecycler = pRecycler;
  }

  @Override public void setReleased(boolean pIsReleased)
  {
  ...
  @Override public void complainIfFreed() throws FreedException
  {
