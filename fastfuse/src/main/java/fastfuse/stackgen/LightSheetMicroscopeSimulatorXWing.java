                                                ...
                                                LightSheetMicroscopeSimulatorOrtho
{
   ...
   * @param pContext
   *          ClearCL context
   * @param pCameraMisalignementMatrix
   *          misalignement matrix between the two cameras (applied to second
   *          camera)
  ...
  public LightSheetMicroscopeSimulatorXWing(ClearCLContext pContext,
                                            Matrix4f pCameraMisalignementMatrix,
                                            int pMaxCameraResolution,
                                            long... pMainPhantomDimensions)
  {

    super(pContext,
          pCameraMisalignementMatrix,
          2,
          4,
