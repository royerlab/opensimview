...
{
  public ReadStackInterfaceContainerFromDiscInstructionPanel(
      ReadStackInterfaceContainerFromDiscInstruction pScheduler)
  {
    int lRow = 0;

    {
      VariableFileChooser
          lRootFolderChooser =
          new VariableFileChooser("Folder:", pScheduler.getRootFolderVariable(), true);
