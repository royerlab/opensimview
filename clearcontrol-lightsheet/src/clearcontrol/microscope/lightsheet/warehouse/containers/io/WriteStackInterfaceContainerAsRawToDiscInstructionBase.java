                                                                                                                 ...
                                                                                                                 LoggingFeature
{
      ...
      sSavingThread = new Thread(() -> {
        while(true)
        {
          ...
          if(lSaveWorkItem!=null)
          {
            ...
            ElapsedTime.measureForceOutput("Saving stack for channel "+lChannelName,
                    () -> lSinkInterface.appendStack(lChannelName,
                            lStack));
          }
                         ...
                         StackInterface lStack)
  {
    if (mAsyncSaving)
    {
      ...
      ElapsedTime.measureForceOutput(this + "Saving stack synchronously",
