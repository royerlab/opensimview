...
public class WriteSpecificStackToSpecificRawFolderInstruction extends
                                                              WriteStackInterfaceContainerAsRawToDiscInstructionBase implements
                                                                                                                     PropertyIOableInstructionInterface
{

  Variable<String>
      mSourceStackKeyVariable =
      new Variable<String>("Stack key to save", "C0L0");
  Variable<String>
      mTargetRawFolderNameVariable =
      new Variable<String>("Foldername", "C0L0");
                                                          ...
                                                          LightSheetMicroscope pLightSheetMicroscope)
  {
    ...
    {
      @Override public void setEvent(String pCurrentValue, String pNewValue)
      {
  ...
  @Override public WriteSpecificStackToSpecificRawFolderInstruction copy()
  {
  ...
  {
    return new Variable[] { getSourceStackKeyVariable(),
