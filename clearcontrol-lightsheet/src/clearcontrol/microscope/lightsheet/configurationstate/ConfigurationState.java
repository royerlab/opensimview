...
{
  UNINITIALIZED("Uninitialized", "#878585"), SUCCEEDED("Succeeded",
                                                       "#3ed860"), ACCEPTABLE("Acceptable",
                                                                              "#84c600"), FAILED(
    "Failed",
    "#ff7c4c"), PERCENT0("Initialising", "#878585"), PERCENT25("25%",
                                                               "#9cafbf"), PERCENT50("50%",
                                                                                     "#acd1ef"), PERCENT75(
    "75%",
    "#97c6ed"), PERCENT100("Finishing", "#49b0ff"), CANCELLED("Cancelled",
                                                              "#eda807"), INTERRUPTED(
    "Interrupted",
    "#eda807");
