 ...
 * @author royer
 */
public class LightSheetMicroscopeQueue extends MicroscopeQueueBase<LightSheetMicroscope, LightSheetMicroscopeQueue> implements
                                                                                                                    QueueInterface,
                                                                                                                    LightSheetMicroscopeParameterInterface
{
  ...
  public LightSheetMicroscopeQueue(LightSheetMicroscope pLightSheetMicroscope)
  {
    ...
    LightSheetSignalGeneratorQueue
        lSignalGeneratorQueue =
  ...
  @Override public void addCurrentStateToQueue()
  {
    super.addCurrentStateToQueue();
  }

  @Override public void finalizeQueue()
  {
    super.finalizeQueue();
  }
  ...
  @Override public void setFullROI()
  {
  ...
  @Override public void setCenteredROI(int pWidth, int pHeight)
  {
  ...
  @Override public void setExp(double pExpsoureISeconds)
  {
  ...
  @Override public void setTransitionTime(double pTransitionTimeInSeconds)
  {
    int lNumberOfLightsheets = getNumberOfLightSheets();
    for (int i = 0; i < lNumberOfLightsheets; i++)
  ...
  @Override public void setFinalisationTime(double pFinalisationTimeInSeconds)
  {
    int lNumberOfLightsheets = getNumberOfLightSheets();
    for (int i = 0; i < lNumberOfLightsheets; i++)
  ...
  @Override public void setC(int pCameraIndex, boolean pKeepImage)
  {
    getStackCameraDeviceQueue(pCameraIndex).getKeepPlaneVariable().set(pKeepImage);
  }

  @Override public boolean getC(int pCameraIndex)
  {
    return getStackCameraDeviceQueue(pCameraIndex).getKeepPlaneVariable().get();
  }

  @Override public void setC(boolean pKeepImage)
  {
    int lNumberOfStackCameraDevices = getNumberOfStackCameras();
    for (int c = 0; c < lNumberOfStackCameraDevices; c++)
  ...
  @Override public void setDZ(int pDetectionArmIndex, double pValue)
  {
    getDetectionArmDeviceQueue(pDetectionArmIndex).getZVariable().set(pValue);
  }

  @Override public void setDZ(double pValue)
  {
  ...
  @Override public double getDZ(int pDetectionArmIndex)
  {
  ...
  @Override public void setI(int pLightSheetIndex)
  {
    int lNumberOfLightsheets = getNumberOfLightSheets();
    for (int i = 0; i < lNumberOfLightsheets; i++)
  ...
  @Override public void setI(int pLightSheetIndex, boolean pOnOff)
  {
  ...
  @Override public void setI(boolean pOnOff)
  {
    int lNumberOfLightsheets = getNumberOfLightSheets();
    for (int i = 0; i < lNumberOfLightsheets; i++)
      setI(i, pOnOff);
  ...
  @Override public boolean getI(int pLightSheetIndex)
  {
    return getLightSheetOpticalSwitchQueue().getSwitchVariable(pLightSheetIndex).get();
  }

  @Override public void setIX(int pLightSheetIndex, double pValue)
  {
  ...
  @Override public double getIX(int pLightSheetIndex)
  {
    return getLightSheetDeviceQueue(pLightSheetIndex).getXVariable().get().doubleValue();
  }

  @Override public void setIY(int pLightSheetIndex, double pValue)
  {
  ...
  @Override public double getIY(int pLightSheetIndex)
  {
    return getLightSheetDeviceQueue(pLightSheetIndex).getYVariable().get().doubleValue();
  }

  @Override public void setIZ(int pLightSheetIndex, double pValue)
  {
  ...
  @Override public void setIZ(double pValue)
  {
    int lNumberOfLightsheets = getNumberOfLightSheets();
    for (int i = 0; i < lNumberOfLightsheets; i++)
  ...
  @Override public double getIZ(int pLightSheetIndex)
  {
    return getLightSheetDeviceQueue(pLightSheetIndex).getZVariable().get().doubleValue();
  }

  @Override public void setIA(int pLightSheetIndex, double pValue)
  {
  ...
  @Override public double getIA(int pLightSheetIndex)
  {
  ...
  @Override public void setIB(int pLightSheetIndex, double pValue)
  {
  ...
  @Override public double getIB(int pLightSheetIndex)
  {
  ...
  @Override public void setIW(int pLightSheetIndex, double pValue)
  {
  ...
  @Override public double getIW(int pLightSheetIndex)
  {
  ...
  @Override public void setIH(int pLightSheetIndex, double pValue)
  {
    getLightSheetDeviceQueue(pLightSheetIndex).getHeightVariable().set(pValue);
  }

  @Override public double getIH(int pLightSheetIndex)
  {
  ...
  @Override public void setILO(boolean pOn)
  {
    int lNumberOfLightSheets = getNumberOfLightSheets();
  ...
  @Override public void setILO(int pLightSheetIndex, boolean pOn)
  {
  ...
  @Override public void setILO(int pLightSheetIndex, int pLaserIndex, boolean pOn)
  {
  ...
  @Override public boolean getILO(int pLightSheetIndex, int pLaserIndex)
  {
    return getLightSheetDeviceQueue(pLightSheetIndex).getLaserOnOffArrayVariable(
        pLaserIndex).get();
  }

  @Override public void setIP(int pLightSheetIndex, double pValue)
  {
    getLightSheetDeviceQueue(pLightSheetIndex).getPowerVariable().set(pValue);
  }

  @Override public double getIP(int pLightSheetIndex)
  {
  ...
  @Override public void setIPA(boolean pAdapt)
  {
    int lNumberOfLightSheets = getNumberOfLightSheets();
  ...
  @Override public void setIPA(int pLightSheetIndex, boolean pAdapt)
  {
  ...
  @Override public boolean getIPA(int pLightSheetIndex)
  {
    return getLightSheetDeviceQueue(pLightSheetIndex).getAdaptPowerToWidthHeightVariable()
                                                     .get();
  }

  @Override public void setIPatternOnOff(int pLightSheetIndex,
                                         int pLaserIndex,
                                         boolean pOnOff)
  {
  ...
  @Override public boolean getIPatternOnOff(int pLightSheetIndex, int pLaserIndex)
  {
    return getLightSheetDeviceQueue(pLightSheetIndex).getSIPatternOnOffVariable(
        pLaserIndex).get();
  }

  @Override public void setIPattern(int pLightSheetIndex,
                                    int pLaserIndex,
  ...
  @Override public StructuredIlluminationPatternInterface getIPattern(int pLightSheetIndex,
                                                                      int pLaserIndex)
  {
