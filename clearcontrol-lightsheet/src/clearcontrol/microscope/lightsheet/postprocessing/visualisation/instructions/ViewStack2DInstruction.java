 ...
 */
public class ViewStack2DInstruction<T extends StackInterfaceContainer> extends
                                                                       ViewStackInstructionBase<T> implements
                                                                                                   PropertyIOableInstructionInterface
{

  private BoundedVariable<Integer>
      mViewerIndexVariable =
      new BoundedVariable<Integer>("Viewer index", 0, 0, Integer.MAX_VALUE);
                                ...
                                LightSheetMicroscope pLightSheetMicroscope)
  {
    super("Visualisation: View stack '"
          ...
          + "' in 2D viewer", pTargetStackInterfaceContainerClass, pLightSheetMicroscope);
  ...
  @Override public InstructionInterface copy()
  {
