  ...
  public CalibrationEngineToolbar(CalibrationEngine pCalibrationEngine)
  {
...

    {
      ...
      int
          ...
          pCalibrationEngine.getLightSheetMicroscope().getNumberOfLightSheets();
      for (int l = 0; l < lNumberOfLightSheets; l++)
      {
        lCalibrateLightSheetOnOffPane.addSwitch("LS" + l,
                                                pCalibrationEngine.getCalibrateLightSheetOnOff(
                                                    l));
      }
...

    {
      TextField
          ...
          new TextField(pCalibrationEngine.getCalibrationDataNameVariable().get());
      lCalibrationDataNameTextField.setMaxWidth(Double.MAX_VALUE);
      lCalibrationDataNameTextField.textProperty().addListener((obs, o, n) -> {
        String lName = n.trim();
        if (!lName.isEmpty())
          pCalibrationEngine.getCalibrationDataNameVariable().set(lName);
...

    {
      ...
      lResetAllCalibration.setOnAction((e) -> {
        for (int i = 0; i < pCalibrationEngine.getLightSheetMicroscope()
      ...
      for (CalibrationModuleInterface lCalibrationModule : lModuleList)
      {
        try
        {
          ...
          String
              ...
              lCalibrationModuleClass.getPackage().getName()
              + ".gui."
