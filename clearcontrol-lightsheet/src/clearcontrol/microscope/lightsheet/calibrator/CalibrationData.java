...
public class CalibrationData
{
  ...
  @SuppressWarnings("javadoc") public UnivariateAffineFunction[] mLightSheetXFunctions,
      mLightSheetYFunctions, mLightSheetZFunctions, mLightSheetWidthFunctions,
      mLightSheetHeightFunctions, mLightSheetAlphaFunctions, mLightSheetBetaFunctions,
      mLightSheetPowerFunctions, mDetectionArmZFunctions;

  @SuppressWarnings("javadoc") public PolynomialFunction[] mLightSheetWidthPowerFunctions,
      mLightSheetHeightPowerFunctions;

  @SuppressWarnings("javadoc") public HashMap<String, LightSheetPositioner>
      mPositionerMap =
      new HashMap<>();
  ...
  public void applyTo(LightSheetMicroscope pLightSheetMicroscope)
  {
    ...
    for (int l = 0; l < mLightSheetXFunctions.length; l++)
    {
      LightSheetInterface
          lLightSheetDevice =
          pLightSheetMicroscope.getDeviceLists().getDevice(LightSheetInterface.class, l);
  ...
  public void copyFrom(LightSheetMicroscope pLightSheetMicroscope)
  {
    ...
    for (int l = 0; l < mLightSheetXFunctions.length; l++)
    {
      ...
      mLightSheetXFunctions[l] =
          new UnivariateAffineFunction(lLightSheetDevice.getXFunction().get());
      mLightSheetYFunctions[l] =
          new UnivariateAffineFunction(lLightSheetDevice.getYFunction().get());
      mLightSheetZFunctions[l] =
          new UnivariateAffineFunction(lLightSheetDevice.getZFunction().get());
      mLightSheetWidthFunctions[l] =
          new UnivariateAffineFunction(lLightSheetDevice.getWidthFunction().get());
      mLightSheetHeightFunctions[l] =
          new UnivariateAffineFunction(lLightSheetDevice.getHeightFunction().get());
      mLightSheetAlphaFunctions[l] =
          new UnivariateAffineFunction(lLightSheetDevice.getAlphaFunction().get());
      mLightSheetBetaFunctions[l] =
          new UnivariateAffineFunction(lLightSheetDevice.getBetaFunction().get());
      mLightSheetPowerFunctions[l] =
          new UnivariateAffineFunction(lLightSheetDevice.getPowerFunction().get());
    ...
    for (int d = 0; d < mDetectionArmZFunctions.length; d++)
    {
      ...
      mDetectionArmZFunctions[d] =
          new UnivariateAffineFunction(lDetectionArmDevice.getZFunction().get());
    }
  }
