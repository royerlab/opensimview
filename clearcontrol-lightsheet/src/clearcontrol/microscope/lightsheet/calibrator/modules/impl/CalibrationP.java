 ...
 * @author royer
 */
public class CalibrationP extends CalibrationBase implements CalibrationModuleInterface,
                                                             HasStateDescriptionPerLightSheet
{

  BoundedVariable<Integer>
      mNumberOfSamplesVariable =
      new BoundedVariable<Integer>("Number of samples", 6, 0, Integer.MAX_VALUE);
                           ...
                           int pNumberOfSamples)
  {
    try
    {
      ...
      double
          lMiddleZ =
          lLightSheetDevice.getZVariable().get().doubleValue();// (lMaxZ - lMinZ) / 2;
  ...
  @Override public void reset()
  {
    ...
    {
      getLightSheetMicroscope().getDeviceLists()
                               .getDevice(LightSheetInterface.class, lLightSheetIndex)
                               .getPowerFunction()
                               .set(UnivariateAffineFunction.axplusb(1, 0));
    }
  ...
  @Override public String getStateDescription(int pLightSheetIndex)
  {
    ...
    UnivariateAffineFunction
        ...
        lLightSheetDevice.getPowerFunction().get();
