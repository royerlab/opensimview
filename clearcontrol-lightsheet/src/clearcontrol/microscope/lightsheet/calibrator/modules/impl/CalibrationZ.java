 ...
 * @author royer
 */
public class CalibrationZ extends CalibrationPerLightSheetBase implements
                                                               ...
                                                               HasStateDescriptionPerLightSheet
{
  ...
  private BoundedVariable<Double>
          mLaserPowerVariable =
          new BoundedVariable<Double>("Laser Power",
                  0.1,
                  0.0,
                  1.0,
                  0.001);
  ...
  private Variable<Boolean>
          mFullRangeVariable =
          new Variable<Boolean>("Full range",false);
    ...
    do
    {
      ...
      lError =
          calibrateZ(pLightSheetIndex,
                     !mFullRangeVariable.get().booleanValue(),
                     lSearchAmplitude,
                     pLightSheetIndex == 0);
      info("############################################## Error = " + lError);
  ...
  public BoundedVariable<Double> getLaserPowerVariable() { return mLaserPowerVariable; }

  public Variable<Boolean> getFullRangeVariable() {return mFullRangeVariable; }
