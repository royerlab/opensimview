 ...
 * @author royer
 */
public class LightSheetMicroscope extends MicroscopeBase<LightSheetMicroscope, LightSheetMicroscopeQueue> implements
                                                                                                          LightSheetMicroscopeInterface
{
                              ...
                              int pThreadPoolSize)
  {
    ...
    for (Class lContainerType : new Class[] { StackInterfaceContainer.class,
  ...
  @Override public int getNumberOfDetectionArms()
  {
    return getNumberOfDevices(DetectionArmInterface.class);
  }

  @Override public int getNumberOfLightSheets()
  {
    return getNumberOfDevices(LightSheetInterface.class);
  }

  @Override public int getNumberOfLaserLines()
  {
    return getNumberOfDevices(LaserDeviceInterface.class);
  }

  @Override public DetectionArmInterface getDetectionArm(int pDeviceIndex)
  {
    return getDevice(DetectionArmInterface.class, pDeviceIndex);
  }

  @Override public LightSheetInterface getLightSheet(int pDeviceIndex)
  {
    return getDevice(LightSheetInterface.class, pDeviceIndex);
  }

  @Override public <T> void addDevice(int pDeviceIndex, T pDevice)
  {
  ...
  public InteractiveAcquisition addInteractiveAcquisition()
  {
    InteractiveAcquisition
        lInteractiveAcquisition =
        new InteractiveAcquisition("Interactive", this);
  ...
  public AdaptiveEngine<InterpolatedAcquisitionState> addAdaptiveEngine(
      InterpolatedAcquisitionState pAcquisitionState)
  {
    AdaptiveEngine<InterpolatedAcquisitionState>
        lAdaptiveEngine =
        new AdaptiveEngine<InterpolatedAcquisitionState>(this, pAcquisitionState);
  ...
  @Override public void setCameraWidthHeight(long pWidth, long pHeight)
  {
    for (int i = 0; i
                    < getDeviceLists().getNumberOfDevices(StackCameraDeviceInterface.class); i++)
    {
      StackCameraDeviceInterface<?>
          lDevice =
    ...
    for (int i = 0; i
                    < getDeviceLists().getNumberOfDevices(LightSheetInterface.class); i++)
    {
  ...
  @Override public int getCameraWidth(int pCameraDeviceIndex)
  {
    @SuppressWarnings("unchecked") Variable<Long>
        lStackWidthVariable =
        getDeviceLists().getDevice(StackCameraDeviceInterface.class, pCameraDeviceIndex)
  ...
  @Override public int getCameraHeight(int pCameraDeviceIndex)
  {
    @SuppressWarnings("unchecked") Variable<Long>
        lStackHeightVariable =
        getDeviceLists().getDevice(StackCameraDeviceInterface.class, pCameraDeviceIndex)
  ...
  @Override public void setExposure(double pExposureInSeconds)
  {

    for (StackCameraDeviceInterface<?> lStackCamera : getDeviceLists().getDevices(
  ...
  @Override public double getExposure(int pCameraDeviceIndex)
  {
  ...
  @Override public void setLO(int pLaserIndex, boolean pLaserOnOff)
  {
    getDevice(LaserDeviceInterface.class, pLaserIndex).getLaserOnVariable()
                                                      .set(pLaserOnOff);
  }

  ;

  @Override public boolean getLO(int pLaserIndex)
  {
    return getDevice(LaserDeviceInterface.class, pLaserIndex).getLaserOnVariable().get();
  }

  @Override public void setLP(int pLaserIndex, double pLaserPowerInmW)
  {
    getDevice(LaserDeviceInterface.class, pLaserIndex).getTargetPowerInMilliWattVariable()
                                                      .set(pLaserPowerInmW);
  }

  ;

  @Override public double getLP(int pLaserIndex)
  {
    return getDevice(LaserDeviceInterface.class,
                     pLaserIndex).getTargetPowerInMilliWattVariable().get().doubleValue();
  }
  ...
  {
    final int
        lNumberOfLightSheetsDOFs =
        getDeviceLists().getNumberOfDevices(LightSheetInterface.class) * 7;
    final int
        lNumberOfDetectionArmDOFs =
        getDeviceLists().getNumberOfDevices(DetectionArmInterface.class) * 1;
  ...
  @Override public LightSheetMicroscopeQueue requestQueue()
  {
    LightSheetMicroscopeQueue
        lLightSheetMicroscopeQueue =
        new LightSheetMicroscopeQueue(this);

    return lLightSheetMicroscopeQueue;
  }

  @Override public FutureBooleanList playQueue(LightSheetMicroscopeQueue pQueue)
  {
