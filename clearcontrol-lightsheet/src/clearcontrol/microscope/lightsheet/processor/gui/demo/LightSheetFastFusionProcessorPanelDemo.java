 ...
 * @author royer
 */
public class LightSheetFastFusionProcessorPanelDemo extends Application implements
                                                                        AsynchronousExecutorFeature
{
  ...
  @Override public void start(Stage stage)
  {
    ...
    LightSheetFastFusionProcessor
        lProcessor =
        new LightSheetFastFusionProcessor("processor", lLightSheetMicroscope, null);

    LightSheetFastFusionProcessorPanel
        lPanel =
