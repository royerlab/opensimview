 ...
 * @author royer
 */
public class LightSheet extends QueueableVirtualDevice<LightSheetQueue> implements
                                                                        LightSheetInterface,
                                                                        ...
                                                                        LoggingFeature
{
  ...
  private final Variable<UnivariateAffineFunction>
      mXFunction =
      new Variable<>("LightSheetXFunction", new UnivariateAffineFunction());
  private final Variable<UnivariateAffineFunction>
      mYFunction =
      new Variable<>("LightSheetYFunction", new UnivariateAffineFunction());
  private final Variable<UnivariateAffineFunction>
      mZFunction =
      new Variable<>("LightSheetZFunction", new UnivariateAffineFunction());

  private final Variable<UnivariateAffineFunction>
      mWidthFunction =
      new Variable<>("LightSheetWidthFunction", new UnivariateAffineFunction());
  private final Variable<UnivariateAffineFunction>
      mHeightFunction =
      new Variable<>("LightSheetHeightFunction", new UnivariateAffineFunction());

  private final Variable<UnivariateAffineFunction>
      mAlphaFunction =
      new Variable<>("LightSheetAlphaFunction", new UnivariateAffineFunction());
  private final Variable<UnivariateAffineFunction>
      mBetaFunction =
      new Variable<>("LightSheetBetaFunction", new UnivariateAffineFunction());

  private final Variable<UnivariateAffineFunction>
      mPowerFunction =
      new Variable<>("LightSheetPowerFunction", new UnivariateAffineFunction());

  private final Variable<PolynomialFunction>
      mWidthPowerFunction =
      new Variable<>("LightSheetWidthPowerFunction",
                     new PolynomialFunction(new double[] { 1, 0 }));

  private final Variable<PolynomialFunction>
      mHeightPowerFunction =
   ...
   */
  @SuppressWarnings("unchecked") public LightSheet(String pName,
                                                   ...
                                                   final int pNumberOfLaserDigitalControls)
  {
    ...
    @SuppressWarnings("rawtypes") final VariableSetListener
        lVariableListener =
        (o, n) -> {
  ...
  @Override public int getNumberOfLaserDigitalControls()
  {
    return mNumberOfLaserDigitalControls;
  }

  @Override public BoundedVariable<Number> getEffectiveExposureInSecondsVariable()
  {
    return mLightSheetQueueTemplate.getEffectiveExposureInSecondsVariable();
  }

  @Override public BoundedVariable<Number> getFinalisationTimeInSecondsVariable()
  {
    return mLightSheetQueueTemplate.getFinalisationTimeInSecondsVariable();
  }

  @Override public BoundedVariable<Long> getImageHeightVariable()
  {
    return mLightSheetQueueTemplate.getImageHeightVariable();
  }

  @Override public BoundedVariable<Number> getOverScanVariable()
  {
    return mLightSheetQueueTemplate.getOverScanVariable();
  }

  @Override public BoundedVariable<Number> getReadoutTimeInMicrosecondsPerLineVariable()
  {
    return mLightSheetQueueTemplate.getReadoutTimeInMicrosecondsPerLineVariable();
  }

  @Override public BoundedVariable<Number> getXVariable()
  {
    return mLightSheetQueueTemplate.getXVariable();
  }

  @Override public BoundedVariable<Number> getYVariable()
  {
  ...
  @Override public BoundedVariable<Number> getAlphaInDegreesVariable()
  {
    return mLightSheetQueueTemplate.getAlphaInDegreesVariable();
  }

  @Override public BoundedVariable<Number> getBetaInDegreesVariable()
  {
    return mLightSheetQueueTemplate.getBetaInDegreesVariable();
  }

  @Override public BoundedVariable<Number> getWidthVariable()
  {
    return mLightSheetQueueTemplate.getWidthVariable();
  }

  @Override public BoundedVariable<Number> getHeightVariable()
  {
    return mLightSheetQueueTemplate.getHeightVariable();
  }

  @Override public BoundedVariable<Number> getPowerVariable()
  {
    return mLightSheetQueueTemplate.getPowerVariable();
  }

  @Override public Variable<Boolean> getAdaptPowerToWidthHeightVariable()
  {
    return mLightSheetQueueTemplate.getAdaptPowerToWidthHeightVariable();
  }

  @Override public Variable<StructuredIlluminationPatternInterface> getSIPatternVariable(
      int pLaserIndex)
  {
    return mLightSheetQueueTemplate.getSIPatternVariable(pLaserIndex);
  }

  @Override public int getNumberOfPhases(int pLaserIndex)
  {
    return mLightSheetQueueTemplate.getNumberOfPhases(pLaserIndex);
  }

  @Override public Variable<Boolean> getSIPatternOnOffVariable(int pLaserIndex)
  {
    return mLightSheetQueueTemplate.getSIPatternOnOffVariable(pLaserIndex);
  }

  @Override public Variable<Boolean> getLaserOnOffArrayVariable(int pLaserIndex)
  {
    return mLightSheetQueueTemplate.getLaserOnOffArrayVariable(pLaserIndex);
  }

  @Override public Variable<UnivariateAffineFunction> getXFunction()
  {
    return mXFunction;
  }

  @Override public Variable<UnivariateAffineFunction> getYFunction()
  {
    return mYFunction;
  }
  ...
  @Override public Variable<UnivariateAffineFunction> getWidthFunction()
  {
    return mWidthFunction;
  }

  @Override public Variable<UnivariateAffineFunction> getHeightFunction()
  {
    return mHeightFunction;
  }

  @Override public Variable<UnivariateAffineFunction> getAlphaFunction()
  {
    return mAlphaFunction;
  }

  @Override public Variable<UnivariateAffineFunction> getBetaFunction()
  {
    return mBetaFunction;
  }

  @Override public Variable<UnivariateAffineFunction> getPowerFunction()
  {
    return mPowerFunction;
  }

  @Override public Variable<PolynomialFunction> getWidthPowerFunction()
  {
    return mWidthPowerFunction;
  }

  @Override public Variable<PolynomialFunction> getHeightPowerFunction()
  {
    return mHeightPowerFunction;
  }

  @Override public LightSheetQueue requestQueue()
  {
    return new LightSheetQueue(mLightSheetQueueTemplate);
  }

  @Override public Future<Boolean> playQueue(LightSheetQueue pLightSheetQueue)
  {
