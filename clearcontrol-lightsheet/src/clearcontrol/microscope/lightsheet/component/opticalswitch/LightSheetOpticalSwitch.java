 ...
 * @author royer
 */
public class LightSheetOpticalSwitch extends QueueableVirtualDevice<LightSheetOpticalSwitchQueue> implements
                                                                                                  OpticalSwitchDeviceInterface
{
  ...
  @Override public String getSwitchName(int pSwitchIndex)
  {
    return "light sheet " + pSwitchIndex;
  }

  @Override public int getNumberOfSwitches()
  {
    return mNumberOfLightSheets;
  }

  @Override public Variable<Boolean> getSwitchVariable(int pLightSheetIndex)
  {
    return mLightSheetOpticalSwitchQueueTemplate.getSwitchVariable(pLightSheetIndex);
  }

  @Override public LightSheetOpticalSwitchQueue requestQueue()
  {
    return new LightSheetOpticalSwitchQueue(mLightSheetOpticalSwitchQueueTemplate);
  }

  @Override public Future<Boolean> playQueue(LightSheetOpticalSwitchQueue pQueue)
  {
    // do nothing
    return null;
  }
