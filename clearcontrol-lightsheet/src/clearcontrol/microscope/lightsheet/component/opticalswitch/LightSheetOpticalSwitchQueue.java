 ...
 * @author royer
 */
public class LightSheetOpticalSwitchQueue extends VariableQueueBase implements
                                                                    QueueInterface
{
   ...
   */
  @SuppressWarnings("unchecked") public LightSheetOpticalSwitchQueue(
      LightSheetOpticalSwitch pLightSheetOpticalSwitch)
  {
    ...
    {
      mLightSheetOnOff[i] =
          new Variable<Boolean>(String.format("LightSheet%dOnOff", i), false);
