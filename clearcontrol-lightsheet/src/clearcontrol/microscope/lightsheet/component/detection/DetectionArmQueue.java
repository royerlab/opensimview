 ...
 * @author royer
 */
public class DetectionArmQueue extends VariableQueueBase implements QueueInterface,
                                                                    LoggingFeature
{
  ...
  public DetectionArmQueue(DetectionArm pDetectionArm)
  {
    ...
    mDetectionFocusZ =
        new BoundedVariable<Number>(mDetectionArm.getName() + "-DetectionFocusZ", 0.0);
