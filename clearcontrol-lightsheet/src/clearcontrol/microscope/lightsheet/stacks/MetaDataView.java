 ...
 * @author royer
 */
@SuppressWarnings("javadoc") public enum MetaDataView implements MetaDataEntryInterface<Integer>
{
  ...
  @Override public Class<Integer> getMetaDataClass()
  {
    return mClass;
  }
  ...
  public static final String getCxLyString(StackMetaData pStackMetaData)
  {
    ...
    if (pStackMetaData.getValue(MetaDataAcquisitionType.AcquisitionType)
        == AcquisitionType.TimeLapseInterleaved)
    {
      return "C" + pStackMetaData.getValue(MetaDataView.Camera) + "interleaved";
    }
    else if (pStackMetaData.getValue(MetaDataAcquisitionType.AcquisitionType)
