 ...
 * @author royer
 */
public class InterpolationTables extends ChangeListeningBase<InterpolationTables> implements
                                                                                  Cloneable
{
  private int mNumberOfLightSheetDevices;
  private int mNumberOfDetectionArmDevices;
  private ArrayList<AbstractInterpolationTable>
                             ...
                             int pNumberOfLightSheetDevices)
  {
    ...
    AbstractInterpolationTable
        lInterpolationTableDZ =
        new LinearInterpolationTable(mNumberOfDetectionArmDevices);

    AbstractInterpolationTable
        lInterpolationTableIX =
        new LinearInterpolationTable(mNumberOfLightSheetDevices);
    AbstractInterpolationTable
        lInterpolationTableIY =
        new LinearInterpolationTable(mNumberOfLightSheetDevices);
    AbstractInterpolationTable
        lInterpolationTableIZ =
        new LinearInterpolationTable(mNumberOfLightSheetDevices);

    AbstractInterpolationTable
        lInterpolationTableIA =
        new LinearInterpolationTable(mNumberOfLightSheetDevices);
    AbstractInterpolationTable
        lInterpolationTableIB =
        new LinearInterpolationTable(mNumberOfLightSheetDevices);
    AbstractInterpolationTable
        lInterpolationTableIW =
        new LinearInterpolationTable(mNumberOfLightSheetDevices);
    AbstractInterpolationTable
        lInterpolationTableIH =
        new LinearInterpolationTable(mNumberOfLightSheetDevices);
    AbstractInterpolationTable
        lInterpolationTableIP =
        new LinearInterpolationTable(mNumberOfLightSheetDevices);
    AbstractInterpolationTable
        lInterpolationTableII =
        new LinearInterpolationTable(mNumberOfLightSheetDevices);
  ...
  @Override public InterpolationTables clone()
  {
  ...
  public void set(InterpolationTables pInterpolationTable)
  {
    ...
    for (AbstractInterpolationTable lSplineInterpolationTable : pInterpolationTable.mInterpolationTableList)
    {
      ...
      {
        mInterpolationTableList.add(((LinearInterpolationTable) lSplineInterpolationTable)
                                        .clone());
      }
      else if (lSplineInterpolationTable instanceof SplineInterpolationTable)
      {
        mInterpolationTableList.add(((SplineInterpolationTable) lSplineInterpolationTable)
                                        .clone());
      }
    }
  }
  ...
  public void addControlPlane(InterpolationTables pInterpolationTables, double pZ)
  {
    ...
    {
      AbstractInterpolationTable
          lSplineInterpolationTable =
          mInterpolationTableList.get(j);
      AbstractInterpolationTable
          lOtherSplineInterpolationTable =
