...
public class AcquisitionStatePanel extends CustomGridPane
{
  ...
  public AcquisitionStatePanel(InterpolatedAcquisitionState pAcquisitionState)
  {
    ...
    VariableSlider<Number>
        lStageXSlider =
        new VariableSlider<Number>("stageX", lStageXVariable, 5);

    VariableSlider<Number>
        lStageYSlider =
        new VariableSlider<Number>("stageY", lStageYVariable, 5);

    VariableSlider<Number>
        lStageZSlider =
        new VariableSlider<Number>("stageZ", lStageZVariable, 5);
    ...
    BoundedVariable<Double>
        ...
        new BoundedVariable<Double>("ControlPlanesZLow",
                                    lZLow.get().doubleValue(),
                                    lZLow.get().doubleValue(),
                                    lZHigh.get().doubleValue());
    ...
    Variable<ControlPlaneLayout>
        lControlPlaneLayoutModeVariable =
        new Variable<>("ControlPlaneLayoutMode", ControlPlaneLayout.Circular);
    ...
    NumberVariableTextField<Number>
        lExposureField =
    ...
    VariableRangeSlider<Double>
        lControlPlaneZRangeSlider =
        new VariableRangeSlider<Double>("CP-range",
                                        lControlPlanesZLow,
                                        lControlPlanesZHigh,
                                        lZLow.getMinVariable().get().doubleValue(),
                                        lZHigh.getMaxVariable().get().doubleValue(),
                                        0.01d,
                                        null);
    ...
    lSetAnisotropyFactorButton.setOnAction((e) -> pAcquisitionState.setNumberOfPlanesForGivenAnisotropy(
        lAnisotropyFactor.get().doubleValue()));

    EnumComboBoxVariable<ControlPlaneLayout>
    ...
    lSetupControlPlanesButton.setOnAction((e) -> pAcquisitionState.setupControlPlanes(
        pAcquisitionState.getNumberOfControlPlanes(),
        lControlPlanesZLow.get().doubleValue(),
        lControlPlanesZHigh.get().doubleValue(),
...

    {
      HBox
          lHBox =
          new HBox(new Label("Control plane layout mode: "),
                   lControlPlaneLayoutModeComboBox,
                   new Label("      "),
