                                                                  ...
                                                                  AsynchronousExecutorFeature
{
  ...
  @Override public void start(Stage stage)
  {
    ...
    LightSheetMicroscope
        ...
        new LightSheetMicroscope("Dummy", null, 1, 1);
    ...
    final AcquisitionStateManager<InterpolatedAcquisitionState>
        lAcquisitionStateManager =
        new AcquisitionStateManager<>(null);
    AcquisitionStateManagerPanel
        lAcquisitionStateManagerPanel =
        new AcquisitionStateManagerPanel(lAcquisitionStateManager);

    InterpolatedAcquisitionState
        lState1 =
        new InterpolatedAcquisitionState("current", lLightSheetMicroscope);
    ...
    for (int i = 0; i < 10; i++)
    {
      InterpolatedAcquisitionState
          lState =
          new InterpolatedAcquisitionState("State" + i, lLightSheetMicroscope);
