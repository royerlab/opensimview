...
{
  boolean mBackup;
  private static ArrayList<AcquisitionStateInterface>
      mAcquisitionStateList =
      new ArrayList<>();
    ...
    if (mBackup)
    {
      AcquisitionStateInterface
          ...
          getLightSheetMicroscope().getAcquisitionStateManager()
                                   .getCurrentState()
                                   .duplicate("backup " + System.currentTimeMillis());
  ...
  @Override public AcquisitionStateBackupRestoreInstruction copy()
  {
