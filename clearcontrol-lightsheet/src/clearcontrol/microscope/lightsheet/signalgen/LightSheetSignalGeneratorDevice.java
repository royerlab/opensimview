 ...
 * @author royer
 */
public class LightSheetSignalGeneratorDevice extends VirtualDevice implements
                                                                   ...
                                                                   LoggingFeature
{
                                         ...
                                         boolean pSharedLightSheetControl)
  {
    ...
    mIsSharedLightSheetControlVariable =
        new Variable<Boolean>("IsSharedLightSheetControl", pSharedLightSheetControl);
  ...
  @Override public LightSheetSignalGeneratorQueue requestQueue()
  {
    return new LightSheetSignalGeneratorQueue(mTemplateQueue);
  }

  @Override public Future<Boolean> playQueue(LightSheetSignalGeneratorQueue pQueue)
  {
    SignalGeneratorQueue lDelegatedQueue = pQueue.getDelegatedQueue();

    Double
        lTransitionDurationInSeconds =
        pQueue.getTransitionDurationInSecondsVariable().get();
