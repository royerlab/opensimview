                                                                                        ...
                                                                                        PropertyIOableInstructionInterface
{
  ...
  private BoundedVariable<Double>
      mAlphaStepVariable =
      new BoundedVariable<Double>("alphaRange", 0.5, 0.01, Double.MAX_VALUE, 0.01);
  ...
  {
    super("Adaptation: Focus finder alpha for C"
          + pDetectionArmIndex
          + "L"
          + pLightSheetIndex
          + "CPI"
  ...
  @Override public boolean enqueue(long pTimePoint)
  {
    ...
    double
        ...
        lAcquisitionState.getInterpolationTables()
                         .get(LightSheetDOF.IA, cpi, lLightSheetIndex);
    info("old alpha " + lIZ);

    lAcquisitionState.getInterpolationTables()
                     .set(LightSheetDOF.IA, cpi, lLightSheetIndex, alpha);
                                            ...
                                            int lCameraIdx)
  {
    ...
    for (int illuminationAlphaIndex = 0; illuminationAlphaIndex
                                         < lNumberOfImagesToTake; illuminationAlphaIndex++)
    {
      ...
      double
          lPositionAlpha =
          lAlphaStart + illuminationAlphaIndex * lIlluminationAlphaStep;
  ...
  @Override public FocusFinderAlphaByVariationInstruction copy()
  {
  ...
  {
    return new Variable[] { getAlphaStepVariable(),
