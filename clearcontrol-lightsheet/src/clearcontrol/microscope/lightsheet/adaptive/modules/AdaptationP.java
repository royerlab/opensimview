 ...
 * @author royer
 */
public class AdaptationP extends AdaptationModuleBase<InterpolatedAcquisitionState> implements
                                                                                    AdaptationModuleInterface<InterpolatedAcquisitionState>
{

  private BoundedVariable<Double>
      mTargetLaserPowerVariable =
      new BoundedVariable<Double>("Target laser power", 0.5, 0.0, 1.0, 0.1);
  ...
  @Override public Boolean apply(Void pVoid)
  {
    ...
    try
    {
      ...
      for (int d = 0; d < lNumberOfDetectionArmDevices; d++)
      {
        final OffHeapPlanarStack
            lStack =
            (OffHeapPlanarStack) lLightsheetMicroscope.getCameraStackVariable(d).get();
        double[]
            lImageSumIntensity =
      ...
      for (int l = 0; l < lNumberOfLightSheets; l++)
      {
        double
            lRenormalizedPower =
            (mTargetLaserPowerVariable.get() / lMaxUnNormalizedPower)
      ...
      for (int l = 0; l < lNumberOfLightSheets; l++)
        ...
        {
          System.out.format(
              "Setting new power for lightsheet %d and control mplane %d:  %g \n",
              l,
              czi,
              lPowerPerLightSheet.get(l));
  ...
  @Override public boolean areAllTasksCompleted()
  {
    // TODO Auto-generated method stub
    return false;
  }

  @Override public boolean areAllStepsCompleted()
  {
    // TODO Auto-generated method stub
    return false;
  }

  @Override public int getRemainingNumberOfSteps()
  {
    // TODO: change this
    return 1;
  }
