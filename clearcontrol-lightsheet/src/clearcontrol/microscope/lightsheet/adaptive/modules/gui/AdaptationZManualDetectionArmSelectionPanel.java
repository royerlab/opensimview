...
{
  public AdaptationZManualDetectionArmSelectionPanel(
      AdaptationZManualDetectionArmSelection pAdaptationZManualDetectionArmSelection)
  {
    ...
    for (int i = 0; i
                    < pAdaptationZManualDetectionArmSelection.getNumberOfControlPlanes(); i++)
    {
