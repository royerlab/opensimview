                                                                ...
                                                                StandardAdaptationModulePanel
{
   ...
   */
  public AdaptationZSlidingWindowDetectionArmSelectionPanel(
      AdaptationZSlidingWindowDetectionArmSelection pAdaptationZSlidingWindowDetectionArmSelection)
  {
    ...
    addNumberTextFieldForVariable(
        "Sliding window width for detection arm runEpoch (no of control planes)): ",
