...
public class StandardAdaptationModulePanel extends CustomVariablePane
{
  ...
  public StandardAdaptationModulePanel(StandardAdaptationModule pAdaptationModule)
  {
    ...
    addNumberTextFieldForVariable("Laser line to use: ",
            pAdaptationModule.getLaserLineVariable(),
            0,
            8,
            1);
    ...
    addNumberTextFieldForVariable("max (absolute) correction: ",
            pAdaptationModule.getMaxCorrectionVariable(),
            0.0,
            1000.0,
            0.001);
