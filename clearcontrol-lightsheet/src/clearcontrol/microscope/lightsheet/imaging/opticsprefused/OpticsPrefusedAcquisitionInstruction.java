 ...
 * 2018
 */
public class OpticsPrefusedAcquisitionInstruction extends AbstractAcquistionInstruction implements
                                                                                        ...
                                                                                        LoggingFeature
{
  ...
  @Override public boolean enqueue(long pTimePoint)
  {
    ...
    getLightSheetMicroscope().getDataWarehouse()
                             .put("opticsprefused_raw_" + pTimePoint, lContainer);

    return true;
  }

  @Override public OpticsPrefusedAcquisitionInstruction copy()
  {
