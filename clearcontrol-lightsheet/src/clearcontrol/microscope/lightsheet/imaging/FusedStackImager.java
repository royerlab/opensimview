  ...
  public StackInterface acquire()
  {
    ...
    case TimelapseSequential:
      lAcquisitionScheduler =
          mLightSheetMicroscope.getDevice(SequentialAcquisitionInstruction.class, 0);
      lFusionScheduler =
          mLightSheetMicroscope.getDevice(SequentialFusionInstruction.class, 0);
      break;
    case TimeLapseOpticallyCameraFused:
      lAcquisitionScheduler =
          mLightSheetMicroscope.getDevice(OpticsPrefusedAcquisitionInstruction.class, 0);
      lFusionScheduler =
          mLightSheetMicroscope.getDevice(OpticsPrefusedFusionInstruction.class, 0);
      break;
    case TimeLapseInterleaved:
    default:
      lAcquisitionScheduler =
          mLightSheetMicroscope.getDevice(InterleavedAcquisitionInstruction.class, 0);
      lFusionScheduler =
          mLightSheetMicroscope.getDevice(InterleavedFusionInstruction.class, 0);
      break;
    }
