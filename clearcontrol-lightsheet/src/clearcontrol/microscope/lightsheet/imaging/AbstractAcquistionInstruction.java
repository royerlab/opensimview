                                                                                        ...
                                                                                        LoggingFeature
{
  ...
  protected Variable<String>
      mChannelName =
      new Variable<String>("Dataset name for saving", "default");
  ...
  @Override public boolean initialize()
  {
    ...
    LightSheetFastFusionProcessor
        lProcessor =
        getLightSheetMicroscope().getDevice(LightSheetFastFusionProcessor.class, 0);
    if (lProcessor != null)
    {
                                     ...
                                     StackInterfaceContainer pContainer)
  {
    ...
    Variable<StackInterface>
        lStackCopyVariable =
        new Variable<StackInterface>("stackcopy", null);
    ...
    if ((lStackCopyVariable.get().getMetaData().getTimeStampInNanoseconds()
    ...
    info(pKey
         ...
         + ") in a container "
         + MetaDataView.getCxLyString(lStackCopyVariable.get().getMetaData()));
  ...
  @Deprecated protected void initializeStackSaving(FileStackSinkInterface pFileStackSinkInterface)
  {
                                     ...
                                     double lDetectionZZStart)
  {
    ...
    lQueue.addVoxelDimMetaData(lLightsheetMicroscope,
                               mCurrentState.getStackZStepVariable().get().doubleValue());
  }

  @Deprecated protected void handleImageFromCameras(long pTimepoint)
  {
   ...
   * @return
   */
  @Deprecated public StackInterface getLastAcquiredStack()
  {
    warning(
        "getLastAcquiredStack is deprecated and will be removed. Access acquired images via the DataWarehouse instead!");
