 ...
 * 2018
 */
public class InterleavedAcquisitionInstruction extends AbstractAcquistionInstruction implements
                                                                                     ...
                                                                                     LoggingFeature
{
  ...
  @Override public boolean enqueue(long pTimePoint)
  {
    ...
    getLightSheetMicroscope().getDataWarehouse()
                             .put("interleaved_raw_" + pTimePoint, lContainer);

    return true;
  }

  @Override public InterleavedAcquisitionInstruction copy()
  {
