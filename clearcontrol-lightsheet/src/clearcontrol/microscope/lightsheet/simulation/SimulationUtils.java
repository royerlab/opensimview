...
public class SimulationUtils
{
   ...
   * @return
   */
  @SuppressWarnings("javadoc") public static LightSheetMicroscopeSimulationDevice getSimulatorDevice(
      ...
      boolean pUniformFluorescence)
  {
    ...
    LightSheetMicroscopeSimulatorDrosophila
        lSimulator =
    ...
    if (pUniformFluorescence)
    {
      ...
      lFluoPhantomImage.readFrom(lUniformNoise.generateTexture(lEffPhantomWidth,
                                                               lEffPhantomHeight,
                                                               lEffPhantomDepth), true);

      lUniformNoise.setMin(0.0001f);
      lUniformNoise.setMax(0.001f);
      lScatterPhantomImage.readFrom(lUniformNoise.generateTexture(lEffPhantomWidth / 2,
                                                                  lEffPhantomHeight / 2,
                                                                  lEffPhantomDepth / 2),
                                    true);
    ...
    LightSheetMicroscopeSimulationDevice
        lLightSheetMicroscopeSimulatorDevice =
