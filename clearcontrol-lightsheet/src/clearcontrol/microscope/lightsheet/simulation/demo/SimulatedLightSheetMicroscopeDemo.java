 ...
 * @author royer
 */
public class SimulatedLightSheetMicroscopeDemo extends Application implements
    ...
    Runnable lRunnable = () -> {
      ...
      ClearCLContext
          ...
          getClearCLDeviceByName(lClearCL,
                                 lMachineConfiguration.getStringProperty(
