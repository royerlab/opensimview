 ...
 * @author royer
 */
public class LightSheetMicroscopeSimulationDevice extends SampleSimulationDeviceBase<LightSheetMicroscopeQueue> implements
                                                                                                                SampleSimulationDeviceInterface<LightSheetMicroscopeQueue>
{
  ...
  private ArrayList<LightSheetSimulationStackProvider>
      mLightSheetSimulationStackProviderList =
      new ArrayList<>();
  ...
  @Override public LightSheetSimulationStackProvider getStackProvider(int pIndex)
  {
    return mLightSheetSimulationStackProviderList.get(pIndex);
  }

  @Override public void connectTo(MicroscopeInterface<LightSheetMicroscopeQueue> pMicroscope)
  {
    ...
    if (lMainXYZRStage != null)
    {
      ...
      lMainXYZRStage.getCurrentPositionVariable(0)
                    .addSetListener((o, n) -> mLightSheetMicroscopeSimulator.setNumberParameter(
                        StageParameter.StageX,
                        0,
                        n));

      lMainXYZRStage.getCurrentPositionVariable(1)
                    .addSetListener((o, n) -> mLightSheetMicroscopeSimulator.setNumberParameter(
                        StageParameter.StageY,
                        0,
                        n));

      lMainXYZRStage.getCurrentPositionVariable(2)
                    .addSetListener((o, n) -> mLightSheetMicroscopeSimulator.setNumberParameter(
                        StageParameter.StageZ,
                        0,
                        n));

      lMainXYZRStage.getCurrentPositionVariable(3)
                    .addSetListener((o, n) -> mLightSheetMicroscopeSimulator.setNumberParameter(
                        StageParameter.StageRY,
                        0,
                        n));
    }
    ...
    for (int i = 0; i < lNumberOfCameras; i++)
    {
      LightSheetSimulationStackProvider
          lLightSheetSimulationStackProvider =
