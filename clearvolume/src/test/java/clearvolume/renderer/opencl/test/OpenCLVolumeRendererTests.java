...
public class OpenCLVolumeRendererTests
{
                                             ...
                                             IOException
  {
    ...
    final ByteBuffer lByteBuffer =
                                 ByteBuffer.allocateDirect(toIntExact(lLength
                                                                      * lBytesPerVoxel))
    ...
    final OffHeapMemory lOffHeapMemory =
                                       OffHeapMemory.allocateBytes(lLength);
                                              ...
                                              IOException
  {
    ...
    for (int z = 0; z < lResolutionZ; z++)
      for (int y = 0; y < lResolutionY; y++)
        for (int x = 0; x < lResolutionX; x++)
        {
          final char lValue = (char) (256 * ((char) x ^ (char) y
                                             ^ (char) z));
    ...
    final OffHeapMemory lOffHeapMemory =
                                       OffHeapMemory.allocateShorts(lLength);
