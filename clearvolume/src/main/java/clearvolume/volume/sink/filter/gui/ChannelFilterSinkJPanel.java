                                     ...
                                     ListDataListener
{
    ...
    EventQueue.invokeLater(new Runnable()
    {
      ...
      public void run()
      {
        try
        {
          ...
          final ChannelFilterSinkJPanel lChannelFilterSinkJPanel =
                                                                 new ChannelFilterSinkJPanel(pChannelFilterSink);
  ...
  public ChannelFilterSinkJPanel(final ChannelFilterSink pChannelFilterSink)
  {
    ...
    {
      final ListModel<String> lChannelListModel =
                                                pChannelFilterSink.getChannelListModel();
  ...
  private void update()
  {
    final int[] lActiveChannels =
                                mActiveChannelJList.getSelectedIndices();
  ...
  public void intervalAdded(final ListDataEvent pE)
  {
    SwingUtilities.invokeLater(new Runnable()
    {
      ...
      public void run()
      {
        final TIntArrayList lSelectedIndices =
                                             new TIntArrayList(mActiveChannelJList.getSelectedIndices());
