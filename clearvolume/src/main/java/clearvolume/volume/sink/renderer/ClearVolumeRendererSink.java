...
public class ClearVolumeRendererSink extends RelaySinkAdapter
                                     implements
                                     RelaySinkInterface,
                                     ClearVolumeCloseable
{
  ...
  private final TreeMap<Integer, String> mSeenChannelIdToNameMap =
  ...
  public void sendVolume(Volume pVolume)
  {
    ...
    if (mClearVolumeRendererInterface == null
        || mClearVolumeRendererInterface.getNumberOfRenderLayers() < lNumberOfLayersNeeded
    ...
    final int lNumberOfRenderLayers =
                                    mClearVolumeRendererInterface.getNumberOfRenderLayers();
    ...
    {
      lTransferFunction =
                        TransferFunctions.getGradientForColor(lColor);
                              ...
                              int pNumberOfLayers)
  {
    ...
    mClearVolumeRendererInterface =
                                  ClearVolumeRendererFactory.newBestRenderer(mRequestedWindowTitle,
    ...
    mVolumeManager =
                   mClearVolumeRendererInterface.createCompatibleVolumeManager(mMaxNumberOfAvailableVolumes);
