...
public class ClearVolumeStressTestDemos
{
  ...
  public static void main(final String[] argv) throws ClassNotFoundException
  {
    ...
    {
      final Class<?> c =
                       Class.forName("clearvolume.demo.ClearVolumeStressTestDemos");
    ...
    {
      final ClearVolumeStressTestDemos cvdemo =
                                              new ClearVolumeStressTestDemos();
      Method m;
                                                    ...
                                                    IOException
  {
    ...
    ContiguousBuffer lContiguousBuffer =
                                       ContiguousBuffer.allocate(lResolutionX
                                                                 * lResolutionY
                                                                 * lResolutionZ
                                                                 * 2L);
    ...
    for (int z = 0; z < lResolutionZ; z++)
      for (int y = 0; y < lResolutionY; y++)
        for (int x = 0; x < lResolutionX; x++)
        {
          lContiguousBuffer.writeByte((byte) (((byte) x ^ (byte) y
                                               ^ (byte) z)));
