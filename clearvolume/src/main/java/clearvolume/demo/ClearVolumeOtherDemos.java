...
public class ClearVolumeOtherDemos
{
  ...
  public static void main(final String[] argv) throws ClassNotFoundException
  {
    ...
    {
      final Class<?> c =
                       Class.forName("clearvolume.demo.ClearVolumeOtherDemos");
    ...
    {
      final ClearVolumeOtherDemos cvdemo =
                                         new ClearVolumeOtherDemos();
      Method m;
                                     ...
                                     IOException
  {
    ...
    final ClearVolumeRendererInterface lClearVolumeRenderer =
                                                            ClearVolumeRendererFactory.newBestRenderer("ClearVolumeTest",
                                                                                                       ...
                                                                                                       1,
                                                                                                       true);
    final NewtCanvasAWT lNewtCanvasAWT =
                                       lClearVolumeRenderer.getNewtCanvasAWT();
                                                  ...
                                                  IOException
  {
    ...
    {
      lEgg3DController =
                       new ExternalRotationController(ExternalRotationController.cDefaultEgg3DTCPport,
    ...
    final ByteBuffer lWrappedArray =
                                   ByteBuffer.wrap(lVolumeDataArray);
    lClearVolumeRenderer.setVolumeDataBuffer(0,
                                             lWrappedArray,
                                             lResolutionX,
    ...
    for (int z = 0; z < lResolutionZ; z++)
      for (int y = 0; y < lResolutionY; y++)
        for (int x = 0; x < lResolutionX; x++)
        {
          ...
          double res =
                     (0 + 200 * Math.exp(-100 * (r1 - r0) * (r1 - r0))
                      + 200 * Math.exp(-100 * (r2 - r0) * (r2 - r0)));
  ...
  public void demoClipping() throws InterruptedException, IOException
  {
    ...
    lClearVolumeRenderer.setTransferFunction(TransferFunctions.getDefault());
    lClearVolumeRenderer.setVisible(true);
    lClearVolumeRenderer.setClipBox(-1.0f,
                                    1.0f,
                                    -1.0f,
                                    1.0f,
                                    -1.0f,
