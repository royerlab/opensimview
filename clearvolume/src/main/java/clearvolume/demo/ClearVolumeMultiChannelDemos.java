...
public class ClearVolumeMultiChannelDemos
{
  ...
  public static void main(final String[] argv) throws ClassNotFoundException
  {
    ...
    {
      final Class<?> c =
                       Class.forName("clearvolume.demo.ClearVolumeMultiChannelDemos");
    ...
    {
      final ClearVolumeMultiChannelDemos cvdemo =
                                                new ClearVolumeMultiChannelDemos();
      Method m;
                                                          ...
                                                          IOException
  {
    ...
    final byte[] lVolumeDataArray0 = new byte[lResolutionX
                                              * lResolutionY
                                              * lResolutionZ];
    ...
    final byte[] lVolumeDataArray1 = new byte[lResolutionX
                                              * lResolutionY
                                              * lResolutionZ];
                                                          ...
                                                          IOException
  {
    ...
    final byte[] lVolumeDataArray2 = new byte[lResolutionX
                                              * lResolutionY
                                              * lResolutionZ];
        ...
        for (int x = 0; x < lResolutionX / 2; x++)
        {
          final int lIndex = lResolutionX / 2 + x
                             ...
                             + lResolutionX * lResolutionY
                               * (lResolutionZ / 2 + z);
          int lCharValue = 255 - (((byte) (x) ^ (byte) (y + z)
                                   ^ (byte) z));
          if (lCharValue < 12)
            lCharValue = 0;
    ...
    while (lClearVolumeRenderer.isShowing())
    {
      ...
      lClearVolumeRenderer.setLayerVisible(i % 3,
                                           !lClearVolumeRenderer.isLayerVisible(i
                                                                                % 3));/**/
    ...
    {
      {
        ...
        lClearVolumeRenderer.waitToFinishAllDataBufferCopy(2,
                                                           TimeUnit.SECONDS);
