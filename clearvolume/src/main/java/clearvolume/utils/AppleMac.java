...
public class AppleMac
{
    ...
    try
    {
      final Thread lThread = new Thread("Apple Set Application Icon")
      {
        ...
        public void run()
        {
          ...
          {
            Method lMethod =
                           cClass.getDeclaredMethod("setDockIconImage",
                                                    Image.class);
          ...
          {
            System.out.println(AppleMac.class.getSimpleName()
                               + ": Could not set Dock Icon (not on osx?)");
          }
          super.run();
        }
      };
  ...
  public final static boolean requestFullscreen(final Window pWindow)
  {
    ...
    try
    {
      ...
      Method lMethod =
                     cClass.getDeclaredMethod("requestToggleFullScreen",
                                              Window.class);
