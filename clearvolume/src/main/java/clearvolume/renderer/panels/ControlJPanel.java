...
public class ControlJPanel extends JPanel
{
                       ...
                       final ClearVolumeRendererInterface pClearVolumeRendererInterface)
  {
    ...
    this.mClearVolumeRendererInterface =
    ...
    final JSlider lGammaSlider =
                               new JSlider(0,
                                           cPrecision,
                                           (int) (cPrecision * .5
                                                  * mClearVolumeRendererInterface.getGamma(layerId)));
    ...
    final JSlider lMinSlider =
                             new JSlider(0,
                                         cPrecision,
                                         (int) (cPrecision
                                                * mClearVolumeRendererInterface.getTransferRangeMin(layerId)));
    final JSlider lMaxSlider =
                             new JSlider(0,
                                         cPrecision,
                                         (int) (cPrecision
                                                * mClearVolumeRendererInterface.getTransferRangeMax(layerId)));
    ...
    final JSlider lQuality =
                           new JSlider(0,
                                       cPrecision,
                                       (int) (cPrecision
                                              * mClearVolumeRendererInterface.getQuality(layerId)));
    ...
    final JSlider lDithering =
                             new JSlider(0,
                                         cPrecision,
                                         (int) (cPrecision
                                                * mClearVolumeRendererInterface.getDithering(layerId)));

    final JLabel lblDithering =
                              new JLabel(String.format("dithering"));
    add(lblDithering);
