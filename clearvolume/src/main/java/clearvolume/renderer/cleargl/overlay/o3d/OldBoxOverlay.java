...
public class OldBoxOverlay extends OverlayBase implements Overlay3D
{
  ...
  private static final FloatBuffer cBoxColor =
                   ...
                   DisplayRequestInterface pDisplayRequestInterface)
  {
    ...
    {
      mBoxGLProgram =
                    GLProgram.buildProgram(pGL,
                                           OldBoxOverlay.class,
                                           "shaders/oldbox_vert.glsl",
                                           "shaders/oldbox_frag.glsl");

      mOverlayModelViewMatrixUniform =
                                     mBoxGLProgram.getUniform("modelview");
      mOverlayProjectionMatrixUniform =
                                      mBoxGLProgram.getUniform("projection");
      ...
      mBoxPositionAttributeArray =
                                 new GLVertexAttributeArray(mBoxPositionAttribute,
                                                            4);

      // FIXME this should be done with IndexArrays, but lets be lazy for
      // now...
      final GLFloatArray lVerticesFloatArray =
                                             new GLFloatArray(24, 4);
