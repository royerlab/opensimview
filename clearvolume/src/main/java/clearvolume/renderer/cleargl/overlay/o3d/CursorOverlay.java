                           ...
                           EyeRayListener
{
                   ...
                   DisplayRequestInterface pDisplayRequestInterface)
  {
    try
    {
      ...
      final GLFloatArray lTexCoordFloatArrayPlane =
                                                  new GLFloatArray(4,
                                                                   2);
                              ...
                              EyeRay pEyeRay)
  {
    ...
    final boolean lCorrectMouseEvent =
                                     (pMouseEvent.getEventType() == MouseEvent.EVENT_MOUSE_CLICKED
                                      || pMouseEvent.getEventType() == MouseEvent.EVENT_MOUSE_DRAGGED);

    if (!(lCorrectMouseButton && lCorrectMouseEvent
          && lCorrectModifier))
      return false;
