...
class KeyboardControl extends KeyAdapter implements KeyListener
{
  ...
  {
    final AutoRotationController lAutoRotateController =
                                                       mClearVolumeRenderer.getAutoRotateController();
    ...
    case KeyEvent.VK_T:
      ...
      {
        final CyclableTransferFunction lCyclableTransferFunction =
                                                                 (CyclableTransferFunction) mClearVolumeRenderer.getTransferFunction();
      ...
      {
        final CyclingTransferFunction lCyclingTransferFunction =
                                                               CyclingTransferFunction.getDefault();
                                              ...
                                              final Collection<?> lOverlays)
  {
    ...
    for (final Object lOverlay : lOverlays)
      ...
      {
        final SingleKeyToggable lSingleKeyToggable =
                                                   (SingleKeyToggable) lOverlay;
