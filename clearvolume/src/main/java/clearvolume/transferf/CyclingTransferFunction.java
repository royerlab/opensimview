...
public class CyclingTransferFunction extends TransferFunction1D
                                     implements
                                     CyclableTransferFunction
{

  private final ArrayList<TransferFunction1D> mListOfTransferFunctions =
                                                                       new ArrayList<TransferFunction1D>();
