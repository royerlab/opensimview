...
/**
 * Precompiled dorado.java-common-conventions script plugin.
 **/
public class DoradoJavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_DoradoJavaCommonConventions").asSubclass(BasicScript.class);
